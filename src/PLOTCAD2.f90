...
!
   ...
   IF(DF1.EQ.0.AND.W1.LE.0.0D0) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & 'THE "SF" VALUE MUST BE GREATER THAN 0.0'//'\n'//&
      & 'RE-ENTER COMMAND', 1)
      RETURN
   END IF
