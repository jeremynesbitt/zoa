...
!       NEWOBJ+1.
!
   real(real64) A11,A12,A13,A21,ALPHA,BETA,&
   &A22,A23,A31,A32,A33,AEEA,BEEB,CEEC,XEEX,YEEY,ZEEZ,&
...
!
   real(real64) A,A11,A12,A13,A21,A22,A23,A31,A32,A33 &
...
!
   ...
   IMPLICIT NONE
!
   real(real64) X1,Y1,Z1,XL1,XM1,XN1,YL1,YM1,YN1,ZL1,ZM1,ZN1
   real(real64) X2,Y2,Z2,XL2,XM2,XN2,YL2,YM2,YN2,ZL2,ZM2,ZN2
   real(real64) X3,Y3,Z3,XL3,XM3,XN3,YL3,YM3,YN3,ZL3,ZM3,ZN3
   real(real64) D11,D12,D13,D21,D22,D23,D31,D32,D33
   real(real64) ALPHA,BETA,GAMMA,COSB,SINB
!
!
...
!
   real(real64) LX11,LY11,LZ11,MX11,MY11,MZ11,NX11,NY11,NZ11,&
