...
!       ALLOCATE THE MULTIHIT ARRAYS AND P1ARAY
      ...
      &MULTIRAY_DATA,MULTIREF_DATA,MULTI_DATA,P1ARAY,STAT=ALLOERR)
...
!       AN NSS TUBE SURFACE IS PRESENT, ALLOCATE MEMORY
            ...
            &MULTIRAY_DATA,MULTIREF_DATA,MULTI_DATA,P1ARAY,STAT=ALLOERR)
            ALLOCATE(&
            &GLOBAL_MULTIRAY_DATA(1:50,0:MAXSUR,1:MRAYS),&
            &GLOBAL_MULTIREF_DATA(1:50,0:MAXSUR,1:MRAYS),&
            &MULTIRAY_DATA(1:50,0:MAXSUR,1:MRAYS),&
            &MULTIREF_DATA(1:50,0:MAXSUR,1:MRAYS),&
            &MULTI_DATA(1:50,0:MAXSUR,1:MRAYS),&
            &P1ARAY(0:360,1:3,1:MRAYS),&
            &STAT=ALLOERR)
...
!       AN NSS TUBE SURFACE IS PRESENT, ALLOCATE MEMORY
            DEALLOCATE(GLOBAL_MULTIRAY_DATA,GLOBAL_MULTIREF_DATA,&
            &MULTIRAY_DATA,MULTIREF_DATA,P1ARAY,MULTI_DATA,STAT=ALLOERR)
            ALLOCATE(&
            &GLOBAL_MULTIRAY_DATA(1:50,0:MAXSUR,1:MRAYS),&
            &GLOBAL_MULTIREF_DATA(1:50,0:MAXSUR,1:MRAYS),&
            &MULTIRAY_DATA(1:50,0:MAXSUR,1:MRAYS),&
...
!     TILT RETURN
            ...
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)&
            &'THE "TILT RET" ON SURFACE ',I,' IS BEING DELETED'
            CALL SHOWIT(1)
         END IF
      ELSE
...
!
   ...
   &,KKKK,I,II,III,SLVMRK,ITT,IFF,TESTIT,J,K,ZZTOP, JJ
!
...
!     DO THE MESSAGE
            OUTLYNE=&
            &'WARNING: CURRENT LENS HAS GLASS INPUT ERRORS'
            CALL SHOWIT(1)
...
!
      IF(SYSTEM(64).EQ.1.0D0) THEN
         ...
         IF(DABS(YTERM).GT.1.0D0) THEN
            OUTLYNE=&
            &'NEW "NAOY" VALUE WAS NOT REALISTIC'
            CALL SHOWIT(1)
      ...
      IF(SYSTEM(64).EQ.2.0D0) THEN
         ...
         IF(DABS(XTERM).GT.1.0D0) THEN
            OUTLYNE=&
            &'NEW "NAOX" VALUE WAS NOT REALISTIC'
            CALL SHOWIT(1)
...
!     CHIEF RAY SOLVES OF ANY TYPE ARE NOT ALLOWED IN FRONT OF THE STOP
            IF(SOLVE(6,I).EQ.2.0D0) THEN
               ...
               &' :SURFACE PRECEEDS ASTOP SURFACE - PCY-SOLVE DELETED'
               CALL SHOWIT(1)
               SOLVE(6,I)=0.0D0
            END IF
            IF(SOLVE(4,I).EQ.5.0D0) THEN
               WRITE(OUTLYNE,*)'SURFACE',SURF,&
               &' :SURFACE PRECEEDS ASTOP SURFACE - PCX-SOLVE DELETED'
               CALL SHOWIT(1)
               SOLVE(4,I)=0.0D0
            END IF
            IF(SOLVE(8,I).EQ.4.0D0) THEN
               WRITE(OUTLYNE,*)'SURFACE',SURF,&
               &' :SURFACE PRECEEDS ASTOP SURFACE - APCY-SOLVE DELETED'
               CALL SHOWIT(1)
               SOLVE(8,I)=0.0D0
            END IF
            IF(SOLVE(2,I).EQ.11.0D0) THEN
               WRITE(OUTLYNE,*)'SURFACE',SURF,&
               &' :SURFACE PRECEEDS ASTOP SURFACE - APCX-SOLVE DELETED'
               CALL SHOWIT(1)
               SOLVE(2,I)=0.0D0
            END IF
            IF(SOLVE(8,I).EQ.5.0D0) THEN
               WRITE(OUTLYNE,*)'SURFACE',SURF,&
               &' :SURFACE PRECEEDS ASTOP SURFACE - PICY-SOLVE DELETED'
               CALL SHOWIT(1)
               SOLVE(8,I)=0.0D0
            END IF
            IF(SOLVE(2,I).EQ.12.0D0) THEN
               WRITE(OUTLYNE,*)'SURFACE',SURF,&
               &' :SURFACE PRECEEDS ASTOP SURFACE - PICX-SOLVE DELETED'
               CALL SHOWIT(1)
               SOLVE(2,I)=0.0D0
            END IF
            IF(SOLVE(8,I).EQ.6.0D0) THEN
               WRITE(OUTLYNE,*)'SURFACE',SURF,&
               &' :SURFACE PRECEEDS ASTOP SURFACE - PUCY-SOLVE DELETED'
               CALL SHOWIT(1)
               SOLVE(8,I)=0.0D0
            END IF
            IF(SOLVE(2,I).EQ.13.0D0) THEN
               WRITE(OUTLYNE,*)'SURFACE',SURF,&
               &' :SURFACE PRECEEDS ASTOP SURFACE - PUCX-SOLVE DELETED'
               CALL SHOWIT(1)
               SOLVE(2,I)=0.0D0
            END IF
...
!     SAY FLOAT IN EFFECT
               IF(SOLVE(6,I).EQ.1.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - PY-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(6,I)=0.0D0
               END IF
               IF(SOLVE(6,I).EQ.3.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - CAY-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(6,I)=0.0D0
               END IF
               IF(SOLVE(8,I).EQ.1.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - APY-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(8,I)=0.0D0
               END IF
               IF(SOLVE(8,I).EQ.2.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - PIY-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(8,I)=0.0D0
               END IF
               IF(SOLVE(8,I).EQ.3.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - PUY-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(8,I)=0.0D0
               END IF
               IF(SOLVE(8,I).EQ.7.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - COCY-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(8,I)=0.0D0
               END IF
            ELSE
...
!     SAX FLOAT IN EFFECT
               IF(SOLVE(4,I).EQ.4.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - PX-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(4,I)=0.0D0
               END IF
               IF(SOLVE(4,I).EQ.6.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - CAX-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(6,I)=0.0D0
               END IF
               IF(SOLVE(2,I).EQ.8.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - APX-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(2,I)=0.0D0
               END IF
               IF(SOLVE(2,I).EQ.9.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - PIX-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(2,I)=0.0D0
               END IF
               IF(SOLVE(2,I).EQ.10.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - PUX-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(2,I)=0.0D0
               END IF
               IF(SOLVE(2,I).EQ.14.0D0) THEN
                  ...
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'SURFACE',SURF,&
                  &' :SURFACE PRECEEDS ASTOP SURFACE - COCX-SOLVE DELETED'
                  CALL SHOWIT(1)
                  SOLVE(2,I)=0.0D0
               END IF
            ELSE
...
!       REMOVE THE SOLVE AND PRINT AN ERROR MESSAGE
                  IF(SOLVE(8,I).EQ.7.0D0) THEN
                     OUTLYNE=&
                     &'(COCY) SOLVE CONFLICTS WITH A FOLLOWING THICKNESS SOLVE'
                     CALL SHOWIT(1)
...
!       NOT A COCY SOLVE,PROCEED
                  ...
                  IF(SOLVE(2,I).EQ.14.0D0) THEN
                     OUTLYNE=&
                     &'(COCX) SOLVE CONFLICTS WITH A FOLLOWING THICKNESS SOLVE'
                     CALL SHOWIT(1)
...
!
   DO ZZTOP=1,INT(SYSTEM(20))-1
      ...
      &GLANAM(ZZTOP,2).EQ.GLANAM((ZZTOP-1),2).AND.&
      &GLANAM(ZZTOP,2).NE.'REFL'.AND.&
      &GLANAM(ZZTOP,2).NE.'REFLTIRO'.AND.&
      &GLANAM(ZZTOP,2).NE.'IDEAL'.AND.&
...
!     NOW THE ENTRANCE AND EXIT PUPIL DIAMETERS
   ...
   call curr_par_ray_trace%&
   &calculateFirstOrderParameters(curr_lens_data)
   CALL PRTRA
!
...
!     IMAGE ANGLES SCALE
      ...
      IF(B.NE.0.0D0) THEN
         ...
         &JK_FACTOR=DTAN(PII*SYSTEM(92)/180.0D0)/B
         IF(SYSTEM(98).EQ.1.0D0)&
         &JK_FACTOR=DTAN(PII*SYSTEM(96)/180.0D0)/B
      END IF
   ELSE
!     IMAGE HT SCALE
      ...
      IF(B.NE.0.0D0) THEN
         IF(SYSTEM(94).EQ.-1.0D0)&
         &JK_FACTOR=SYSTEM(92)/B
         IF(SYSTEM(98).EQ.-1.0D0)&
         &JK_FACTOR=SYSTEM(96)/B
      END IF
   END IF
!     SET SCX
...
!     IMAGE ANGLES SCALE
      ...
      IF(B.NE.0.0D0) THEN
         ...
         &JK_FACTOR=DTAN(PII*SYSTEM(93)/180.0D0)/B
         IF(SYSTEM(99).EQ.1.0D0)&
         &JK_FACTOR=DTAN(PII*SYSTEM(97)/180.0D0)/B
      END IF
   ELSE
!     IMAGE HT SCALE
      ...
      IF(B.NE.0.0D0) THEN
         IF(SYSTEM(95).EQ.-1.0D0)&
         &JK_FACTOR=SYSTEM(93)/B
         IF(SYSTEM(99).EQ.-1.0D0)&
         &JK_FACTOR=SYSTEM(97)/B
      END IF
   END IF
!     SET SCY
