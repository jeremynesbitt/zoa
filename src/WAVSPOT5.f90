...
!
   REAL*8 XDOLD,YDOLD,ZDOLD,FPOS,TFSPACE ,CUTFR,CUTFRX,CUTFRY,XMOD,YMOD,XPHA,YPHA,MMENT,AL,FREQ1,FREQ2
!
...
!
   REAL*8 EXPUZMM ,REFIN,NREFIN,CUTFRX,CUTFRY,VALVAL,GRNX,GRNY
!
   LOGICAL ERRR
!
   INTEGER SHTNM
...
!
   CHARACTER UN*11
!
   REAL*8 SPT,SPT1,SPT2,SPT3,SPT4,IWLIJK(1:10),WAY,SPT5,SPT6,SPT7,SPT8,SPT9,SPT10,LAMFACTOR ,OPPEAK(0:10),OPPIT(0:10),OPPTV(0:10),SUMONE(0:10),SUMTWO(0:10),ARG,LAM(1:10),WEI(1:10),SUML2,SUML4 ,WEIS,SIG,SUMSIG,DELFOB,APODX2,APODR2
!
   REAL*8 NCOS,A,DSPO
!
   DIMENSION DSPO(:,:)
...
!
   INTEGER KIK,KIKI
!
   REAL*8 TOT,W,AMSS ,X,Y,MSSX,MSSY,AMSSX,AMSSY
!
   REAL*8 MAX ,FRAC,FRACA,FRACB,MSS,APFAC
!
...
!
   CHARACTER*8 WWWQW
!
   REAL*8 SUM1,SUM2,CUTFRX,CUTFRY,JK_TEMP,COFACT ,VALVAL,GRNX,GRNY,WVNUM,FREQFACT,X,Y,Y1,Y2,nor,SHRTWV ,IWLIJK(1:10),REFIN,NREFIN,VXHI,VXLO,VYHI,VYLO,FNXX,FNYY
!
   LOGICAL REFERR,EXTDMTF1,EXTDMTF2,PERF
   COMMON/DMTFEXT/EXTDMTF1,EXTDMTF2,PERF
!
   COMMON/PEPITO/IWLIJK,IJK
!
   REAL*8 YP1,YPN,CUTFR,SPTT ,NORMI,DOTFR1,DOTFI1,DOTFM1,DOTFP1,XFR ,DOTFM0,DOTFP0,DOTFI0,DOTFR0,XFR0
!
...
!
!
   REAL*8 PUPL,SUMMER1,SUMMER2,FREQ,XY12,XY22,FREQ1,FREQ2,AL,WWWW1,WWWW2,DOTFR,DOTFI,DOTFP,DOTFM,FR
