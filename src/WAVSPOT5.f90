...
!
   ...
   IF(W2.LT.16.0D0.OR.(W2-DBLE(INT(W2))).NE.0.0D0.OR.((W2/2.0D0)-DBLE(INT(W2/2.0D0))).NE.0.0D0) THEN
      ...
      CALL SHOWIT(1)
      OUTLYNE='CALCULATION. IT MUST BE A POSITIVE'
      CALL SHOWIT(1)
      OUTLYNE='EVEN INTEGER VALUE GREATER THAN OR EQUAL TO 16'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(NUMT0.NE.0.0D0) THEN
      ...
      IF(ARG.LT.0.0D0) THEN
         OUTLYNE='RMSOPD ERROR OCCURED, CAPFN CALCULATION HAS FAILED'
         CALL SHOWIT(1)
         CALL MACFAL
!     DEALLOCATE DSPOTT
         CALL SPOTIT(1)
...
!
   ...
   IF(W2.LT.3.0D0.OR.W2.GT.100.0D0) THEN
      OUTLYNE='VALID NUMBER OF FREQUENCY POINTS RANGES FROM 3 TO 100'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(DF1.EQ.0) THEN
      IF(W1.LT.0.0D0) THEN
         OUTLYNE='FREQUENCY MUST BE GREATER THAN 0.0D0'
         CALL SHOWIT(1)
         OUTLYNE='RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
