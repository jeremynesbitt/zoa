...
22    CONTINUE
      ...
      &.AND.SOLVE(2,1).EQ.0.0D0 &
      &.AND.SOLVE(6,1).EQ.0.0D0 &
      &.AND.SOLVE(8,1).EQ.0.0D0 &
      &.AND.SOLVE(4,2).EQ.0.0D0 &
...
!       ADJUSTMENT CAN'T BE DONE.
         ...
         CALL SHOWIT(1)
         OUTLYNE=&
         &'SURFACES 1 AND/OR 2 ARE EITHER NOT DUMMY SURFACES OR THEY'
         CALL SHOWIT(1)
...
!       ADJUSTMENT
            OUTLYNE=&
            &'A "TH" OR "THOAL" PIKUP ON SURFACE (IMAGE-2) OR (IMAGE-1)'
            CALL SHOWIT(1)
...
!       ADJUSTMENT CAN'T BE DONE.
         ...
         CALL SHOWIT(1)
         OUTLYNE=&
         &'SURFACES (IMAGE-1) AND (IMAGE-2) ARE EITHER NOT DUMMY'
         CALL SHOWIT(1)
         OUTLYNE=&
         &'SURFACES OR THEY HAVE SOLVES ASSIGNED TO THEM'
         CALL SHOWIT(1)
         OUTLYNE='THE (EX) ADJUSTMENT IS BEING CANCELLED'
         CALL SHOWIT(1)
         call sys_set_astop_adj(0.0D0)
...
!       THE DESIRED EXIT PUPIL RADIUS IS STORED IN SYSTEM(46)
...
!       THE DESIRED EXIT PUPIL RADIUS IS STORED IN SYSTEM(47)
!       IF ALL SOLVED ARE SHUT OFF, THE NEW EXIT PUPIL RADIUS
...
!
   IF(SQ.EQ.1.AND.S1.EQ.1) THEN
      IF(WC.EQ.'PCD3') THEN
         WRITE(OUTLYNE,*)&
         &'"PCD3" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
      ...
      IF(WC.EQ.'XPCD3') THEN
         WRITE(OUTLYNE,*)&
         &'"XPCD3" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'BUT NOT BOTH'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
   ...
   IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      IF(WC.EQ.'PCD3') THEN
         WRITE(OUTLYNE,*)&
         &'"PCD3" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(WC.EQ.'XPCD3') THEN
         WRITE(OUTLYNE,*)&
         &'"XPCD3" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!
   IF(SQ.EQ.1.AND.S1.EQ.1) THEN
      IF(WC.EQ.'PCD5') THEN
         WRITE(OUTLYNE,*)&
         &'"PCD5" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'BUT NOT BOTH'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      ...
      IF(WC.EQ.'XPCD5') THEN
         WRITE(OUTLYNE,*)&
         &'"XPCD5" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'BUT NOT BOTH'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
   ...
   IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      IF(WC.EQ.'PCD5') THEN
         WRITE(OUTLYNE,*)&
         &'"PCD5" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(WC.EQ.'XPCD5') THEN
         WRITE(OUTLYNE,*)&
         &'"XPCD5" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
5000 FORMAT('SURF',5X,'SA5 ',10X,'CMA5',10X,'AST5',&
   &10X,'DIS5',10X,'PTZ5')
5001 FORMAT(&
   &'(Y-Z) PLANE, FIFTH ORDER')
6001 FORMAT(&
   &'(X-Z) PLANE, FIFTH ORDER')
5002 FORMAT('PRIMARY CHROMATIC DIFFERENCES'&
   &,' - (CFG #',I2,')')
6002 FORMAT('SECONDARY CHROMATIC DIFFERENCES'&
   &,' - (CFG #',I2,')')
...
!
   IF(SQ.EQ.1.AND.S1.EQ.1) THEN
      IF(WC.EQ.'PCDX5') THEN
         WRITE(OUTLYNE,*)&
         &'"PCDX5" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'BUT NOT BOTH'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      ...
      IF(WC.EQ.'XPCDX5') THEN
         WRITE(OUTLYNE,*)&
         &'"XPCDX5" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'BUT NOT BOTH'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
   ...
   IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      IF(WC.EQ.'PCDX5') THEN
         WRITE(OUTLYNE,*)&
         &'"PCDX5" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(WC.EQ.'XPCDX5') THEN
         WRITE(OUTLYNE,*)&
         &'"XPCDX5" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!
   IF(SQ.EQ.1.AND.S1.EQ.1) THEN
      IF(WC.EQ.'PCDP3') THEN
         WRITE(OUTLYNE,*)&
         &'"PCDP3" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'BUT NOT BOTH'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      ...
      IF(WC.EQ.'XPCDP3') THEN
         WRITE(OUTLYNE,*)&
         &'"XPCDP3" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'BUT NOT BOTH'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
   ...
   IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      IF(WC.EQ.'PCDP3') THEN
         WRITE(OUTLYNE,*)&
         &'"PCDP3" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(WC.EQ.'XPCDP3') THEN
         WRITE(OUTLYNE,*)&
         &'"XPCDP3" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
6001 FORMAT(&
   &'(X-Z) PLANE, EXIT PUPIL THIRD ORDER ')
5002 FORMAT('PRIMARY CHROMATIC CONTRIBUTIONS'&
   &,' - (CFG #',I2,')')
6002 FORMAT('SECONDARY CHROMATIC CONTRIBUTIONS'&
   &,' - (CFG #',I2,')')
...
!
   IF(SQ.EQ.1.AND.S1.EQ.1) THEN
      IF(WC.EQ.'PCDSA') THEN
         WRITE(OUTLYNE,*)&
         &'"PCDSA" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'BUT NOT BOTH'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      ...
      IF(WC.EQ.'XPCDSA') THEN
         WRITE(OUTLYNE,*)&
         &'"XPCDSA" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'BUT NOT BOTH'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
   ...
   IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      IF(WC.EQ.'PCDSA') THEN
         WRITE(OUTLYNE,*)&
         &'"PCDSA" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(WC.EQ.'XPCDSA') THEN
         WRITE(OUTLYNE,*)&
         &'"XPCDSA" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
5001 FORMAT(&
   &'(Y-Z) PLANE, SPHERICAL ABERRATION (3RD,5TH,7TH)')
5002 FORMAT('PRIMARY CHROMATIC CONTRIBUTIONS'&
   &,' - (CFG #',I2,')')
6001 FORMAT(&
   &'(X-Z) PLANE, SPHERICAL ABERRATION (3RD,5TH,7TH)')
6002 FORMAT('SECONDARY CHROMATIC CONTRIBUTIONS'&
   &,' - (CFG #',I2,')')
5501 FORMAT('TRANSVERSE - WITH FINAL SURFACE CONVERSION')
5502 FORMAT('TRANSVERSE - WITHOUT FINAL SURFACE CONVERSION')
...
!       THE CONTROL WAVELENGTH NUMBER IS STORED IN
!       SYSTEM(11),THE PRIMARY WAVELENTH PAIR NUMBERS
...
!
   ...
   IF(SQ.EQ.1.AND.WQ.NE.'QUIET') THEN
      WRITE(OUTLYNE,*)&
      &'"FIRD" ONLY TAKES "QUIET" AS AN OPTIONAL QUALIFIER'
      CALL SHOWIT(1)
...
!
   use DATLEN
   use DATMAI
   use mod_surface, only: surf_curvature, surf_thickness, surf_toric_flag, surf_toric_curvature, surf_ideal_efl, surf_asphere_coeff
...
!
   IF(surf_has_pickups(K)) CALL PIKRES ! existence derived from PIKUP flags (pickup_manager)
!
   IF(K.GT.0) THEN
...
!
   IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      ...
      &'"FCHY" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
      IF(WC.EQ.'FCHX') WRITE(OUTLYNE,*)&
      &'"FCHX" TAKES NO STRING OR NUMERIC WORD #2 THROUGH #5 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'BUT NOT BOTH'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
   ...
   IF(SQ.EQ.1.AND.S1.EQ.1) THEN
      IF(WC.EQ.'FCHY') WRITE(OUTLYNE,*)&
      &'"FCHY" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
      IF(WC.EQ.'FCHX') WRITE(OUTLYNE,*)&
      &'"FCHX" TAKES EITHER QUALIFIER OR NUMERIC WORD #1 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'BUT NOT BOTH'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
