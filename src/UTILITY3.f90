...
!       MATHEMATICS FUNCTIONS SUCH AS PLUS, MINUS ETC.
!       ALSO DOES THE CLREG COMMAND
!
   CHARACTER ACCWRD*8
!
...
!
   IF(WC.NE.'WRITE') THEN
      IF(SST.EQ.1.OR.SN.EQ.1) THEN
         CALL REPORT_ERROR_AND_FAIL(WC//' ONLY TAKES QUALIFIER INPUT'//'\n'//'RE-ENTER COMMAND', 1)
         RETURN
      END IF
   END IF
   IF(WC.EQ.'WRITE') THEN
      IF(SN.EQ.1) THEN
         CALL REPORT_ERROR_AND_FAIL(WC//' TAKES NO NUMERIC INPUT'//'\n'//'RE-ENTER COMMAND', 1)
         RETURN
      END IF
   END IF
!
...
!
   ...
   &.AND.WQ.NE.'D'.AND.WQ.NE.'E'.AND.WQ.NE.'F'.AND.&
   &WQ.NE.'G'.AND.WQ.NE.'H'.AND.WQ.NE.'Y'.AND.WQ.NE.'Z'&
   &.AND.WQ.NE.'T'.AND.WQ.NE.'IX'.AND.WQ.NE.'IY'&
   &.AND.WQ.NE.'IZ'.AND.WQ.NE.'IT'.AND.WQ.NE.'I'.AND.&
   &WQ.NE.'ITEST'.AND.WQ.NE.'J'.AND.WQ.NE.'JTEST'&
   &.AND.WQ.NE.'X'.AND.WQ.NE.' '.AND.WQ.NE.'K'.AND.WQ.NE.'L'&
   &.AND.WQ.NE.'M'.AND.WQ.NE.'N'.AND.WQ.NE.'KTEST'.AND.WQ.NE.'MTEST'&
   &.AND.WQ.NE.'LTEST'.AND.WQ.NE.'NTEST') THEN
...
FUNCTION DIV()
   ...
   IF(WQ.EQ.'A') THEN
      ...
      IF(REG(1).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('REG A =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'B') THEN
      ...
      IF(REG(2).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('REG B =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'C') THEN
      ...
      IF(REG(3).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('REG C =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'D') THEN
      ...
      IF(REG(4).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('REG D =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'E') THEN
      ...
      IF(REG(5).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('REG E =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'F') THEN
      ...
      IF(REG(6).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('REG F =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'G') THEN
      ...
      IF(REG(7).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('REG G =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'H') THEN
      ...
      IF(REG(8).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('REG H =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.' '.OR.WQ.EQ.'ACC'.OR.WQ.EQ.'X') THEN
      ...
      IF(REG(9).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('ACCUMULATOR =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'Y') THEN
      ...
      IF(REG(10).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('Y REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'Z') THEN
      ...
      IF(REG(11).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('Z REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'T') THEN
      ...
      IF(REG(12).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('T REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'IX') THEN
      ...
      IF(REG(13).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('IX REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'IY') THEN
      ...
      IF(REG(14).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('IY REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'IZ') THEN
      ...
      IF(REG(15).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('IZ REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'IT') THEN
      ...
      IF(REG(16).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('IT REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'I') THEN
      ...
      IF(REG(17).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('I REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'ITEST') THEN
      ...
      IF(REG(18).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('ITEST REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'J') THEN
      ...
      IF(REG(19).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('J REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'JTEST') THEN
      ...
      IF(REG(20).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('JTEST REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'K') THEN
      ...
      IF(REG(21).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('K REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'L') THEN
      ...
      IF(REG(22).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('L REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'M') THEN
      ...
      IF(REG(23).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('M REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'N') THEN
      ...
      IF(REG(24).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('N REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'KTEST') THEN
      ...
      IF(REG(25).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('KTEST REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'LTEST') THEN
      ...
      IF(REG(26).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('LTEST REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'MTEST') THEN
      ...
      IF(REG(27).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('MTEST REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   IF(WQ.EQ.'NTEST') THEN
      ...
      IF(REG(28).EQ.0.0D0) THEN
         CALL REPORT_ERROR_AND_FAIL('NTEST REG =ZERO, NO DIVISION DONE', 1)
         RETURN
      END IF
   END IF
   RETURN
...
10 CONTINUE
   ...
   & 'INVALID NEG. SQRT ARGUMENT'//'\n'//&
   & 'FOR REG '//WC//'\n'//&
   & 'ACCUMULATOR NOT ALTERED', 1)
   RETURN
11 CONTINUE
   REG(40)=REG(9)
   IF(WQ.EQ.'A') THEN
...
!       IZ,OR IT. THE STORE COMMAND IS THE INVERSE OF THE MOVE
!       COMMAND. ALSO WORKS ON I,J,ITEST AND JTEST
!       ALSO WORKS ON K,L,KTEST AND LTEST
!       ALSO WORKS ON M,N,MTEST AND NTEST
   REG(40)=REG(9)
   ...
   IF(WQ.EQ.' '.OR.WQ.EQ.'X'.OR.WQ.EQ.'ACC')THEN
      ...
      CALL REPORT_ERROR_AND_FAIL('STORE X NOT DEFINED', 1)
      RETURN
   END IF
...
!
!       NOW TEST FOR NEGATIVE VALUE
   IF(REGG.LT.0.0D0) THEN
      OUTLYNE=&
      &'NEGATIVE FACTORIAL ARGUMENT IN REG '//WQ
      CALL SHOWIT(1)
      CALL REPORT_ERROR_AND_FAIL('ACCUMULATOR NOT ALTERED', 1)
      RETURN
   END IF
!       CONVERT TO INTEGER
   ARG=INT(REGG)
   ...
   IF((REGG-DARG).NE.0) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & 'REG '//WQ//':'//'\n'//&
      & 'NON-INTEGER ARGUMENT FOR FACTORIAL NOT ALLOWED'//'\n'//&
      & 'ACCUMULATOR NOT ALTERED', 1)
      RETURN
   END IF
   IF(ARG.GT.33) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & 'REG '//WQ//':'//'\n'//&
      & 'MAXIMUM FACTORIAL ARGUMENT IS 33'//'\n'//&
      & 'ACCUMULATOR NOT ALTERED', 1)
      RETURN
   END IF
...
!       USING THE ARGUMENT W1 AND W2. IF W2 = 0.0D0 THEN ATANN2
!       RETURNS THE VALUE PI/2.
!
!       THE RESULT IS LEFT IN THE ACCUMULATOR.
!       IN GENERAL THE RESULT IS RETURNED AS AN ANGULAR
!       VALUE IN RADIANS BETWEEN -PI/2 AND +PI/2.
!
!
   IF(SST.EQ.1.OR.SQ.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & '"ATANN2" ONLY TAKES NUMERIC WORD #1 AND #2 INPUT'//'\n'//&
      & 'RE-ENTER COMMAND', 1)
      RETURN
   END IF
   IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
      OUTLYNE=&
      &'"ATANN2" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
      CALL SHOWIT(1)
