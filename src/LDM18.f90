...
!       COMMAND (N6,W1, TO N10,W1)
      ...
      &WC.EQ.'N3'.OR.WC.EQ.'N8'.OR.WC.EQ.'N9'.OR.WC.EQ.'N10'.OR.WC &
      &.EQ.'N4'.OR.WC.EQ.'N5') THEN
         CALL RNCHG
         RETURN
      END IF
...
!       COMMAND ((GLASS CAT NAME) [INDENTIFICATION])
      ...
      &WC.EQ.'CORNIN'.OR.WC.EQ.'MATL'.OR.&
      &WC.EQ.'HOYA'.OR.WC.EQ.'GLCAT'.OR.WC.EQ.'RADHARD'&
      &.OR.WC.EQ.'USER'.OR.WC.EQ.'RUSSIAN'.OR.WC.EQ.'HIKARI'&
      &.OR.WC.EQ.'GLAK')THEN
         CALL GLSCAT
         CALL FLUSHNEXT
         RETURN
...
!       COMMAND (AH,AI,AJ,AK,AL)
      ...
      &.OR.WC.EQ.'AFTOR'.OR.WC.EQ.'AGTOR'.OR.WC.EQ.'AH'.OR.&
      &WC.EQ.'AJ'.OR.WC.EQ.'AI'.OR.WC.EQ.'AK'.OR.WC.EQ.'AL') THEN
         CALL SDEFG
         RETURN
      END IF
...
!       COMMANDS (PY,PX,PCY,PCX,CAY,CAX)
      ...
      &.OR.WC.EQ.'PCX'.OR.WC.EQ.'CAY'.OR.WC.EQ.'CAX'&
...
!                 APX,PIX,PUX,APCX,PICX,PUCX AND COCX)
      ...
      &.OR.WC.EQ.'APCY'.OR.WC.EQ.'PICY'.OR.WC.EQ.'PUCY'.OR.&
      &WC.EQ.'COCY'.OR.WC.EQ.'APX'.OR.WC.EQ.'PIX'.OR.&
      &WC.EQ.'PUX'.OR.WC.EQ.'APCX'.OR.WC.EQ.'PICX'.OR.&
      &WC.EQ.'PUCX'.OR.WC.EQ.'COCX') THEN
         CALL CVSOLV
         RETURN
      END IF
!       COMMAND (PIKUP)
...
!
   ...
   &,ALLOERR,JK,TOTSUR,IS,OLDOUT,OLDIN,IREND
!
   REAL*8 ASTOP2,REFS2,&
   &IMAGE1,IMAGE2,UNI1,UNI2
!
   LOGICAL EXISJK
!
...
!       LENADD TAKES NO STRING OR QUALIFIER INPUT
   IF(SST.EQ.1.OR.SQ.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"LENADD" TAKES NO QUALIFIER OR STRING INPUT'
      CALL SHOWIT(1)
...
!     ALLOCATE
   ...
   &GLANMA(AM10:AM3,AM9),ALBL(AM10:AM3),MULTCLAPA(1:1000,1:3,0:AM3),&
   &AIPOLYX(1:200,AM10:AM3,1:4),AIPOLYY(1:200,AM10:AM3,1:4),&
   &mULTCOBSA(1:1000,1:3,0:AM3),STAT=ALLOERR)
...
! RAD HARD LIMITS
   IF( NAME2.EQ.'BK7G18       '&
   &.OR.NAME2.EQ.'520637       '&
   &.OR.NAME2.EQ.'GG375G34     '&
   &.OR.NAME2.EQ.'525564       '&
   &.OR.NAME2.EQ.'BK7G25       '&
   &.OR.NAME2.EQ.'521632       '&
   &.OR.NAME2.EQ.'K5G20        '&
   &.OR.NAME2.EQ.'523568       ')THEN
      LAMLOW=0.365D0
      LAMUPP=2.3254D0
   END IF
!
   ...
   &.OR.NAME2.EQ.'673323       '&
   &.OR.NAME2.EQ.'SF8G07       '&
   &.OR.NAME2.EQ.'695307       ')THEN
      LAMLOW=0.4047D0
      LAMUPP=2.3254D0
   END IF
   IF( NAME2.EQ.'SF6G05       '&
   &.OR.NAME2.EQ.'809253       '&
   &.OR.NAME2.EQ.'KZFS4G20     '&
   &.OR.NAME2.EQ.'615447       ')THEN
      LAMLOW=0.4358D0
      LAMUPP=2.3254D0
   END IF
