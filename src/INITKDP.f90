...
!
   ...
   &DDDAT*10,TTTIM*8,MYED*8 &
   &,DMNAM*10,STRUC*140,AI4*4,COMLINE*140
!
...
!
   ...
   &HROW(0:100)*12,HROW2(0:100)*12,WCOLD*8
!
...
!     PSF LI DEFAULT
   PSFLI=&
   &'THIS IS AN ASCII REPRESENTATION OF A POINT SPREAD FUNCTION'
!
   CAPDEF=16
...
!
   ...
   F99=0
   F100=0
!     PIVAXIS MODE ALWAYS STARTS AS "VERTEX" BECAUSE SYSTEM(101) ALWAYS
!     STARTS AS 0
!
