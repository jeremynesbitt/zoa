...
!       LENO TAKES NO STRING OF NUMERIC INPUT
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"LENO (QUALIFIER)" TAKES NO STRING OR NUMERIC INPUT'
      CALL SHOWIT(1)
...
!
   ...
   &WQ.NE.'RD'.AND.WQ.NE.'NOOPT'.AND.WQ.NE.'HEX') THEN
...
!     SCREEN ON
      ...
      &,SYSTEM(107),SYSTEM(108)
      CALL SHOWIT(10)
1003  FORMAT('SCREEN   ON      ,',G23.15,',',G23.15,','&
      &,G23.15,',',G23.15,',',G23.15)
   END IF
!**********************************************************
...
!       WAVELENGTH IN G23.15,FOLLOWED BY THE PRIMARY WAVELENGTH PAIR EACH IN G23.15 FORMAT
   ...
   &SYSTEM(INT(SYSTEM(11))+110)&
   &,SYSTEM(INT(SYSTEM(7))+110),SYSTEM(INT(SYSTEM(8))+110)
...
!       FOLLOWED BY THE SECOND FULL GLASS NAME EACH IN 2(A13) FORMAT
   ...
   DO I=0,INT(SYSTEM(20))
      ...
      &GLANAM(I,1).EQ.'CORNIN'.OR.GLANAM(I,1).EQ.'CHANCE'.OR.&
      &GLANAM(I,1).EQ.'SCH2000'.OR.&
      &GLANAM(I,1).EQ.'HIKARI'.OR.GLANAM(I,1).EQ.'GLCAT'.OR.&
      &GLANAM(I,1).EQ.'MATL'.OR.GLANAM(I,1).EQ.'RUSSIAN'.OR.&
      &GLANAM(I,1).EQ.'GLAK'.OR.GLANAM(I,1).EQ.'RADHARD'.OR.&
      &GLANAM(I,1).EQ.'USER'.OR.GLANAM(I,1).EQ.'OHARA') THEN
...
!
   WRITE(OUTLYNE,221)&
   &SYSTEM(71),SYSTEM(72),SYSTEM(73),SYSTEM(74),SYSTEM(75)
   CALL SHOWIT(10)
!
...
!
   ...
   &SYSTEM(98).EQ.0.0D0.AND.SYSTEM(99).EQ.0.0D0) THEN
...
!       SAY
   ...
   ELSE
      ...
      &WRITE(OUTLYNE,2929) SYSTEM(65)
      IF(SYSTEM(64).EQ.1.0D0.OR.SYSTEM(64).EQ.3.0D0)&
      &CALL SHOWIT(10)
      IF(SYSTEM(67).EQ.1.0D0.OR.SYSTEM(67).EQ.3.0D0)&
      &WRITE(OUTLYNE,2930) SYSTEM(68)
      IF(SYSTEM(67).EQ.1.0D0.OR.SYSTEM(67).EQ.3.0D0)&
      &CALL SHOWIT(10)
   END IF
!
!       SAX
   ...
   ELSE
      ...
      &WRITE(OUTLYNE,3030) SYSTEM(66)
      IF(SYSTEM(64).EQ.2.0D0.OR.SYSTEM(64).EQ.3.0D0)&
      &CALL SHOWIT(10)
      IF(SYSTEM(67).EQ.2.0D0.OR.SYSTEM(67).EQ.3.0D0)&
      &WRITE(OUTLYNE,3031) SYSTEM(69)
      IF(SYSTEM(67).EQ.2.0D0.OR.SYSTEM(67).EQ.3.0D0)&
      &CALL SHOWIT(10)
   END IF
!
...
!
401 FORMAT &
   &('CK THE FOLLOWING PIKUP/SOLVE DATA REFERS TO SURFACE #',I1)
402 FORMAT &
   &('CK THE FOLLOWING PIKUP/SOLVE DATA REFERS TO SURFACE #',I2)
403 FORMAT &
   &('CK THE FOLLOWING PIKUP/SOLVE DATA REFERS TO SURFACE #',I3)
!     SURFACE LABEL
...
666 CONTINUE
   ...
   &GL=GLANAM(I,2)(1:JA)//'_SCHOTT'
   IF(GLANAM(I,1).EQ.'SCH2000')&
   &GL=GLANAM(I,2)(1:JA)//'_SCH2000'
   IF(GLANAM(I,1).EQ.'OHARA')&
   &GL=GLANAM(I,2)(1:JA)//'_OHARA'
   IF(GLANAM(I,1).EQ.'HOYA')&
   &GL=GLANAM(I,2)(1:JA)//'_HOYA'
   IF(GLANAM(I,1).EQ.'HIKARI')&
   &GL=GLANAM(I,2)(1:JA)//'_HIKARI'
   IF(GLANAM(I,1).EQ.'CORNIN')&
   &GL=GLANAM(I,2)(1:JA)//'_CORNFR'
   IF(GLANAM(I,1).EQ.'CHANCE')&
   &GL=GLANAM(I,2)(1:JA)//'_CHANCE'
   IF(GLANAM(I,2).EQ.'LAST SURFACE')&
   &GL='AIR                        '
   IF(GLANAM(I,1).NE.'SCHOTT'.AND.&
   &GLANAM(I,1).NE.'SCH2000'.AND.&
   &GLANAM(I,1).NE.'OHARA'.AND.&
   &GLANAM(I,1).NE.'HOYA'.AND.&
   &GLANAM(I,1).NE.'HIKARI'.AND.&
   &GLANAM(I,1).NE.'CORNIN'.AND.&
   &GLANAM(I,2).NE.'LAST SURFACE'.AND.&
   &GLANAM(I,1).NE.'CHANCE')&
   &GL=GLANAM(I,2)(1:JA)
...
!     TORICS
      ...
      &ALENS(41,I).EQ.0.0D0.AND.&
      &ALENS(5,I).EQ.0.0D0.AND.&
      &ALENS(6,I).EQ.0.0D0.AND.&
      &ALENS(7,I).EQ.0.0D0.AND.&
      &ALENS(8,I).EQ.0.0D0.AND.&
      &ALENS(37,I).EQ.0.0D0.AND.&
      &ALENS(38,I).EQ.0.0D0.AND.&
      &ALENS(39,I).EQ.0.0D0.AND.&
      &ALENS(40,I).EQ.0.0D0) THEN
!     CYLINDER ONLY
         WRITE(OUTLYNE,35)
         CALL SHOWIT(10)
!       TORICS PRESENT
...
106   FORMAT('DEC,',E15.7,',',E15.7)
   ...
   &ALENS(25,I).EQ.-1.0D0) THEN
!       TILTS
      IF(ALENS(25,I).EQ.1.0D0.AND.ALENS(77,I).EQ.0.0D0)&
      &WRITE(OUTLYNE,102) ALENS(118,I),ALENS(119,I),ALENS(120,I)
      IF(ALENS(25,I).EQ.-1.0D0)&
      &WRITE(OUTLYNE,103) ALENS(118,I),ALENS(119,I),ALENS(120,I)
      CALL SHOWIT(10)
!
...
!
   ...
   &GLANAM(I,1).EQ.' '.AND.GLANAM(I,2).EQ.'LAST SURFACE') THEN
      WRITE(OUTLYNE,110)
      CALL SHOWIT(10)
      RETURN
   END IF
...
101 CONTINUE
   IF(GLANAM(I,1)(1:5).EQ.'GLAK') THEN
      IF(IG.EQ.1)&
      &WRITE(OUTLYNE,201)GLANAM(I,1)(1:6),GLANAM(I,2)(1:IG),ALENS(46,I),&
      &ALENS(47,I),ALENS(48,I),ALENS(49,I),ALENS(50,I)
      IF(IG.EQ.2)&
      &WRITE(OUTLYNE,202)GLANAM(I,1)(1:6),GLANAM(I,2)(1:IG),ALENS(46,I),&
      &ALENS(47,I),ALENS(48,I),ALENS(49,I),ALENS(50,I)
      IF(IG.EQ.3)&
      &WRITE(OUTLYNE,203)GLANAM(I,1)(1:6),GLANAM(I,2)(1:IG),ALENS(46,I),&
      &ALENS(47,I),ALENS(48,I),ALENS(49,I),ALENS(50,I)
      IF(IG.EQ.4)&
      &WRITE(OUTLYNE,204)GLANAM(I,1)(1:6),GLANAM(I,2)(1:IG),ALENS(46,I),&
      &ALENS(47,I),ALENS(48,I),ALENS(49,I),ALENS(50,I)
      IF(IG.EQ.5)&
      &WRITE(OUTLYNE,205)GLANAM(I,1)(1:6),GLANAM(I,2)(1:IG),ALENS(46,I),&
      &ALENS(47,I),ALENS(48,I),ALENS(49,I),ALENS(50,I)
      IF(IG.EQ.6)&
      &WRITE(OUTLYNE,206)GLANAM(I,1)(1:6),GLANAM(I,2)(1:IG),ALENS(46,I),&
      &ALENS(47,I),ALENS(48,I),ALENS(49,I),ALENS(50,I)
      CALL SHOWIT(10)
   END IF
...
!       LENS ARRAY
   IF(ALENS(133,I).NE.0.0D0) THEN
      ...
      &WRITE(OUTLYNE,1219) ALENS(131,I),ALENS(132,I)
      IF(ALENS(133,I).EQ.1.0D0)&
      &WRITE(OUTLYNE,1220) ALENS(131,I),ALENS(132,I)
      CALL SHOWIT(10)
...
!     LONG FORM
      WRITE(OUTLYNE,13) -ALENS(4,I),-ALENS(5,I),&
      &-ALENS(6,I),-ALENS(7,I),-ALENS(43,I)
      CALL SHOWIT(10)
...
!
   ...
   IF(I.NE.0) THEN
      ...
      &GLANAM(I-1,1).EQ.' '.AND.GLANAM(I-2,2).EQ.'REFLTIRO') THEN
         ...
         &DABS(ALENS(50,I-1)).EQ.1.0D0.AND.&
         &DABS(ALENS(71,I-1)).EQ.1.0D0.AND.&
         &DABS(ALENS(72,I-1)).EQ.1.0D0.AND.&
         &DABS(ALENS(73,I-1)).EQ.1.0D0.AND.&
         &DABS(ALENS(74,I-1)).EQ.1.0D0.AND.&
         &DABS(ALENS(75,I-1)).EQ.1.0D0) THEN
!     USE AIR
            WRITE(OUTLYNE,110)
            CALL SHOWIT(10)
         ELSE
...
!     IS IT "GLASS" ?
                  IF(GLANAM(J,1).EQ.'GLASS') THEN
                     ...
                     &ALENS(46,J),ALENS(47,J),ALENS(48,J),ALENS(49,J),&
                     &ALENS(50,J)
                     CALL SHOWIT(10)
...
!     IS IT "MODEL" ?
                  IF(GLANAM(J,1).EQ.'MODEL') THEN
                     ...
                     &ALENS(86,J),ALENS(87,J),ALENS(89,J)
                     CALL SHOWIT(10)
                     GO TO 9876
                  END IF
!     IS IT A CATALOG GLASS ?
                  IF(GLANAM(J,1).NE.'GLASS'.AND.GLANAM(J,1).NE.' '&
                  &.AND.GLANAM(J,2).NE.'AIR'.AND.GLANAM(J,2).NE.&
                  &'REFL'.AND.GLANAM(J,2).NE.'LAST SURFACE'&
                  &.AND.GLANAM(J,1).NE.'MODEL'.AND.&
...
!
      ...
      &GLANAM(I-1,1).EQ.' '.AND.GLANAM(I-1,2).EQ.'LAST SURFACE') THEN
         WRITE(OUTLYNE,110)
         CALL SHOWIT(10)
         RETURN
      END IF
      IF(GLANAM(I-1,1).EQ.'GLASS') THEN
         ...
         &ALENS(46,I-1),ALENS(47,I-1),ALENS(48,I-1),ALENS(49,I-1),&
         &ALENS(50,I-1)
         CALL SHOWIT(10)
...
1015     FORMAT('N10     ,',G23.15)
      ...
      &.AND.GLANAM(I-1,2).NE.'AIR'.AND.GLANAM(I-1,2).NE.&
      &'REFL'.AND.GLANAM(I-1,1).NE.'MODEL'.AND.&
      &GLANAM(I-1,2).NE.'REFLTIRO'.AND.&
      &GLANAM(I-1,2).NE.'REFLTIR')THEN
...
!       TILTS
      ...
      ELSE
         ...
         &WRITE(OUTLYNE,104) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         IF(ALENS(25,I).EQ.3.0D0)&
         &WRITE(OUTLYNE,105) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         IF(ALENS(25,I).EQ.4.0D0)&
         &WRITE(OUTLYNE,1005) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         IF(ALENS(25,I).EQ.5.0D0)&
         &WRITE(OUTLYNE,1006) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         IF(ALENS(25,I).EQ.7.0D0)&
         &WRITE(OUTLYNE,7674) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         CALL SHOWIT(10)
      END IF
!
...
9006        FORMAT('GGAMMA  ,',G23.15)
      ...
      ELSE
         IF(ALENS(25,I).EQ.1.0D0)&
         &WRITE(OUTLYNE,6669) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         IF(ALENS(25,I).EQ.-1.0D0)&
         &WRITE(OUTLYNE,6670) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         IF(ALENS(25,I).EQ.2.0D0)&
         &WRITE(OUTLYNE,6671) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         IF(ALENS(25,I).EQ.3.0D0)&
         &WRITE(OUTLYNE,6672) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         IF(ALENS(25,I).EQ.4.0D0)&
         &WRITE(OUTLYNE,6673) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         IF(ALENS(25,I).EQ.5.0D0)&
         &WRITE(OUTLYNE,6674) ALENS(118,I),ALENS(119,I),ALENS(120,I)
         IF(ALENS(25,I).EQ.7.0D0)&
         &WRITE(OUTLYNE,7674) ALENS(118,I),ALENS(119,I),ALENS(120,I)
      END IF
!
...
!     IS IT "MODEL" ?
   IF(GLANAM(I,1).EQ.'MODEL') THEN
      ...
      &ALENS(86,I),ALENS(87,I),ALENS(89,I)
      CALL SHOWIT(10)
   END IF
   IF(GLANAM(I,1).NE.'GLASS'.AND.GLANAM(I,1).NE.' '&
   &.AND.GLANAM(I,2).NE.'AIR'.AND.GLANAM(I,2).NE.&
   &'REFL'.AND.GLANAM(I,1).NE.'MODEL'.AND.GLANAM(I,2).NE.&
   &'PERFECT'.AND.GLANAM(I,2).NE.'REFLTIRO'.AND.&
   &GLANAM(I,2).NE.'REFLTIR') THEN
