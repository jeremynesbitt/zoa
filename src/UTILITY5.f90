...
!
   real(real64) WWW1,OW1,OW2,OW3,OW4
!
   COMMON/COMWDS/WCC
!
   CHARACTER REMWQ*8
...
!
      ...
      CALL CONTA(WC1,IS)
      IF(IS) THEN
         CALL REPORT_ERROR_AND_FAIL('INVALID CMD LEVEL COMMAND', 1)
         RETURN
      END IF
   END IF
...
!
      ...
      CALL CONTB(WC1,IS)
      IF(IS) THEN
         CALL REPORT_ERROR_AND_FAIL('INVALID SPECT LEVEL COMMAND', 1)
         RETURN
      END IF
   END IF
!
...
!
   IF(F2.EQ.1) THEN
      ...
      IF(IS) THEN
         CALL REPORT_ERROR_AND_FAIL('INVALID COMMAND USED IN MACRO CREATION', 1)
         RETURN
      END IF
   END IF
!
...
!
   IF(F3.EQ.1) THEN
      ...
      CALL CONTD(WC1,IS)
      IF(IS) THEN
         CALL REPORT_ERROR_AND_FAIL('INVALID LMEDIT COMMAND', 1)
         RETURN
      END IF
   END IF
...
!
   IF(F2.EQ.1) THEN
      ...
      CALL CONTE(WC1,IS)
      IF(IS) THEN
         CALL REPORT_ERROR_AND_FAIL('INVALID MACRO INPUT COMMAND', 1)
         RETURN
      END IF
   END IF
!
...
!               DURING THIS MODE.
      ...
      OUTLYNE=INPUT
      CALL SHOWIT(1)
      CALL REPORT_ERROR_AND_FAIL("LINE 4132", 19)
      RETURN
   END IF
...
call sysConfig%updateParameters()
      ...
      !call sleep(5)
      CALL REPORT_ERROR_AND_FAIL('INVALID LENS UPDATE COMMAND', 1)
      RETURN
   END IF
...
!               DURING THIS MODE.
      ...
      ELSE
         ...
         END IF
      END IF
      CALL REPORT_ERROR_AND_FAIL('INVALID SPSRF INPUT COMMAND', 1)
      RETURN
   END IF
!
...
!               DURING THIS MODE.
      ...
      ELSE
         ...
         END IF
      END IF
      CALL REPORT_ERROR_AND_FAIL('INVALID SPSRF UPDATE COMMAND', 1)
      RETURN
   END IF
...
!               DURING THIS MODE.
      ...
      ELSE
         ...
         ELSE
            ...
            END IF
         END IF
         CALL REPORT_ERROR_AND_FAIL('INVALID SPFIT INPUT COMMAND', 1)
         RETURN
      END IF
   END IF
   IF(F27.EQ.1.OR.F27.EQ.2) THEN
...
!               DURING THIS MODE.
      ...
      ELSE
         ...
         END IF
         IF(F27.EQ.1) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (MERIT INPUT) COMMAND', 1)
            RETURN
         END IF
         IF(F27.EQ.2) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (MERIT UPDATE) COMMAND', 1)
            RETURN
         END IF
      END IF
   END IF
...
!       INITIALIZE THE CURRENT CONFIGURATION NUMBER TO 1
      ...
      ELSE
         ...
         END IF
         IF(F53.EQ.1) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (TOPER INPUT) COMMAND', 1)
            RETURN
         END IF
         IF(F53.EQ.2) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (TOPER UPDATE) COMMAND', 1)
            RETURN
         END IF
      END IF
   END IF
...
!       INITIALIZE THE CURRENT CONFIGURATION NUMBER TO 1
      ...
      ELSE
         ...
         END IF
         IF(F54.EQ.1) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (FOCRIT INPUT) COMMAND', 1)
            RETURN
         END IF
         IF(F54.EQ.2) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (FOCRIT UPDATE) COMMAND', 1)
            RETURN
         END IF
      END IF
   END IF
...
68             CONTINUE
      ...
      ELSE
         ...
         END IF
         IF(F29.EQ.1) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (VARIABLE INPUT) COMMAND', 1)
            RETURN
         END IF
         IF(F29.EQ.2) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (VARIABLE UPDATE) COMMAND', 1)
            RETURN
         END IF
      END IF
   END IF
...
!               DURING THIS MODE.
      ...
      ELSE
         ...
         END IF
         IF(F51.EQ.1) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (TVAR INPUT) COMMAND', 1)
            RETURN
         END IF
         IF(F51.EQ.2) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (TVAR UPDATE) COMMAND', 1)
            RETURN
         END IF
      END IF
   END IF
...
!               WE ARE IN VARIABLE INPUT OR UPDATE MODE.
      ...
      ELSE
         ...
         END IF
         IF(F52.EQ.1) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (COMPVAR INPUT) COMMAND', 1)
            RETURN
         END IF
         IF(F52.EQ.2) THEN
            CALL REPORT_ERROR_AND_FAIL('INVALID (COMPVAR UPDATE) COMMAND', 1)
            RETURN
         END IF
      END IF
   END IF
...
!       THIS IS THE LIST OF VALID LENS UPDATE COMMANDS
      ...
      END IF
      IF(F1.EQ.0.AND.F10.EQ.1) THEN
         CALL REPORT_ERROR_AND_FAIL('INVALID CONFIGS INPUT COMMAND', 1)
         RETURN
      END IF
      IF(F1.EQ.0.AND.F11.EQ.1) THEN
         CALL REPORT_ERROR_AND_FAIL('INVALID CONFIGS UPDATE COMMAND', 1)
         RETURN
      END IF
   END IF
