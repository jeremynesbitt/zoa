...
!
   IF(SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      OUTLYNE='"PIKD" TAKES NO STRING OR NUMERIC WORD #3 THROUGH #5 INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(DF1.EQ.1.AND.DF2.EQ.0.OR.DF1.EQ.0.AND.DF2.EQ.1) THEN
      OUTLYNE='"PIKD" USES EITHER TWO OR ZERO NUMERIC WORDS'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!       PIKUP RD OR PIKUP CV
   IF(WQ.EQ.'RD'.OR.WQ.EQ.'CV') THEN
      IF(SURF.EQ.0) THEN
         OUTLYNE='"'//WQ(1:2)//'" PIKUP NOT ALLOWED ON OBJECT SURFACE'
         CALL SHOWIT(1)
         OUTLYNE='RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!       PIKUP ASPHERIC TORIC TERMS
   IF(WQ.EQ.'ADTOR'.OR.WQ.EQ.'AETOR'.OR.WQ.EQ.'AFTOR'.OR.WQ.EQ.'AGTOR') THEN
      IF(SURF.EQ.0) THEN
         OUTLYNE='"'//WQ(1:5)//'" PIKUP NOT ALLOWED ON OBJECT SURFACE'
         CALL SHOWIT(1)
         OUTLYNE='RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!       PIKUP GDX, GDY, GDZ
   IF(WQ.EQ.'GDX'.OR.WQ.EQ.'GDY'.OR.WQ.EQ.'GDZ') THEN
      IF(SURF.EQ.0) THEN
         OUTLYNE='"'//WQ(1:3)//'" PIKUP NOT ALLOWED ON OBJECT SURFACE'
         CALL SHOWIT(1)
         OUTLYNE='RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
