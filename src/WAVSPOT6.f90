...
!
   INTEGER NTOT,NDIM,NN(2),ISIGN,NPREV,IP1,IP2,IP3,N ,IFP1,NREM,IBIT,IDIM,I1,I2,I3,I2REV,I3REV,NDAT ,IFP2,K1,K2,NPOINTS
!
...
!
   REAL*8 VALUE,VALVAL,SHTVALUE,GRNX,GRNY,XRANGE,YRANGE ,WVNUM,DIAM,OUTGRIDEXTENT,EXEX,EXEY,V1,OUTGRIDSPACING,FACTER,EFFER,SEFFER,CEFFER,CVALUE ,XPL1,YPL1,SPACER1,OLDGRI,NEWGRI
!
   INTEGER IT,IA,IB,IQ,IJK,WK,IER,PCOUNT,HOLN,KKK
!
   REAL*8 FAF,FAFF,FSUM,IIII,IV,PSFXCENT,PSFYCENT ,FACTER1,SPTT,SPTOT,FTOT ,SPACER,PEAKER,CRAYX,CRAYY,X2JK,Y2JK,F2JK,IWLIJK(1:10),C
!
   COMMON/PEPITO/IWLIJK,IJK
!
   REAL SPACING,EXTENT,CNTX,CNTY,PEXTENT,PSPACING ,PEAKADJ
!
...
!     REAL PART
         ...
         FOEGRID1(IIX,IIY,J,1)=DSQRT(DABS(DSPOT(12)))*DCOS(DSPOT(4))
!     IMAGINARY PART
         FOEGRID1(IIX,IIY,J,2)=-DSQRT(DABS(DSPOT(12)))*DSIN(DSPOT(4))
         WVNUM=DSPOT(16)
      ELSE
!       SAVE AS REITHETA
!     MODULUS
...
!
   REAL*8 SHTVALUE,VALUE,FNX,FNY,FNN,VALVAL ,TNRD
!
