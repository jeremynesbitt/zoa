...
!
   ...
   &,IFP2,K1,K2,NPOINTS
!
   real(real64) TWOPI,WR,WI,WPR,WPI,WTEMP,THETA
!
   real(real64) DATA,TEMPI,TEMPR
!
   DIMENSION DATA(NDAT)
!
!     SET NN ARRAY
...
!
   real(real64) VALUE,VALVAL,SHTVALUE,GRNX,GRNY,XRANGE,YRANGE &
...
!
   real(real64) FAF,FAFF,FSUM,IIII,IV,PSFXCENT,PSFYCENT &
...
!
   real(real64) SHTVALUE,VALUE,FNX,FNY,FNN,VALVAL &
   &,TNRD
!
