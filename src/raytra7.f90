...
!
   ...
   &,XR,YR,LS,RS,XRD,YRD,X1,X2,X3,X4,Y1,Y2,Y3,Y4,ANGLE,&
...
!       IS ALENS(17,II). POINTS GO COUNTER CLOCKWISE LOOKING
!       TOWARD THE +Z DIRECTION
!       COORDINATES ARE:
      ANGLE=0.0D0
...
!
   ...
   &,XREAL,YREAL,PY,PX,PUY,PUX,HR,HP,HPU,HRU,FACTOR,FACTOR2 &
   &,MYW1,MYW2,MYW3,MYW4
!
...
!
   REAL*8 PCY,PCX,PUCY,PUCX,V1,VAL1,VAL2,SIG &
   &,XREAL,YREAL,PY,PX,PUY,PUX,HR,HP,DWORD1,DWORD2,HUP,EEFEL &
   &,MYW1,MYW2,MYW3,MYW4,HPU,HRU,FACTOR,FACTOR2
   REAL*8 O18,O19
   COMMON/O18O19/O18,O19
!
   LOGICAL OLDLDIF,OLDLDIF2
...
!
   REAL*8 PCY,PCX,PUCY,PUCX,V1,VAL1,VAL2,SIG &
   &,XREAL,YREAL,PY,PX,PUY,PUX,HR,HP &
   &,MYW1,MYW2,MYW3,MYW4
   REAL*8 O18,O19
   COMMON/O18O19/O18,O19
!
...
!
   ...
   &,SYS12,SYS13,NWN1,NWN2,NWN3,NWN4
!
   REAL*8 VALUE
   INTEGER NUM5
   COMMON/GV/VALUE,NUM5
...
!
   ...
   &,SYS12,SYS13,PCY,PUCX,PUCY,MYW1,MYW2,MYW3,MYW4
!
   INTEGER ERROR,GFLAG
!
   LOGICAL OLDLDIF,OLDLDIF2
...
&,DWORD1,DWORD2,DWORD3,DWORD4,GFLAG)
!
   use DATLEN
   use DATMAI
   IMPLICIT NONE
!
   REAL*8 V1,PX,PY,PUX,PUY,PCX,VAL1,VAL2,SIG,XHT,YHT &
   &,SYS12,SYS13,PCY,PUCX,PUCY,DWORD1,DWORD2,DWORD3,DWORD4
!
!     DWORD1 IS Y FOB
!     DWORD2 IS X FOB
...
!
   REAL*8 PCY,PCX,PUCY,PUCX,V1,VAL1,VAL2,SIG &
   &,XREAL,YREAL,PY,PX,PUY,PUX,HR,HP,DWORD1,DWORD2 &
   &,MYW1,MYW2,MYW3,MYW4,HPX,HPY,HRX,HRY,VALUEX,VALUEY
   REAL*8 O18,O19
   COMMON/O18O19/O18,O19
!
   LOGICAL OLDLDIF,OLDLDIF2
...
!       SET FLAGS CAFLG AND COFLG
   ...
   &ALENS(9,I).NE.0.0D0.AND.CACOCA.EQ.1) THEN
!       CLAP EXISTS
      CAFLG=INT(DABS(ALENS(9,I)))
   ELSE
      CAFLG=0
   ...
   &ALENS(16,I).NE.0.0D0.AND.CACOCA.EQ.2) THEN
!       COBS EXISTS
      COFLG=INT(DABS(ALENS(16,I)))
   ELSE
      COFLG=0
...
!       RAY IS BLOCKED BY CLAP ON SURFACE I
         ...
         IF(MSG) THEN
            IF(ALENS(9,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY CIRCULAR CLEAR APERTURE'
               CALL SHOWIT(1)
            END IF
         END IF
         STOPP=1
...
!
         ...
         IF(MSG) THEN
            IF(ALENS(9,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY RECTANGULAR CLEAR APERTURE'
               CALL SHOWIT(1)
            END IF
         END IF
!
...
!
         IF(MSG) THEN
            IF(ALENS(9,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY ELLIPTICAL CLEAR APERTURE'
               CALL SHOWIT(1)
            END IF
         END IF
!
...
!
         IF(MSG) THEN
            IF(ALENS(9,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY RACETRACK CLEAR APERTURE'
               CALL SHOWIT(1)
            END IF
         END IF
         LS=0.0D0
...
!
         IF(MSG) THEN
            IF(ALENS(9,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY POLYGON CLEAR APERTURE'
               CALL SHOWIT(1)
            END IF
         END IF
         LS=0.0D0
...
!
         IF(MSG) THEN
            IF(ALENS(9,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY IRREGULAR POLYGON CLEAR APERTURE'
               CALL SHOWIT(1)
            END IF
         END IF
         LS=0.0D0
...
!
         IF(MSG) THEN
            IF(ALENS(16,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY CIRCULAR OBSCURATION'
               CALL SHOWIT(1)
            END IF
         END IF
         STOPP=1
...
!
         IF(MSG) THEN
            IF(ALENS(16,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY RECTANGULAR OBSCURATION'
               CALL SHOWIT(1)
            END IF
         END IF
!
...
!
         IF(MSG) THEN
            IF(ALENS(16,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY ELLIPTICAL OBSCURATION'
               CALL SHOWIT(1)
            END IF
         END IF
!
...
!
         IF(MSG) THEN
            IF(ALENS(16,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY RACETRACK OBSCURATION'
               CALL SHOWIT(1)
            END IF
         END IF
         LS=0.0D0
...
!
         IF(MSG) THEN
            IF(ALENS(16,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY POLYGON OBSCURATION'
               CALL SHOWIT(1)
            END IF
         END IF
         LS=0.0D0
...
!
         IF(MSG) THEN
            IF(ALENS(16,I).GT.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE=&
               &'RAY BLOCKED BY IRREGULAR POLYGON OBSCURATION'
               CALL SHOWIT(1)
            END IF
         END IF
         LS=0.0D0
