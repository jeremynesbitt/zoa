...
!
   REAL*8 X,Y,Z,JK_X,JK_Y,JK_SAG,PRAD,PRAD1,PRAD2 ,XR,YR,LS,RS,XRD,YRD,X1,X2,X3,X4,Y1,Y2,Y3,Y4,ANGLE,X5,X6,X7,X8,Y5,Y6,Y7,Y8,XC1,XC2,XC3,XC4,YC1,YC2,YC3,YC4,RAD2,MAXSID,CS1,CS2,CS3,CS4,A15,A22
!
...
!          IW1=FIELD NUMBER
!
   REAL*8 PCY,PCX,PUCY,PUCX,V1,VAL1,VAL2,SIG ,XREAL,YREAL,PY,PX,PUY,PUX,HR,HP,HPU,HRU,FACTOR,FACTOR2 ,MYW1,MYW2,MYW3,MYW4
!
...
!          XFOB=DWORD2
!
   REAL*8 PCY,PCX,PUCY,PUCX,V1,VAL1,VAL2,SIG ,XREAL,YREAL,PY,PX,PUY,PUX,HR,HP,DWORD1,DWORD2,HUP,EEFEL ,MYW1,MYW2,MYW3,MYW4,HPU,HRU,FACTOR,FACTOR2
   REAL*8 O18,O19
   COMMON/O18O19/O18,O19
!
   LOGICAL OLDLDIF,OLDLDIF2
...
!          IW1=FIELD NUMBER
!
   REAL*8 PCY,PCX,PUCY,PUCX,V1,VAL1,VAL2,SIG ,XREAL,YREAL,PY,PX,PUY,PUX,HR,HP ,MYW1,MYW2,MYW3,MYW4
   REAL*8 O18,O19
   COMMON/O18O19/O18,O19
!
   LOGICAL OLDLDIF,OLDLDIF2
...
!
   ...
   IMPLICIT NONE
!
   REAL*8 V1,VAL1,VAL2,SIG,XHT,YHT ,SYS12,SYS13,NWN1,NWN2,NWN3,NWN4
!
   REAL*8 VALUE
   INTEGER NUM5
   COMMON/GV/VALUE,NUM5
...
!
   ...
   IMPLICIT NONE
!
   REAL*8 V1,PX,PY,PUX,PUY,PCX,VAL1,VAL2,SIG,XHT,YHT ,SYS12,SYS13,PCY,PUCX,PUCY,MYW1,MYW2,MYW3,MYW4
!
   INTEGER ERROR,GFLAG
!
   LOGICAL OLDLDIF,OLDLDIF2
...
!
   ...
   IMPLICIT NONE
!
   REAL*8 V1,PX,PY,PUX,PUY,PCX,VAL1,VAL2,SIG,XHT,YHT ,SYS12,SYS13,PCY,PUCX,PUCY,DWORD1,DWORD2,DWORD3,DWORD4
!
!     DWORD1 IS Y FOB
!     DWORD2 IS X FOB
...
!          XFOB=DWORD2
!
   REAL*8 PCY,PCX,PUCY,PUCX,V1,VAL1,VAL2,SIG ,XREAL,YREAL,PY,PX,PUY,PUX,HR,HP,DWORD1,DWORD2 ,MYW1,MYW2,MYW3,MYW4,HPX,HPY,HRX,HRY,VALUEX,VALUEY
   REAL*8 O18,O19
   COMMON/O18O19/O18,O19
!
   LOGICAL OLDLDIF,OLDLDIF2
...
!
   REAL*8 X,Y,Z,ANGLE,JK1,JK2,JK3,XR,YR,LS,RS,XRD,YRD,X1,X2,X3,X4,Y1,Y2,Y3,Y4,X5,X6,X7,X8,Y5,Y6,Y7,Y8,XC1,XC2,XC3,XC4,YC1,YC2,YC3,YC4,RAD2,MAXSID,CS1,CS2,CS3,CS4,A15,A22
!
   LOGICAL INS,INSID1,INSID2
!
   LOGICAL NOCOBSPSF
