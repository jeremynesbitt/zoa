...
!
   ...
   IF(sys_units().EQ.3.0D0) UN='MM    '
   IF(sys_units().EQ.4.0D0) UN='METERS'
   YSTEP=120
!
...
!     SET WAVELENGTH TO THE CONTROL WAVELENGTH
      WAVEL1=sys_wavelength(INT(sys_wl_ref()))
   END IF
!
...
!     LINE 10, PERMANENT BOXED DATA
   ...
   IF(DABS(POD1).GT.(3.0D0/2.0D0*DABS(ALENS(3,DRAWSURF)))) THEN
      TMPVAL=DABS(POD1)
      IF(sys_units().EQ.1.0D0) TMPVAL=TMPVAL*1000.0D0
      IF(sys_units().EQ.2.0D0) TMPVAL=TMPVAL*1000.0D0/2.54D0
      IF(sys_units().EQ.3.0D0) TMPVAL=TMPVAL*1000.0D0/25.4D0
      IF(sys_units().EQ.4.0D0) TMPVAL=TMPVAL*1.0D6/25.4
...
!
!     DIATOL
   IF(sys_units().EQ.1.0D0) DIATOL=0.002D0
   IF(sys_units().EQ.2.0D0) DIATOL=0.002D0*2.54D0
   IF(sys_units().EQ.3.0D0) DIATOL=0.002D0*25.4D0
   IF(sys_units().EQ.4.0D0) DIATOL=(0.002D0*25.4D0)/1000.0D0
!
!     RADTOL
...
!
!     THICKNESS TOLERANCE
   IF(sys_units().EQ.1.0D0) THITOL=0.002D0
   IF(sys_units().EQ.2.0D0) THITOL=0.002D0*2.54D0
   IF(sys_units().EQ.3.0D0) THITOL=0.002D0*25.4D0
   IF(sys_units().EQ.4.0D0) THITOL=(0.002D0*25.4D0)/1000.0D0
!
!     CLEARAP FOR NOTES ONLY
   IF(.NOT.CLP1SET) THEN
      IF(sys_units().EQ.1.0D0) CLP1=(2.0D0*PODA1)-0.08D0
      IF(sys_units().EQ.2.0D0) CLP1=(2.0D0*PODA1)-(0.08D0*2.54D0)
      IF(sys_units().EQ.3.0D0) CLP1=(2.0D0*PODA1)-(0.08D0*25.4D0)
      IF(sys_units().EQ.4.0D0) CLP1=(2.0D0*PODA1)-&
      &((0.08D0*25.4D0)/1000.0D0)
   END IF
   IF(.NOT.CLP2SET) THEN
      IF(sys_units().EQ.1.0D0) CLP2=(2.0D0*PODB1)-0.08D0
      IF(sys_units().EQ.2.0D0) CLP2=(2.0D0*PODB1)-(0.08D0*2.54D0)
      IF(sys_units().EQ.3.0D0) CLP2=(2.0D0*PODB1)-(0.08D0*25.4D0)
      IF(sys_units().EQ.4.0D0) CLP2=(2.0D0*PODB1)-&
      &((0.08D0*25.4D0)/1000.0D0)
   END IF
!
!     SURFQUAL
...
!
!     EDGE BREAK
   IF(sys_units().EQ.1.0D0) BRKEDG=0.002D0
   IF(sys_units().EQ.2.0D0) BRKEDG=0.002D0*2.54D0
   IF(sys_units().EQ.3.0D0) BRKEDG=0.002D0*25.4D0
   IF(sys_units().EQ.4.0D0) BRKEDG=(0.002D0*25.4D0)/1000.0D0
!
!     COAT
   SURCOAT='(UNCOATED)          '
!
!     SAGTOL
   IF(sys_units().EQ.1.0D0) SAGTL1=(0.002D0)
   IF(sys_units().EQ.2.0D0) SAGTL1=(0.002D0*2.54D0)
   IF(sys_units().EQ.3.0D0) SAGTL1=(0.002D0*25.4D0)
   IF(sys_units().EQ.4.0D0) SAGTL1=((0.002D0*25.4D0)/1000.0D0)
   IF(sys_units().EQ.1.0D0) SAGTL2=(0.002D0)
   IF(sys_units().EQ.2.0D0) SAGTL2=(0.002D0*2.54D0)
   IF(sys_units().EQ.3.0D0) SAGTL2=(0.002D0*25.4D0)
   IF(sys_units().EQ.4.0D0) SAGTL2=((0.002D0*25.4D0)/1000.0D0)
!
!     PRPNTL
   PRPNTL1=1.0D0
   PRPNTL2=1.0D0
...
!
!     AXIAL THICKNESS IS:
   IF(sys_units().EQ.1.0D0) TH=ALENS(3,DRAWSF)
   IF(sys_units().EQ.2.0D0) TH=ALENS(3,DRAWSF)/2.54D0
   IF(sys_units().EQ.3.0D0) TH=ALENS(3,DRAWSF)/25.4D0
   IF(sys_units().EQ.4.0D0) TH=1000.0D0*ALENS(3,DRAWSF)/25.4D0
!
!     EDGE OFFSETS
   DZ1=ALENS(14,DRAWSF)
   DZ2=ALENS(14,DRAWSF+1)
   IF(sys_units().EQ.1) DZ1=DZ1
   IF(sys_units().EQ.2) DZ1=DZ1/2.54D0
   IF(sys_units().EQ.3) DZ1=DZ1/25.4D0
   IF(sys_units().EQ.4) DZ1=1000.0D0*DZ1/25.4D0
   IF(sys_units().EQ.1) DZ2=DZ2
   IF(sys_units().EQ.2) DZ2=DZ2/2.54D0
   IF(sys_units().EQ.3) DZ2=DZ2/25.4D0
   IF(sys_units().EQ.4) DZ2=1000.0D0*DZ2/25.4D0
!
!     PART OD
...
!     SAG AT OD
   ...
   IF(ERROR) RETURN
   IF(sys_units().EQ.1.0D0) SAGOD1=Z
   IF(sys_units().EQ.2.0D0) SAGOD1=Z/2.54D0
   IF(sys_units().EQ.3.0D0) SAGOD1=Z/25.4D0
   IF(sys_units().EQ.4.0D0) SAGOD1=1000.0D0*Z/25.4D0
   X=0.0D0
   Y=OD
   ERROR=.FALSE.
   CALL SAGRET(DRAWSF+1,X,Y,Z,ERROR)
   IF(ERROR) RETURN
   IF(sys_units().EQ.1.0D0) SAGOD2=Z
   IF(sys_units().EQ.2.0D0) SAGOD2=Z/2.54D0
   IF(sys_units().EQ.3.0D0) SAGOD2=Z/25.4D0
   IF(sys_units().EQ.4.0D0) SAGOD2=1000.0D0*Z/25.4D0
!
!     SAG AT RADIUS TO FLAT
   ...
   CALL SAGRET(DRAWSF,X,Y,Z,ERROR)
   IF(ERROR) RETURN
   IF(sys_units().EQ.1.0D0) SAGODFLT1=Z
   IF(sys_units().EQ.2.0D0) SAGODFLT1=Z/2.54D0
   IF(sys_units().EQ.3.0D0) SAGODFLT1=Z/25.4D0
   IF(sys_units().EQ.4.0D0) SAGODFLT1=1000.0D0*Z/25.4D0
   Y=ODFLAT2
   ERROR=.FALSE.
   CALL SAGRET(DRAWSF+1,X,Y,Z,ERROR)
   IF(ERROR) RETURN
   IF(sys_units().EQ.1.0D0) SAGODFLT2=Z
   IF(sys_units().EQ.2.0D0) SAGODFLT2=Z/2.54D0
   IF(sys_units().EQ.3.0D0) SAGODFLT2=Z/25.4D0
   IF(sys_units().EQ.4.0D0) SAGODFLT2=1000.0D0*Z/25.4D0
!
!     LOAD SAG ARRAYS WITH DATA REFERENCED TO EACH SURFACE VERTEX
   DO I=1,2
      ...
      DO K=1,180
         ...
         IF(ERROR) RETURN
         IF(sys_units().EQ.1.0D0) SAGVAL(I,K)=Z
         IF(sys_units().EQ.2.0D0) SAGVAL(I,K)=Z/2.54D0
         IF(sys_units().EQ.3.0D0) SAGVAL(I,K)=Z/25.4D0
         IF(sys_units().EQ.4.0D0) SAGVAL(I,K)=1000.0D0*Z/25.4D0
         Y=Y+ODSTEP
      END DO
   END DO
   IF(sys_units().EQ.1.0D0)           OD=OD
   IF(sys_units().EQ.1.0D0)           OD1=OD1
   IF(sys_units().EQ.1.0D0)           OD2=OD2
   IF(sys_units().EQ.1.0D0) ODFLAT1=ODFLAT1
   IF(sys_units().EQ.1.0D0) ODFLAT2=ODFLAT2
   IF(sys_units().EQ.1.0D0)   ODSTEP=ODSTEP
   IF(sys_units().EQ.2.0D0)           OD=OD/2.54D0
   IF(sys_units().EQ.2.0D0)           OD1=OD1/2.54D0
   IF(sys_units().EQ.2.0D0)           OD2=OD2/2.54D0
   IF(sys_units().EQ.2.0D0) ODFLAT1=ODFLAT1/2.54D0
   IF(sys_units().EQ.2.0D0) ODFLAT2=ODFLAT2/2.54D0
   IF(sys_units().EQ.2.0D0)   ODSTEP=ODSTEP/2.54D0
   IF(sys_units().EQ.3.0D0)           OD=OD/25.4D0
   IF(sys_units().EQ.3.0D0)           OD1=OD1/25.4D0
   IF(sys_units().EQ.3.0D0)           OD2=OD2/25.4D0
   IF(sys_units().EQ.3.0D0) ODFLAT1=ODFLAT1/25.4D0
   IF(sys_units().EQ.3.0D0) ODFLAT2=ODFLAT2/25.4D0
   IF(sys_units().EQ.3.0D0)   ODSTEP=ODSTEP/25.4D0
   IF(sys_units().EQ.4.0D0)           OD=1000.0D0*OD/25.4D0
   IF(sys_units().EQ.4.0D0)           OD1=1000.0D0*OD1/25.4D0
   IF(sys_units().EQ.4.0D0)           OD2=1000.0D0*OD2/25.4D0
   IF(sys_units().EQ.4.0D0) ODFLAT1=1000.0D0*ODFLAT1/25.4D0
   IF(sys_units().EQ.4.0D0) ODFLAT2=1000.0D0*ODFLAT2/25.4D0
   IF(sys_units().EQ.4.0D0)   ODSTEP=1000.0D0*ODSTEP/25.4D0
...
!     PARTDRAW
   IF(WC.EQ.'PARTDRAW') THEN
      ...
      IF(S1.EQ.0) THEN
         ...
         RETURN
      END IF
      IF(W1.GE.sys_last_surf().OR.W1.LE.0.0D0) THEN
         OUTLYNE=&
...
!     MAKE CHANGES TO THE SURFACE
   SFNUMBER=INT(W1)
   TPVALUE=W2
   IF(sys_units().EQ.1.0D0) TPVALUE=TPVALUE/25.4D0
   IF(sys_units().EQ.2.0D0) TPVALUE=TPVALUE/10.0D0
   IF(sys_units().EQ.3.0D0) TPVALUE=TPVALUE
   IF(sys_units().EQ.4.0D0) TPVALUE=TPVALUE/1000.0D0
