...
!       CHECK FOR STRING INPUT
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      ...
      & '"OPDIF" TAKES NO STRING OR NUMERICAL INPUT'//'\n'//&
      & 'RE-ENTER COMMAND', 1)
      RETURN
   END IF
!       QUALIFIERS
   ...
   IF(SQ.EQ.0) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & '"OPDIF" REQUIRES EXPLICIT QUALIFIER INPUT'//'\n'//&
      & 'RE-ENTER COMMAND', 1)
      RETURN
   END IF
...
!       CHECK FOR STRING INPUT
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & '"DIFRAY" TAKES NO STRING OR NUMERICAL INPUT'//'\n'//&
      & 'RE-ENTER COMMAND', 1)
      RETURN
   END IF
!       QUALIFIERS
   ...
   IF(SQ.EQ.0) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & '"DIFRAY" REQUIRES EXPLICIT QUALIFIER INPUT'//'\n'//&
      & 'RE-ENTER COMMAND', 1)
      RETURN
   END IF
...
!       CHECK FOR STRING INPUT
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & '"DIFFOB" TAKES NO STRING OR NUMERICAL INPUT'//'\n'//&
      & 'RE-ENTER COMMAND', 1)
      RETURN
   END IF
!       QUALIFIERS
   ...
   IF(SQ.EQ.0) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & '"DIFFOB" REQUIRES EXPLICIT QUALIFIER INPUT'//'\n'//&
      & 'RE-ENTER COMMAND', 1)
      RETURN
   END IF
...
!       CHECK FOR STRING INPUT
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & '"VIRTRAY" TAKES NO STRING OR NUMERICAL INPUT'//'\n'//&
      & 'RE-ENTER COMMAND', 1)
      RETURN
   END IF
!       QUALIFIERS
   ...
   IF(SQ.EQ.0) THEN
      CALL REPORT_ERROR_AND_FAIL(&
      & '"VIRTRAY" REQUIRES EXPLICIT QUALIFIER INPUT'//'\n'//&
      & 'RE-ENTER COMMAND', 1)
      RETURN
   END IF
...
!
         IF(WC.EQ.'TH') THEN
            ...
            CALL SHOWIT(1)
            CALL REPORT_ERROR_AND_FAIL('IN THE UPDATE LENS MODE'//'\n'//'NO ACTION TAKEN', 1)
            RETURN
         END IF
!
!
...
!       COMMAND (INS,W1)
      IF(WC.EQ.'INSK') THEN
         IF(F12.NE.1) THEN
            CALL REPORT_ERROR_AND_FAIL(&
            & '"INS" ONLY WORKS IN CONFIGURATION #1 (MAIN CONFIG)'//'\n'//&
            & 'NO ACTION TAKEN', 1)
            RETURN
         END IF
         CALL SINS
...
!       COMMAND (DEL,W1 W2)
      IF(WC.EQ.'DELK') THEN
         IF(F12.NE.1) THEN
            CALL REPORT_ERROR_AND_FAIL(&
            & '"DEL" ONLY WORKS IN CONFIGURATION #1 (MAIN CONFIG)'//'\n'//&
            & 'NO ACTION TAKEN', 1)
            RETURN
         END IF
         CALL SDEL
...
!       COMMAND (AH,AI,AJ,AK,AL)
      IF(WC.EQ.'ACK'.OR.WC.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.&
...
!
   ...
   &.OR.WQ.EQ.'PSH'.OR.WQ.EQ.'PRO') THEN
      IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         CALL REPORT_ERROR_AND_FAIL(&
         & '"LIB" TAKES NO NUMERIC WORD #3 TO #5 INPUT'//'\n'//&
         & 'RE-ENTER COMMAND', 1)
         RETURN
      END IF
      ...
      &W1.GT.999.0.AND.DF1.NE.1) THEN
         CALL REPORT_ERROR_AND_FAIL(&
         & 'NUMERIC WORD 1 BEYOND LEGAL RANGE'//'\n'//&
         & 'RE-ENTER COMMAND', 1)
         RETURN
      END IF
      ...
      &W2.GT.999.0.AND.DF2.NE.1) THEN
         CALL REPORT_ERROR_AND_FAIL(&
         & 'NUMERIC WORD 2 BEYOND LEGAL RANGE'//'\n'//&
         & 'RE-ENTER COMMAND', 1)
         RETURN
      END IF
      IF(S2.EQ.1) THEN
...
!
   IF(WQ.EQ.'PUT') THEN
      IF(S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         CALL REPORT_ERROR_AND_FAIL(&
         & '"LIB PUT" TAKES NO NUMERIC WORD #2 TO #5 INPUT'//'\n'//&
         & 'RE-ENTER COMMAND', 1)
         RETURN
      END IF
      IF(W1.LT.1.0.AND.DF1.NE.1.OR.&
...
!       IS NW1 DEFAULT
      IF(WQ.EQ.'GET') THEN
         IF(DF1.EQ.1) THEN
            CALL REPORT_ERROR_AND_FAIL(&
            & '"LIB GET" REQUIRES EXPLICIT NUMERIC INPUT'//'\n'//&
            & 'RE-ENTER COMMAND', 1)
            RETURN
         END IF
      ELSE
...
!
   IF(WQ.EQ.'DELK') THEN
      IF(SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         CALL REPORT_ERROR_AND_FAIL(&
         & '"LIB DEL" ONLY TAKES NUMERIC WORD #1 AND #2 INPUT'//'\n'//&
         & 'RE-ENTER COMMAND', 1)
         RETURN
      END IF
      IF(W1.LT.1.0.AND.DF1.NE.1.OR.&
...
!       IS NW1 AND NW2 DEFAULT
      IF(DF1.EQ.1.AND.DF2.EQ.1) THEN
         CALL REPORT_ERROR_AND_FAIL(&
         & '"LIB DEL" REQUIRES EXPLICIT NUMERIC INPUT'//'\n'//&
         & 'RE-ENTER COMMAND', 1)
         RETURN
      END IF
   END IF
...
!       IF YOU GOT HERE, LIBRARY WAS FULL
         CALL REPORT_ERROR_AND_FAIL('LENS LIBRARY FULL, LENS NOT FILED', 1)
         RETURN
11       CONTINUE
...
!       SLOT OCCUPIED
            ...
            CALL SHOWIT(1)
            CALL REPORT_ERROR_AND_FAIL('LENS NOT FILED', 1)
            RETURN
         END IF
      END IF
