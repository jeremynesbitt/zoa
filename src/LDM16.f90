...
SUBROUTINE OPENLIBDAT(fileID)
   ...
   OPEN(UNIT=fileID,ACCESS='DIRECT',FILE=trim(LIBLEN)//'LIB.DAT',FORM='UNFORMATTED',RECL=rec22,STATUS='UNKNOWN')
...
SUBROUTINE OPENLIBTAGDAT(fileID)
   ...
   if(existTag) then
      ...
      OPEN(UNIT=fileID,ACCESS='DIRECT',FILE=trim(LIBLEN)//'LIBTAG.DAT',FORM='UNFORMATTED',RECL=rec27,STATUS='UNKNOWN')
...
!       ***************************************************************
   ...
   K=0
   DO 10 I=1,999
      call READLENSLIBLINEANDTAG(uLIB, uLIBTAG, I, II,DATA, IDTAG)
      IF(II.NE.0) THEN
!       FOUND A STORED LENS
         J=J+1
         JJ=JJ+1
...
!               LENS LIBRARY COMMANDS
   IF(SQ.EQ.1.AND.WQ.NE.'P'.AND.WQ.NE.'PUT'.AND.WQ.NE.'GET'.AND.WQ.NE.'DELK'.AND.WQ.NE.'GETES'.AND.WQ.NE.'GETMG'.AND.WQ.NE.'GETNC'.AND.WQ.NE.'GETSH'.AND.WQ.NE.'PNC'.AND.WQ.NE.'PMG'.AND.WQ.NE.'PES'.AND.WQ.NE.'PSH'.AND.WQ.NE.'PRO'.AND.WQ.NE.'GETRO') THEN
      OUTLYNE='INVALID QUALIFIER WORD USED WITH THE "LIB" COMMAND'
      CALL SHOWIT(1)
   ...
   END IF
   IF(SQ.EQ.0) THEN
      OUTLYNE='"LIB" REQUIRES EXPLICIT QUALIFIER WORD INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      RETURN
   ...
   IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      OUTLYNE='"LIB" TAKES NO STRING OR NUMERIC WORD #3, #4 OR #5 INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      RETURN
   END IF
   IF(WQ.EQ.'P'.OR.WQ.EQ.'PMG'.OR.WQ.EQ.'PES'.OR.WQ.EQ.'PNC'.OR.WQ.EQ.'PSH'.OR.WQ.EQ.'GETMG'.OR.WQ.EQ.'GETES'.OR.WQ.EQ.'GETNC'.OR.WQ.EQ.'GETSH'.OR.WQ.EQ.'PUT'.OR.WQ.EQ.'PRO'.OR.WQ.EQ.'GETRO'.OR.WQ.EQ.'GET'.OR.WQ.EQ.'DELK') THEN
      CALL LLIBRY
      CALL FIXCURLENS
      RETURN
   ELSE
...
!
   IF(STI.EQ.1) THEN
      ...
      CALL SHOWIT(0)
100   FORMAT('DIFFERNTIAL RAY TRACING "ON" IN PRE-DEFINED OPERANDS')
200   FORMAT('DIFFERNTIAL RAY TRACING "OFF" IN PRE-DEFINED OPERANDS')
      RETURN
   END IF
...
!
   IF(STI.EQ.1) THEN
      ...
      CALL SHOWIT(0)
100   FORMAT('DIFFERNTIAL RAY TRACING IS CURRENTLY ACTIVE')
200   FORMAT('DIFFERNTIAL RAY TRACING IS CURRENTLY "NOT" ACTIVE')
      RETURN
   END IF
!       CHECK FOR STRING INPUT
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
...
!
   IF(STI.EQ.1) THEN
      ...
      CALL SHOWIT(0)
100   FORMAT('DIFFERNTIAL REFERENCE RAY TRACING IS CURRENTLY ACTIVE')
200   FORMAT('DIFFERNTIAL REFERENCE RAY TRACING IS CURRENTLY "NOT" ACTIVE')
      RETURN
   END IF
!       CHECK FOR STRING INPUT
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
...
!
   IF(STI.EQ.1) THEN
      ...
      CALL SHOWIT(0)
100   FORMAT('VIRTUAL RAYS WILL NOT BE PLOTTED (PROGRAM DEFAULT)')
200   FORMAT('VIRTUAL RAYS WILL BE PLOTTED')
      RETURN
   END IF
!       CHECK FOR STRING INPUT
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
...
!
!
   IF(S2.EQ.1.OR.SQ.EQ.1.OR.SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      IF(WC.EQ.'LEPRT') WRITE(OUTLYNE,*)'"LEPRT" TAKES NO QUALIFIER, STRING OR NUMERIC WORD'
      IF(WC.EQ.'LIS') WRITE(OUTLYNE,*)'"LIS" TAKES NO QUALIFIER, STRING OR NUMERIC WORD'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'"#2 THROUGH #5 INPUT'
      CALL SHOWIT(1)
      CALL MACFAL
      RETURN
   END IF
   IF(STI.EQ.1) THEN
      WRITE(OUTLYNE,*)'"LEPRT/LIS" LISTS ALL LENS DATA'
      CALL SHOWIT(1)
      CALL MACFAL
      RETURN
   END IF
...
!       IS HANDLED
   IF(STI.EQ.1) THEN
      ...
      RETURN
   END IF
!       CERTAIN COMMANDS ARE NOT ALLOWED IF SURF=sys_last_surf()
!       THEY ARE TH,PY,PCY,PX,PCX,CAY,CAX,PIKUP TH,
   IF(SURF.EQ.INT(sys_last_surf())) THEN
      IF(WC.EQ.'PY'.OR.WC.EQ.'PCY'.OR.WC.EQ.'PX'.OR.WC.EQ.'PCX'.OR.WC.EQ.'CAY'.OR.WC.EQ.'CAX'.OR.WC.EQ.'PIKUP'.AND.WQ.EQ.'TH') THEN
...
!
         IF(WC.EQ.'TH') THEN
            OUTLYNE='THE "TH" COMMAND IS NOT VALID AT THE IMAGE SURFACE'
            CALL SHOWIT(1)
...
!
         IF(WC.EQ.'PY') THEN
            OUTLYNE='THE "PY" COMMAND IS NOT VALID AT THE IMAGE SURFACE'
            CALL SHOWIT(1)
            OUTLYNE='IN THE UPDATE LENS MODE'
            CALL SHOWIT(1)
            OUTLYNE='NO ACTION TAKEN'
...
!
         IF(WC.EQ.'PCY') THEN
            OUTLYNE='THE "PCY" COMMAND IS NOT VALID AT THE IMAGE SURFACE'
            CALL SHOWIT(1)
            OUTLYNE='IN THE UPDATE LENS MODE'
            CALL SHOWIT(1)
            OUTLYNE='NO ACTION TAKEN'
...
!
         IF(WC.EQ.'CAY') THEN
            OUTLYNE='THE "CAY" COMMAND IS NOT VALID AT THE IMAGE SURFACE'
            CALL SHOWIT(1)
            OUTLYNE='IN THE UPDATE LENS MODE'
            CALL SHOWIT(1)
            OUTLYNE='NO ACTION TAKEN'
...
!
         IF(WC.EQ.'PX') THEN
            OUTLYNE='THE "PX" COMMAND IS NOT VALID AT THE IMAGE SURFACE'
            CALL SHOWIT(1)
            OUTLYNE='IN THE UPDATE LENS MODE'
            CALL SHOWIT(1)
            OUTLYNE='NO ACTION TAKEN'
...
!
         IF(WC.EQ.'PCX') THEN
            OUTLYNE='THE "PCX" COMMAND IS NOT VALID AT THE IMAGE SURFACE'
            CALL SHOWIT(1)
            OUTLYNE='IN THE UPDATE LENS MODE'
            CALL SHOWIT(1)
            OUTLYNE='NO ACTION TAKEN'
...
!
         IF(WC.EQ.'CAX') THEN
            OUTLYNE='THE "CAX" COMMAND IS NOT VALID AT THE IMAGE SURFACE'
            CALL SHOWIT(1)
            OUTLYNE='IN THE UPDATE LENS MODE'
            CALL SHOWIT(1)
            OUTLYNE='NO ACTION TAKEN'
...
!
         IF(WC.EQ.'PIKUP'.AND.WQ.EQ.'TH') THEN
            OUTLYNE='THE "PIKUP TH" COMMAND IS NOT VALID AT THE IMAGE SURFACE'
            CALL SHOWIT(1)
            OUTLYNE='IN THE UPDATE LENS MODE'
            CALL SHOWIT(1)
            OUTLYNE='NO ACTION TAKEN'
...
!       COMMAND (DEFORM)
      IF(WC.EQ.'DEFORM') THEN
         IF(surf_special_type(SURF) /= 0) THEN
            OUTLYNE='A SPECIAL SURFACE MAY NOT BE DEFINED AS A DEFORMABLE SURFACE'
            CALL SHOWIT(1)
            OUTLYNE='RE-ENTER COMMAND'
            CALL SHOWIT(1)
            CALL MACFAL
...
!       COMMAND (DELDEFOR)
      IF(WC.EQ.'DELDEFOR') THEN
         IF(surf_default_flag(SURF) == 0) THEN
            OUTLYNE='NO DEFORMABLE SURFACE DEFINITION EXISTS TO BE DELETED'
            CALL SHOWIT(1)
            OUTLYNE='RE-ENTER COMMAND'
            CALL SHOWIT(1)
            CALL MACFAL
...
!       COMMAND ((GLASS CAT NAME) [INDENTIFICATION])
      IF(WC.EQ.'SCHOTT'.OR.WC.EQ.'OHARA'.OR.WC.EQ.'CHANCE'.OR.WC.EQ.'CORNIN'.OR.WC.EQ.'RADHARD'.OR.WC.EQ.'MATL'.OR.WC.EQ.'GLAK'.OR.WC.EQ.'USER'.OR.WC.EQ.'RUSSIAN'.OR.WC.EQ.'HIKARI'.OR.WC.EQ.'SCH2000'.OR.WC.EQ.'HOYA'.OR.WC.EQ.'GLCAT') THEN
         CALL GLSCAT
         RETURN
      END IF
!       COMMAND (MULTCLAP)
...
!       COMMAND (AH,AI,AJ,AK,AL)
      IF(WC.EQ.'AC'.OR.WC.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF'.OR.WC.EQ.'AG'.OR.WC.EQ.'ADTOR'.OR.WC.EQ.'AETOR'.OR.WC.EQ.'AFTOR'.OR.WC.EQ.'AGTOR'.OR.WC.EQ.'AH'.OR.WC.EQ.'AI'.OR.WC.EQ.'AJ'.OR.WC.EQ.'AK'.OR.WC.EQ.'AL') THEN
         CALL SDEFG
         RETURN
      END IF
...
!       AND DELETIONS TSD
      IF(WC.EQ.'PY'.OR.WC.EQ.'PX'.OR.WC.EQ.'PCY'.OR.WC.EQ.'TSD'.OR.WC.EQ.'REDSLV'.OR.WC.EQ.'PCX'.OR.WC.EQ.'CAY'.OR.WC.EQ.'CAX') THEN
...
!       AND DELETIONS CSD,CSDX,CSDY
      IF(WC.EQ.'APY'.OR.WC.EQ.'PIY'.OR.WC.EQ.'PUY'.OR.WC.EQ.'APCY'.OR.WC.EQ.'PICY'.OR.WC.EQ.'PUCY'.OR.WC.EQ.'COCY'.OR.WC.EQ.'APX'.OR.WC.EQ.'PIX'.OR.WC.EQ.'PUX'.OR.WC.EQ.'APCX'.OR.WC.EQ.'PICX'.OR.WC.EQ.'PUCX'.OR.WC.EQ.'COCX'.OR.WC.EQ.'CSD'.OR.WC.EQ.'CSDX'.OR.WC.EQ.'CSDY') THEN
         CALL CVSOLV
         RETURN
      END IF
!       COMMANDS (PIKUP)
...
SUBROUTINE READLENSLIBLINEANDTAG(ioLIB, ioTAG, recNum, idx,DATA, IDTAG)
   implicit none
...
SUBROUTINE WRITELENSLIBLINEANDTAG(ioLIB, ioTAG, recNum, idx,DATA, IDTAG, boolCallDogTag)
   implicit none
   integer, intent(in) :: ioLIB, ioTag, recNum
...
!                       DEFINE VARIABLES
!
   CHARACTER DATA*80,AI4*4,AI*3,LLIP*80,WCOLD*8,DDATE*10,TTIME*8,AN*3 ,FN*10,NM*8,TTTIM*8,DDDAT*10,LNDIR*7
!
...
!
   INTEGER KPIK,KLEN,KK,SING,LCNT,I,II,J,N,K,JK,KSP,OLDOUT,OLDSQ,OLDSN,OLDIN,IREND,N3,JJ,OLDOUT1
!
   INTEGER FLG(0:20),SUR,ALL,IEND,rec27, uLIB, uLIBTAG
!
   COMMON/FFL/FLG
!
!
...
!
   IF(WQ.EQ.'P'.OR.WQ.EQ.'PMG'.OR.WQ.EQ.'PES'.OR.WQ.EQ.'PNC'.OR.WQ.EQ.'PSH'.OR.WQ.EQ.'PRO') THEN
      IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
...
!       NW1 CAN BE 1 TO 999 OR BLANK
!
   IF(WQ.EQ.'GET'.OR.WQ.EQ.'GETMG'.OR.WQ.EQ.'GETES'.OR.WQ.EQ.'GETNC'.OR.WQ.EQ.'GETSH'.OR.WQ.EQ.'GETRO') THEN
      IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         IF(WQ.EQ.'GET') THEN
            OUTLYNE='"LIB '//WQ(1:3)//'" ONLY TAKES NUMERIC WORD #1 INPUT'
            CALL SHOWIT(1)
            OUTLYNE='RE-ENTER COMMAND'
            CALL SHOWIT(1)
         ELSE
            OUTLYNE='"LIB '//WQ(1:5)//'" ONLY TAKES NUMERIC WORD #1 INPUT'
            CALL SHOWIT(1)
            OUTLYNE='RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
...
!       IS NW1 DEFAULT
      ...
      ELSE
         IF(DF1.EQ.1) THEN
            OUTLYNE='"LIB '//WQ(1:5)//'" REQUIRES EXPLICIT NUMERIC INPUT'
            CALL SHOWIT(1)
            OUTLYNE='RE-ENTER COMMAND'
            CALL SHOWIT(1)
            CALL MACFAL
...
!       ALL NOT 1 SET II=INT(W1)
         ...
         call READLENSLIBLINEANDTAG(uLIB, uLIBTAG, II, J,DATA, IDTAG)
...
!       FILE THE NUMBER AND NAME IN THE LIBRARY
      ...
      call WRITELENSLIBLINEANDTAG(uLIB, uLIBTAG, II, II,LLIP, IDTAG, .TRUE.)
...
!
      ...
      OPEN(UNIT=33,ACCESS='SEQUENTIAL',BLANK='NULL',FORM='FORMATTED',FILE=trim(LIBLEN)//FN ,STATUS='UNKNOWN')
!
!**********************************************************
...
!       ***************************************************************
      ...
      call READLENSLIBLINEANDTAG(uLIB, uLIBTAG, INT(W1), II,DATA, IDTAG)
...
!       TO USE
      ...
      IF (EXISTFN) THEN
         OPEN(UNIT=33,ACCESS='SEQUENTIAL',BLANK='NULL',FORM='FORMATTED',FILE=trim(LIBLEN)//FN ,STATUS='UNKNOWN', ACTION='READ')
      ELSE
...
3141  READ(UNIT=33,FMT=100,END=8888,ERR=8888) INPUT
      ...
      IF(INPUT(1:8).EQ.'FLDSRAYS') THEN
         ...
         DO I=1,200
            READ(33,*) AI,FIELDY(I),FIELDX(I),FIELDZ(I),N3
            FIELDW(I)=DBLE(N3)
...
!       ***************************************************************
         ...
         IF(.NOT.EXISJK) THEN
            IF(LIBLEN.NE.'LIBLEN\') THEN
               WRITE(OUTLYNE,*)'THE LENS LIBRARY IN LIBRARY DIRECTORY = ',LIBLEN
               CALL SHOWIT(1)
...
!       DUMP THE LIBRARY FILE
            ...
            IF(N.GT.9.AND.N.LE.99) FN='LIB0'//AN(2:3)//'.DAT'
            IF(N.GT.99.AND.N.LE.999) FN='LIB'//AN(1:3)//'.DAT'
            OPEN(UNIT=33,ACCESS='SEQUENTIAL',BLANK='NULL',FORM='FORMATTED',FILE=LIBLEN//FN ,STATUS='UNKNOWN')
...
!       NOT EMPTY, DELETE ENTRY
            II=0
            DATA=AA//AA//AA//AA
            call WRITELENSLIBLINEANDTAG(uLIB, uLIBTAG, I, II,DATA, IDTAG, .TRUE.)
