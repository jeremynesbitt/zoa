...
!
            CALL KDP_EXEC('U L')
            CALL KDP_EXEC('CHG '//AIV1)
            CALL KDP_EXEC('DEC 0 0 0')
            CALL KDP_EXEC('TILTD')
            CALL KDP_EXEC('EOS')
      INPUT='U L'
      CALL PROCES
...
!
            CALL KDP_EXEC('U L')
            CALL KDP_EXEC('CHG '//AIV1)
            CALL KDP_EXEC('GDX '//AXDEC)
            CALL KDP_EXEC('GDY '//AYDEC)
            CALL KDP_EXEC('GDZ '//AZDEC)
            CALL KDP_EXEC('GALPHA '//AALPHA)
            CALL KDP_EXEC('GBETA '//ABETA)
            CALL KDP_EXEC('GGAMMA '//AGAMMA)
      SAVE_KDP(20)=SAVEINPT(20)
