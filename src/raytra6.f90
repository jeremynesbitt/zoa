...
!     A IS LINE SPACING IN MICRONS
   IF(SYSTEM(6).EQ.1.0D0) A=surf_grating_spacing(I)*25.4D0*1.0D3
   IF(SYSTEM(6).EQ.2.0D0) A=surf_grating_spacing(I)*10.0D0*1.0D3
   IF(SYSTEM(6).EQ.3.0D0) A=surf_grating_spacing(I)*1.0D3
   IF(SYSTEM(6).EQ.4.0D0) A=surf_grating_spacing(I)*1.0D6
...
!     CHECK WAVELENGTH
   IF(V1.NE.1.0D0.AND.V1.NE.2.0D0.AND.V1.NE.3.0D0.AND.V1.NE.4.0D0.AND.V1.NE.5.0D0.AND.V1.NE.6.0D0.AND.V1.NE.7.0D0.AND.V1.NE.8.0D0.AND.V1.NE.9.0D0.AND.V1.NE.10.0D0) THEN
      ...
      RETURN
   END IF
   IF(V1.EQ.1.0D0.AND.SYSTEM(1).EQ.0.0D0.OR.V1.EQ.2.0D0.AND.SYSTEM(2).EQ.0.0D0.OR.V1.EQ.3.0D0.AND.SYSTEM(3).EQ.0.0D0.OR.V1.EQ.4.0D0.AND.SYSTEM(4).EQ.0.0D0.OR.V1.EQ.5.0D0.AND.SYSTEM(5).EQ.0.0D0.OR.V1.EQ.6.0D0.AND.SYSTEM(71).EQ.0.0D0.OR.V1.EQ.7.0D0.AND.SYSTEM(72).EQ.0.0D0.OR.V1.EQ.8.0D0.AND.SYSTEM(73).EQ.0.0D0.OR.V1.EQ.9.0D0.AND.SYSTEM(74).EQ.0.0D0.OR.V1.EQ.10.0D0.AND.SYSTEM(75).EQ.0.0D0) THEN
      ERROR=1
      RETURN
   END IF
!     WAVELENGTHS ARE OK
