...
!
   ...
   END IF
   IF(SST.EQ.1) THEN
      CALL REPORT_ERROR_AND_FAIL('"PLOT INTEN" TAKES NO STRING INPUT'//'\n'//'RE-ENTER COMMAND', 1)
      RETURN
   END IF
   IF(WQ.EQ.'INTEN') THEN
      IF(S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         CALL REPORT_ERROR_AND_FAIL(&
         & '"PLOT INTEN" TAKES NO NUMERIC WORD'//'\n'//&
         & '#2, #3, #4 OR #5 INPUT'//'\n'//&
         & 'RE-ENTER COMMAND', 1)
         RETURN
      END IF
...
!     OF THE REF SURFACE COORDINATES
   IF(surf_clap_type(NEWREF) >= 1 .AND. surf_clap_type(NEWREF) <= 5) THEN
