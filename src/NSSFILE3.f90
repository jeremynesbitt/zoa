...
!
   ...
   REAL*8 RD,RDT
!
!       THIS ROUTINE OUTPUTS THE CURRENT NSS DATABASE IN A FORM READABLE BY THE
!       PROGRAM
...
!       SOURCE GRID DIMENSION
   ...
   &WRITE(OUTLYNE,20) DBLE(INT(NSSSYSTEM(32))),NSSSYSTEM(37)
   IF(NSSSYSTEM(33).EQ.1.0D0)&
   &WRITE(OUTLYNE,202) DBLE(INT(NSSSYSTEM(32))),NSSSYSTEM(37)
   CALL SHOWIT(10)
20 FORMAT('NSSGRIDS CIRC',',',D23.15,',',D23.15)
202 FORMAT('NSSGRIDS RECT',',',D23.15,',',D23.15)
!       REFERENCE GRID POSITION
...
!       REFERENCE GRID DIMENSION
   ...
   &WRITE(OUTLYNE,22) DBLE(INT(NSSSYSTEM(36))),NSSSYSTEM(38)
   IF(NSSSYSTEM(22).EQ.1.0D0)&
   &WRITE(OUTLYNE,229) DBLE(INT(NSSSYSTEM(36))),NSSSYSTEM(38)
   CALL SHOWIT(10)
22 FORMAT('NSSGRIDR CIRC',',',D23.15,',',D23.15)
229 FORMAT('NSSGRIDR RECT',',',D23.15,',',D23.15)
!       REFERENCE GRID APODIZATION
...
222         FORMAT('NSSDET')
         END IF
!       OUTPUT SURFACE DATA FOR THIS SURFACE
         ...
         IF(NSSALENS(1,J).EQ.1.0D0) THEN
            ...
            &,NSSALENS(5,J),NSSALENS(6,J),NSSALENS(7,J)
         END IF
...
!       OUTPUT LINEAR GRATING DATA FOR THIS SURFACE
         IF(NSSALENS(146,J).NE.0.0D0) THEN
            WRITE(OUTLYNE,200) NSSALENS(141,J),NSSALENS(142,J)&
            &,NSSALENS(143,J),NSSALENS(144,J),NSSALENS(145,J)
            CALL SHOWIT(10)
...
102               FORMAT('SCLAP',',',D23.15,',',D23.15,',',D23.15,',',D23.15 &
               ...
               IF(NSSALENS(19,J).EQ.2.0D0) THEN
                  ...
                  &,NSSALENS(22,I),NSSALENS(23,J),NSSALENS(24,J)
                  CALL SHOWIT(10)
...
! NOW HOLES
            IF(NSSALENS(25,J).NE.0.0D0) THEN
               IF(NSSALENS(25,J).EQ.1.0D0) THEN
                  ...
                  &,NSSALENS(28,J),NSSALENS(29,J),NSSALENS(30,J)
                  CALL SHOWIT(10)
...
!       OUTPUT SURFACE SPOS
         ...
         &NSSALENS(36,J),INT(NSSALENS(37,J))
         CALL SHOWIT(10)
...
!       THE NSSN INDEX COMMAND IF NEEDED.
...
122         FORMAT('SBOUNDZ ',D23.15,',',D23.15)
         END IF
!       NOW OUTPUT "LINKAGE" ASSIGNMENTS
!       LINK SPROFILE
         IF(NSSALENS(44,J).NE.DBLE(J).AND.&
         &NSSALENS(44,J).NE.0.0D0) THEN
...
END
SUBROUTINE NSSLIST
!       THIS MAKE A HUMAN READABLE LISTING OF THE CURRENT NSS DATABASE
   USE NSSMOD
!
   use DATMAI
   IMPLICIT NONE
...
191      FORMAT('VIRTUAL SOURCE POSITION (X,Y,Z) = ',G15.8,',',G15.8,&
      ...
      WRITE(OUTLYNE,99)
      CALL SHOWIT(0)
!       SOURCE GRID DIMENSION AND SPACING
...
!       OUTPUT SURFACE DATA FOR THIS SURFACE
            ...
            IF(STYPE.EQ.'SPHERIC') THEN
               ...
               &WRITE(OUTLYNE,1001) 1.0D0/NSSALENS(3,J)
               CALL SHOWIT(0)
               WRITE(OUTLYNE,1002) NSSALENS(4,J)
               CALL SHOWIT(0)
               WRITE(OUTLYNE,1003) NSSALENS(5,J)
...
112         FORMAT('SURFACE ROT.(A,B,C) = ',G15.8 &
            &,',',G15.8,',',G15.8)
!       OUTPUT SURFACE COATING 1 FILE NUMBER
            WRITE(OUTLYNE,1131) INT(NSSALENS(31,J))
            CALL SHOWIT(0)
1131        FORMAT('NSS SURFACE COATING 1 FILE NUMBER = ',I3)
!       OUTPUT SURFACE COATING  2 ID NUMBER
            WRITE(OUTLYNE,1132) INT(NSSALENS(32,J))
            CALL SHOWIT(0)
