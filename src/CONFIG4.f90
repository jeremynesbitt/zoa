...
!
   IF(WQ.EQ.'CENT'.OR.WQ.EQ.'DELT') THEN
      WRITE(OUTLYNE,*)'QUALIFIERS "CENT" AND "DELT" ARE NOT OPERATIONAL IN'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'ALTERNATE LENS CONFIGURATIONS'
      CALL SHOWIT(1)
      CALL MACFAL
      RETURN
   END IF
!
   IF(WC.EQ.'ZERO') THEN
      IF(SQ.EQ.1.OR.SN.EQ.1.OR.SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"ZERO" TAKES NO INPUT'
         CALL SHOWIT(1)
         CALL MACFAL
         RETURN
      END IF
   ...
   IF(WC.EQ.'YTORIC') THEN
      IF(SQ.EQ.1.OR.SN.EQ.1.OR.SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"YTORIC" TAKES NO INPUT'
         CALL SHOWIT(1)
         CALL MACFAL
         RETURN
      END IF
   ...
   IF(WC.EQ.'XTORIC') THEN
      IF(SQ.EQ.1.OR.SN.EQ.1.OR.SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"XTORIC" TAKES NO INPUT'
         CALL SHOWIT(1)
         CALL MACFAL
         RETURN
      END IF
...
!     MULTCLAP STUFF
   IF(WC.EQ.'MULTCLAP') THEN
      IF(SST.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"MULTCLAP" ONLY TAKES QUALIFIER'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'"OR NUMERIC WORD #1 THROUGH #4 INPUT'
         CALL SHOWIT(1)
      ...
      IF(SN.EQ.1.AND.SQ.EQ.1) THEN
         OUTLYNE='"MULTCLAP" REQUIRES EXPLICIT NUMERIC OR QUALIFIER INPUT'
         CALL SHOWIT(1)
      ...
      IF(SQ.EQ.1.AND.WQ.NE.'DELETE') THEN
         OUTLYNE='"MULTCLAP" ONLY TAKES "DELETE" AS A QUALIFIER WORD'
         CALL SHOWIT(1)
         OUTLYNE='BUT NOT BOTH'
         CALL SHOWIT(1)
         OUTLYNE='RE-ENTER COMMAND'
...
!     MULTCOBS STUFF
   IF(WC.EQ.'MULTCOBS') THEN
      IF(SST.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"MULTCOBS" ONLY TAKES QUALIFIER'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'"OR NUMERIC WORD #1 THROUGH #4 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      ...
      END IF
      IF(SN.EQ.1.AND.SQ.EQ.1) THEN
         OUTLYNE='"MULTCOBS" REQUIRES EXPLICIT NUMERIC OR QUALIFIER INPUT'
         CALL SHOWIT(1)
         OUTLYNE='BUT NOT BOTH'
         CALL SHOWIT(1)
         OUTLYNE='RE-ENTER COMMAND'
      ...
      END IF
      IF(SQ.EQ.1.AND.WQ.NE.'DELETE') THEN
         OUTLYNE='"MULTCOBS" ONLY TAKES "DELETE" AS A QUALIFIER WORD'
         CALL SHOWIT(1)
         OUTLYNE='BUT NOT BOTH'
         CALL SHOWIT(1)
         OUTLYNE='RE-ENTER COMMAND'
...
!     SPIDER STUFF
   IF(WC.EQ.'SPIDER') THEN
      IF(SST.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"SPIDER" ONLY TAKES QUALIFIER'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'"OR NUMERIC WORD #1 THROUGH #3 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(SN.EQ.1.AND.SQ.EQ.1) THEN
         OUTLYNE='"SPIDER" REQUIRES EXPLICIT NUMERIC OR QUALIFIER INPUT'
         CALL SHOWIT(1)
         OUTLYNE='BUT NOT BOTH'
         CALL SHOWIT(1)
         OUTLYNE='RE-ENTER COMMAND'
      ...
      END IF
      IF(SQ.EQ.1.AND.WQ.NE.'DELETE') THEN
         OUTLYNE='"SPIDER" ONLY TAKES "DELETE" AS A QUALIFIER WORD'
         CALL SHOWIT(1)
         OUTLYNE='BUT NOT BOTH'
         CALL SHOWIT(1)
         OUTLYNE='RE-ENTER COMMAND'
...
!     NSS STUFF
   IF(WC.EQ.'ROO') THEN
      IF(SQ.EQ.1.OR.SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"ROO" ONLY TAKES NUMERIC WORD #1 AND #2 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(S1.EQ.0.OR.W1.LE.0.0D0) THEN
         WRITE(OUTLYNE,*)'"ROO" REQUIRES EXPLICIT, POSITIVE NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'CCR') THEN
      IF(SQ.EQ.1.OR.SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"CCR" TAKES NO QUALIFIER OR STRING INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"CCR" TAKES NO NUMERIC WORD #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(S1.EQ.0.OR.W1.LE.0.0D0) THEN
         WRITE(OUTLYNE,*)'"CCR" REQUIRES EXPLICIT, POSITIVE NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
...
!     UPDATE LENS DELETETION COMMANDS
   IF(WC.EQ.'CSD'.OR.WC.EQ.'CSDX'.OR.WC.EQ.'CSDY'.OR.WC.EQ.'TSD'.OR.WC.EQ.'ASPHD'.OR.WC.EQ.'TASPHD'.OR.WC.EQ.'TILTD'.OR.WC.EQ.'CLAPD'.OR.WC.EQ.'COBSD'.OR.WC.EQ.'TORD'.OR.WC.EQ.'DELDEFOR'.OR.WC.EQ.'ARRAYD') THEN
      DO II=8,1,-1
         IF(WC(II:II).NE.' ') THEN
            TAG=II
         END IF
      ...
      IF(SQ.EQ.1.OR.SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         ...
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'TAKES NO STRING OR QUALIFIER'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'OR NUMERIC WORDS #3 THROUGH #5'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(DF1.EQ.1.AND.DF2.EQ.0.OR.DF1.EQ.0.AND.DF2.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:TAG),'"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'USES EITHER TWO OR ZERO NUMERIC WORDS'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      END IF
      IF(INT(W1).LT.0) THEN
         WRITE(OUTLYNE,*)'STARTING SURFACE NUMBER MUST BE GREATER THAN OR EQUAL TO 0'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(W1.GT.W2) THEN
         ...
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'THE STARTING SURFACE #'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
   ...
   END IF
!
   IF(WC.EQ.'SAY'.OR.WC.EQ.'SAX'.OR.WC.EQ.'WRY'.OR.WC.EQ.'WRX'.OR.WQ.EQ.'BDX'.OR.WC.EQ.'BDY') THEN
      IF(S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
         IF(SQ.EQ.0) THEN
            WRITE(OUTLYNE,*)'"',WC(1:3),'" TAKES NO NUMERIC WORD #2 THROUGH #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(SST.EQ.1) THEN
         ...
         RETURN
      END IF
      IF(WQ.NE.'        '.AND.WQ.NE.'CENT'.AND.WQ.NE.'DELT'.AND.WQ.NE.'FLOAT'.AND.WQ.NE.'NOFLOAT') THEN
         WRITE(OUTLYNE,*)'INVALID QUALIFIER USED WITH "',WC(1:3),'"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(DF1.EQ.1.AND.SQ.EQ.0) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),'" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'COATING') THEN
      IF(S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:7),'" TAKES NO NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(SST.EQ.1.OR.SQ.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:7),'" TAKES NO QUALIFIER OR STRING INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:7),'" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(W1.LT.0.0D0.OR.W1.GT.1000.0D0) THEN
         WRITE(OUTLYNE,*)'"',WC(1:7),'" REQUIRES NUMBERIC WORD #1 TO BE IN THE RANGE'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'0 TO 1000'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'AUTOFUNC') THEN
      IF(S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:8),'" TAKES NO NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(SST.EQ.1.OR.SQ.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:8),'" TAKES NO STRING OR QUALIFIER INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:8),'" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'NAOY'.OR.WC.EQ.'NAOX') THEN
      IF(S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:4),'" TAKES NO NUMERIC WORD #2 THROUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:4),'" TAKES NO STRING INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(WQ.NE.'        '.AND.WQ.NE.'CENT'.AND.WQ.NE.'DELT') THEN
         WRITE(OUTLYNE,*)'INVALID QUALIFIER USED WITH "',WC(1:4),'"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:4),'" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'SCY'.OR.WC.EQ.'SCX') THEN
      IF(SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),'" ONLY TAKES QUALIFIER AND NUMERIC WORD #1'
         CALL SHOWIT(1)
      ...
      END IF
   END IF
   IF(WC.EQ.'PXIM'.OR.WC.EQ.'PYIM'.OR.WC.EQ.'RXIM'.OR.WC.EQ.'RYIM') THEN
      IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:4),'" ONLY TAKES QUALIFIER AND NUMERIC WORD #1'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'SPTWT') THEN
      ...
      IF(W1.LT.0.0D0.OR.W2.LT.0.0D0.OR.W3.LT.0.0D0 .OR.W4.LT.0.0D0.OR.W5.LT.0.0D0) THEN
         WRITE(OUTLYNE,*)'"',WC(1:5),'" REQUIRES NON-NEGATIVE NUMERIC INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'SPTWT2') THEN
      ...
      END IF
      IF(W1.LT.0.0D0.OR.W2.LT.0.0D0.OR.W3.LT.0.0D0 .OR.W4.LT.0.0D0.OR.W5.LT.0.0D0) THEN
         WRITE(OUTLYNE,*)'"',WC(1:6),'" REQUIRES NON-NEGATIVE NUMERIC INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
   END IF
   IF(WC.EQ.'SPTWT'.AND.DF1.EQ.1.AND.DF2.EQ.1.AND.DF3.EQ.1 .AND.DF4.EQ.1.AND.DF5.EQ.1) THEN
      WRITE(OUTLYNE,*)'"SPTWT" REQUIRES SOME EXPLICIT NUMERIC INPUT IN THIS CONTEXT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      RETRET=1
      ...
      RETURN
   END IF
   IF(WC.EQ.'SPTWT2'.AND.DF1.EQ.1.AND.DF2.EQ.1.AND.DF3.EQ.1 .AND.DF4.EQ.1.AND.DF5.EQ.1) THEN
      WRITE(OUTLYNE,*)'"SPTWT2" REQUIRES SOME EXPLICIT NUMERIC INPUT IN THIS CONTEXT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      RETRET=1
   ...
   IF(WC.EQ.'THERM') THEN
      ...
      IF(INT(W2).LT.0.OR.INT(W2).GT.INT(sys_last_surf())) THEN
         WRITE(OUTLYNE,*)'ENDING SURFACE NUMBER MUST BE LESS THAN ',INT(sys_last_surf())
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(INT(W2).LT.INT(W1)) THEN
         WRITE(OUTLYNE,*)'ERROR:'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'ENDING SURFACE LESS THAN STARTING SURFACE'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(DF3.EQ.1) THEN
         ...
         RETURN
      END IF
      IF(WQ.EQ.'GLASS'.OR.WQ.EQ.'SPACE'.OR.WQ.EQ.'THICK'.OR.WQ.EQ.'SHAPE'.OR.WQ.EQ.'GAS') THEN
         IF(DF4.EQ.1) THEN
            WRITE(OUTLYNE,*)'"THERM ',WQ,'" REQUIRES EXPLICIT NUMERIC WORD #4 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(SQ.EQ.0) THEN
         ...
         RETURN
      END IF
      IF(WQ.NE.'SHAPE'.AND.WQ.NE.'SPACE'.AND.WQ.NE.'THICK'.AND.WQ.NE.'GLASS'.AND.WQ.NE.'GAS'.AND.WQ.NE.'AIR'.AND.WQ.NE.'OXYGEN'.AND.WQ.NE.'HYDROGEN'.AND.WQ.NE.'HELIUM'.AND.WQ.NE.'ARGON'.AND.WQ.NE.'METHANE'.AND.WQ.NE.'ETHANE'.AND.WQ.NE.'NITROGEN') THEN
   ...
   IF(WC.EQ.'PRES') THEN
      ...
      IF(WQ.EQ.'GAS') THEN
         IF(DF4.EQ.1) THEN
            WRITE(OUTLYNE,*)'"PRES GAS" REQUIRES EXPLICIT NUMERIC WORD #4 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(SQ.EQ.0) THEN
         ...
         RETURN
      END IF
      IF(WQ.NE.'GAS'.AND.WQ.NE.'AIR'.AND.WQ.NE.'OXYGEN'.AND.WQ.NE.'HYDROGEN'.AND.WQ.NE.'HELIUM'.AND.WQ.NE.'ARGON'.AND.WQ.NE.'METHANE'.AND.WQ.NE.'ETHANE'.AND.WQ.NE.'NITROGEN') THEN
   ...
   IF(WC.EQ.'INR') THEN
      IF(SQ.EQ.1.OR.SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),'" TAKES NO STRING OR QUALIFIER WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),'" TAKES NO NUMERIC WORD #2 TRHOUGH #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(S1.EQ.1.AND.W1.LE.0.0D0) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),'" REQUIRES POSITIVE NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
   END IF
   IF(WC.EQ.'GRO'.OR.WC.EQ.'GRS'.OR.WC.EQ.'GRX'.OR.WC.EQ.'GRY'.OR.WC.EQ.'GRZ') THEN
      IF(SQ.EQ.1.OR.SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),'" TAKES NO STRING OR QUALIFIER WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
   ...
   IF(WC.EQ.'GRT') THEN
      ...
      END IF
      IF(SN.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),'" TAKES NO NUMERIC WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(SQ.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),'" TAKES NO QUALIFIER WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'GRTD') THEN
      ...
      END IF
      IF(SN.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:4),'" TAKES NO NUMERIC WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(SQ.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:4),'" TAKES NO QUALIFIER WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'INRD') THEN
      IF(SQ.EQ.1.OR.SST.EQ.1.OR.SN.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:4),'" TAKES NO ADDITIONAL INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'RD'.OR.WC.EQ.'CV') THEN
      ...
      IF(WQ.NE.'DELTFR') THEN
         IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
            WRITE(OUTLYNE,*)'"',WC(1:2),'" TAKES NO NUMERIC WORD #3 THROUGH #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
...
!     WQ IS DELTFR
         IF(S4.EQ.1.OR.S5.EQ.1) THEN
            WRITE(OUTLYNE,*)'"',WC(1:2),'DELTFR" TAKES NO NUMERIC WORD #4 OR #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
         ...
         IF(W2.LE.0.0D0.AND.DF2.EQ.0.OR.W3.LE.0.0D0 .AND.DF3.EQ.0) THEN
            WRITE(OUTLYNE,*)'"',WC(1:2),'DELTFR" REQUIRES POSITIVE NUMERIC WORD #2 AN #3 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
         ...
         END IF
      END IF
      IF(WQ.NE.'        '.AND.WQ.NE.'CENT'.AND.WQ.NE.'DELT'.AND.WQ.NE.'DELTFR') THEN
         WRITE(OUTLYNE,*)'INVALID QUALIFIER WORD USED WITH "',WC(1:2),'"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'DEFORM') THEN
      IF(SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"DEFORM" TAKES NO STRING INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
         WRITE(OUTLYNE,*)'"DEFORM" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.5) THEN
         WRITE(OUTLYNE,*)'"DEFORM" REQUIRES TAKES NO NUMERIC WORD #3, #4 OR #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(SQ.EQ.0) THEN
         ...
         WQ='F01'
      END IF
      IF(WQ.NE.'F01'.AND.WQ.NE.'F02'.AND.WQ.NE.'F03'.AND.WQ.NE.'F01'.AND.WQ.NE.'F02'.AND.WQ.NE.'F03'.AND.WQ.NE.'F04'.AND.WQ.NE.'F05'.AND.WQ.NE.'F06'.AND.WQ.NE.'F07'.AND.WQ.NE.'F08'.AND.WQ.NE.'F09'.AND.WQ.NE.'F10') THEN
         WRITE(OUTLYNE,*)'INVALID QUALIFIER WORD USED WITH "DEFORM"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'PUY'.OR.WC.EQ.'PUX') THEN
      IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),'" ONLY TAKES QUALIFIER OR NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
      END IF
   ...
   IF(WC.EQ.'PUY'.OR.WC.EQ.'PUX') THEN
      IF(WQ.EQ.'FN'.AND.DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),' FN" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
   ...
   IF(WC.EQ.'PUY'.OR.WC.EQ.'PUX') THEN
      IF(WQ.EQ.'FN'.AND.W1.EQ.0.0D0) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),' FN" REQUIRES NON-ZERO NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
   ...
   IF(WC.EQ.'PUY'.OR.WC.EQ.'PUX') THEN
      ...
      END IF
   END IF
   IF(WC.EQ.'CC'.OR.WC.EQ.'AG'.OR.WC.EQ.'AH'.OR.WC.EQ.'AJ'.OR.WC.EQ.'CCTOR'.OR.WC.EQ.'PIY'.OR.WC.EQ.'PIX'.OR.WC.EQ.'PICY'.OR.WC.EQ.'AK'.OR.WC.EQ.'AI'.OR.WC.EQ.'PICX'.OR.WC.EQ.'PUCY'.OR.WC.EQ.'PUCX'.OR.WC.EQ.'TH'.OR.WC.EQ.'PY'.OR.WC.EQ.'PCY'.OR.WC.EQ.'PX'.OR.WC.EQ.'PCX'.OR.WC.EQ.'CVTOR'.OR.WC.EQ.'RDTOR'.OR.WC.EQ.'AL'.OR.WC.EQ.'XD'.OR.WC.EQ.'YD'.OR.WC.EQ.'ALPHA'.OR.WC.EQ.'ADTOR'.OR.WC.EQ.'AETOR'.OR.WC.EQ.'AFTOR'.OR.WC.EQ.'AGTOR'.OR.WC.EQ.'BETA'.OR.WC.EQ.'GAMMA'.OR.WC.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF'.OR.WC.EQ.'AC'.OR.WC.EQ.'ZD'.OR.WC.EQ.'PIVX'.OR.WC.EQ.'PIVY'.OR.WC.EQ.'PIVZ'.OR.WC.EQ.'THM'.OR.WC.EQ.'GDX'.OR.WC.EQ.'GDY'.OR.WC.EQ.'GDZ'.OR.WC.EQ.'GALPHA'.OR.WC.EQ.'GBETA'.OR.WC.EQ.'GGAMMA'.OR.WC.EQ.'SPGR'.OR.WQ.EQ.'PRICE'.OR.WC.EQ.'RAYERROR'.OR.WC.EQ.'CCR'.OR.WC.EQ.'ROO') THEN
      IF(S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         IF(WC.EQ.'RAYERROR') THEN
            WRITE(OUTLYNE,*)'"RAYERROR" TAKES NO NUMERIC WORD #2 THROUGH #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
      ...
      IF(S4.EQ.1.OR.S5.EQ.1) THEN
         IF(WC.EQ.'ROO') THEN
            WRITE(OUTLYNE,*)'"ROO" TAKES NO NUMERIC WORD #4 AND #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
      ...
      IF(SQ.EQ.1.OR.SST.EQ.1) THEN
         IF(WC.EQ.'RAYERROR') THEN
            WRITE(OUTLYNE,*)'"RAYERROR" TAKES NO QUALIFIER OR STRING INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         ...
         END IF
         IF(WC.EQ.'ROO') THEN
            WRITE(OUTLYNE,*)'"ROO" TAKES NO QUALIFIER OR STRING INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
...
!
      IF(S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
         IF(WC.EQ.'CC'.OR.WC.EQ.'AG'.OR.WC.EQ.'AH'.OR.WC.EQ.'AI'.OR.WC.EQ.'TH'.OR.WC.EQ.'AJ'.OR.WC.EQ.'AK'.OR.WC.EQ.'AL'.OR.WC.EQ.'PY'.OR.WC.EQ.'PX'.OR.WC.EQ.'XD'.OR.WC.EQ.'YD'.OR.WC.EQ.'ZD'.OR.WC.EQ.'AD'.OR.WC.EQ.'AC'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF') THEN
            WRITE(OUTLYNE,*)'"',WC(1:2),'" TAKES NO NUMERIC WORD #2 THROUGH #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'PIY'.OR.WC.EQ.'PIX'.OR.WC.EQ.'THM'.OR.WC.EQ.'PRICE'.OR.WQ.EQ.'PCY'.OR.WC.EQ.'PCX'.OR.WC.EQ.'CVTOR'.OR.WC.EQ.'RDTOR')THEN
            WRITE(OUTLYNE,*)'"',WC(1:5),'" TAKES NO NUMERIC WORD #2 THROUGH #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'PICY'.OR.WC.EQ.'PICX'.OR.WC.EQ.'PUCY'.OR.WC.EQ.'PUCX'.OR.WC.EQ.'PIVZ'.OR.WC.EQ.'BETA'.OR.WC.EQ.'PIVX'.OR.WC.EQ.'PIVY'.OR.WC.EQ.'SPGR') THEN
            WRITE(OUTLYNE,*)'"',WC(1:4),'" TAKES NO NUMERIC WORD #2 THROUGH #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'CCTOR'.OR.WC.EQ.'ALPHA'.OR.WC.EQ.'ADTOR'.OR.WC.EQ.'GALPHA'.OR.WC.EQ.'AETOR'.OR.WC.EQ.'AFTOR'.OR.WC.EQ.'AGTOR'.OR.WC.EQ.'GAMMA'.OR.WC.EQ.'GBETA'.OR.WC.EQ.'GGAMMA') THEN
            WRITE(OUTLYNE,*)'"',WC(1:6),'" TAKES NO NUMERIC WORD #2 THROUGH #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
      ...
      END IF
      IF(SST.EQ.1) THEN
         IF(WC.EQ.'CC'.OR.WC.EQ.'AG'.OR.WC.EQ.'AJ'.OR.WC.EQ.'AK'.OR.WC.EQ.'TH'.OR.WC.EQ.'AH'.OR.WC.EQ.'AI'.OR.WC.EQ.'AL'.OR.WC.EQ.'PY'.OR.WC.EQ.'PX'.OR.WC.EQ.'XD'.OR.WC.EQ.'YD'.OR.WC.EQ.'ZD'.OR.WC.EQ.'AD'.OR.WC.EQ.'AC'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF') THEN
            WRITE(OUTLYNE,*)'"',WC(1:2),'" TAKES NO STRING INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'PIY'.OR.WC.EQ.'PIX'.OR.WC.EQ.'THM'.OR.WC.EQ.'PRICE'.OR.WQ.EQ.'PCY'.OR.WC.EQ.'PCX'.OR.WC.EQ.'CVTOR'.OR.WC.EQ.'RDTOR')THEN
            WRITE(OUTLYNE,*)'"',WC(1:5),'" TAKES NO STRING INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'PICY'.OR.WC.EQ.'PICX'.OR.WC.EQ.'PUCY'.OR.WC.EQ.'PUCX'.OR.WC.EQ.'PIVZ'.OR.WC.EQ.'BETA'.OR.WC.EQ.'PIVX'.OR.WC.EQ.'PIVY'.OR.WC.EQ.'SPGR') THEN
            ...
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'CCTOR'.OR.WC.EQ.'ALPHA'.OR.WC.EQ.'ADTOR'.OR.WC.EQ.'AETOR'.OR.WC.EQ.'AFTOR'.OR.WC.EQ.'AGTOR'.OR.WC.EQ.'GAMMA'.OR.WC.EQ.'GALPHA'.OR.WC.EQ.'GBETA'.OR.WC.EQ.'GGAMMA') THEN
            WRITE(OUTLYNE,*)'"',WC(1:6),'" TAKES NO STRING INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
      ...
      IF(WQ.NE.'        '.AND.WQ.NE.'DELT'.AND.WQ.NE.'CENT') THEN
         IF(WC.EQ.'CC'.OR.WC.EQ.'AG'.OR.WC.EQ.'AH'.OR.WC.EQ.'AI'.OR.WC.EQ.'TH'.OR.WC.EQ.'AJ'.OR.WC.EQ.'AK'.OR.WC.EQ.'AL'.OR.WC.EQ.'XD'.OR.WC.EQ.'YD'.OR.WC.EQ.'ZD'.OR.WC.EQ.'AD'.OR.WC.EQ.'AC'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF') THEN
            WRITE(OUTLYNE,*)'INVALID QUALIFIER USED WITH "',WC(1:2),'"'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'CVTOR'.OR.WC.EQ.'RDTOR'.OR.WC.EQ.'THM'.OR.WQ.EQ.'PRICE') THEN
            WRITE(OUTLYNE,*)'INVALID QUALIFIER USED WITH "',WC(1:5),'"'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'BETA'.OR.WC.EQ.'PIVX'.OR.WC.EQ.'PIVY'.OR.WC.EQ.'PIVZ')THEN
            WRITE(OUTLYNE,*)'INVALID QUALIFIER USED WITH "',WC(1:4),'"'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'CCTOR'.OR.WC.EQ.'ALPHA'.OR.WC.EQ.'ADTOR'.OR.WC.EQ.'AETOR'.OR.WC.EQ.'AFTOR'.OR.WC.EQ.'AGTOR'.OR.WC.EQ.'GAMMA'.OR.WC.EQ.'GALPHA'.OR.WC.EQ.'GBETA'.OR.WC.EQ.'GGAMMA') THEN
            WRITE(OUTLYNE,*)'INVALID QUALIFIER USED WITH "',WC(1:6),'"'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
      ...
      END IF
      IF(SST.EQ.1) THEN
         IF(WC.EQ.'PY'.OR.WC.EQ.'PX') THEN
            WRITE(OUTLYNE,*)'"',WC(1:2),'" TAKES NO QUALIFIER INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'PIY'.OR.WC.EQ.'PIX'.OR.WC.EQ.'PCY'.OR.WC.EQ.'PCX')THEN
            WRITE(OUTLYNE,*)'"',WC(1:5),'" TAKES NO QUALIFIER INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'PICY'.OR.WC.EQ.'PICX'.OR.WC.EQ.'PUCY'.OR.WC.EQ.'PUCX'.OR.WC.EQ.'SPGR')THEN
            WRITE(OUTLYNE,*)'"',WC(1:4),'" TAKES NO QUALIFIER INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
   ...
   IF(WC.EQ.'UNITS') THEN
      ...
      IF(SQ.EQ.0) THEN
         WQ='INCH'
      END IF
      IF(WQ.NE.'IN'.AND.WQ.NE.'INCH'.AND.WQ.NE.'INCHES'.AND.WQ.NE.'MM'.AND.WQ.NE.'MM'.AND.WQ.NE.'M') THEN
         WRITE(OUTLYNE,*)'INVALID QUALIFIER FOUND'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
   ...
   IF(WC.EQ.'N1'.OR.WC.EQ.'N2'.OR.WC.EQ.'N3'.OR.WC.EQ.'N4'.OR.WC.EQ.'N5'.OR.WC.EQ.'N6'.OR.WC.EQ.'N7'.OR.WC.EQ.'N8'.OR.WC.EQ.'N9'.OR.WC.EQ.'N10') THEN
      ...
      END IF
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:2),'" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'INDEX'.OR.WC.EQ.'VNUM'.OR.WC.EQ.'DPART') THEN
      ...
      END IF
      IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:5),'" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'ASPH'.OR.WC.EQ.'TASPH'.OR.WC.EQ.'ASPH2') THEN
      IF(SQ.EQ.1.OR.SST.EQ.1) THEN
         IF(WC.EQ.'ASPH') THEN
            WRITE(OUTLYNE,*)'"ASPH" TAKES NO QUALIFIER OR STRING INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'ASPH2') THEN
            WRITE(OUTLYNE,*)'"ASPH2" TAKES NO QUALIFIER OR STRING INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'TASPH') THEN
            WRITE(OUTLYNE,*)'"TASPH" TAKES NO QUALIFIER OR STRING INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
   ...
   IF(WC.EQ.'ARRAY') THEN
      IF(SQ.EQ.1.AND.WQ.NE.'ODD'.AND.WQ.NE.'EVEN') THEN
         WRITE(OUTLYNE,*)'"ARRAY" ONLY TAKES "ODD" OR "EVEN" AS QUALIFIER NPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"ARRAY" TAKES NO STRING INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
         WRITE(OUTLYNE,*)'"ARRAY" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(W1.LE.0.0D0.OR.W2.LE.0.0D0) THEN
         WRITE(OUTLYNE,*)'"ARRAY" REQUIRES POSITIVE INTEGER NUMERIC WORD #1 AND #2 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"ARRAY" TAKES NO NUMERIC WORD #3, #4 OR #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      RETURN
   END IF
   IF(WC.EQ.'REFS'.OR.WC.EQ.'APY'.OR.WC.EQ.'PERFECT'.OR.WC.EQ.'APX'.OR.WC.EQ.'APCY'.OR.WC.EQ.'APCX'.OR.WC.EQ.'AIR'.OR.WC.EQ.'REFL'.OR.WC.EQ.'REFLTIR'.OR.WC.EQ.'GRT'.OR.WC.EQ.'REFLTIRO') THEN
      IF(SST.EQ.1.OR.SQ.EQ.1.OR.SN.EQ.1) THEN
!
         IF(WC.EQ.'APY'.OR.WC.EQ.'APX'.OR.WC.EQ.'AIR'.OR.WC.EQ.'GRT')THEN
...
!
         ...
         END IF
!
         IF(WC.EQ.'REFS'.OR.WC.EQ.'APCY'.OR.WC.EQ.'APCX'.OR.WC.EQ.'REFL') THEN
            WRITE(OUTLYNE,*)'"',WC(1:4),'" TAKES NO EXPLICIT INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
...
!
   ...
   IF(WC.EQ.'MODE') THEN
      IF(SST.EQ.1.OR.SN.EQ.1) THEN
         ...
         RETURN
      END IF
      IF(WQ.EQ.'FOCAL'.OR.WQ.EQ.'AFOCAL'.OR.WQ.EQ.'UFOCAL'.OR.WQ.EQ.'UAFOCAL') THEN
         RETURN
      END IF
   ...
   IF(WC.EQ.'MAGY'.OR.WC.EQ.'MAGX') THEN
      IF(SST.EQ.1.OR.SQ.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
         IF(WC.EQ.'MAGY') THEN
            WRITE(OUTLYNE,*)'"MAGY" ONLY TAKES NUMERIC WORD #1, #2 AND #3 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'MAGX') THEN
            WRITE(OUTLYNE,*)'"MAGX" ONLY TAKES NUMERIC WORD #1, #2 AND #3 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
      ...
      IF(DF1.EQ.1.OR.DF2.EQ.1.OR.DF3.EQ.1) THEN
         IF(WC.EQ.'MAGY') THEN
            WRITE(OUTLYNE,*)'"MAGY" REQUIRES EXPLICIT NUMERIC WORD #1, #2 AND #3 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'MAGX') THEN
            WRITE(OUTLYNE,*)'"MAGX" REQUIRES EXPLICIT NUMERIC WORD #1, #2 AND #3 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
...
!     FLDS
      IF(SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"FLDS" TAKES NO STRING INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(SQ.EQ.0) THEN
         IF(DF4.EQ.0.OR.DF5.EQ.0) THEN
            WRITE(OUTLYNE,*)'"FLDS" TAKES NO NUMERIC WORD #4 OR #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(SQ.EQ.1) THEN
         IF(WQ.NE.'MAX')THEN
            WRITE(OUTLYNE,*)'"FLDS" ONLY TAKES "MAX" AS OPTIONAL'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'QUALIFIER WORD INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(SQ.EQ.0.AND.DF2.EQ.1.AND.DF3.EQ.1) THEN
         WRITE(OUTLYNE,*)'"FLDS" REQUIRES SOME EXPLICIT NUMERIC WORD #2 OR #3 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(WC.EQ.'FLDS'.AND.WQ.EQ.'MAX') THEN
         IF(DF1.EQ.1) THEN
            WRITE(OUTLYNE,*)'"FLDS MAX" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(WC.EQ.'FLDS'.AND.WQ.EQ.'MAX') THEN
         IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0.OR.DF5.EQ.0) THEN
            WRITE(OUTLYNE,*)'"FLDS MAX" ONLY TAKES NUMERIC WORD #1 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(SQ.EQ.0.AND.DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)'"FLDS" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      IF(SQ.EQ.0.AND.W1.LT.1.0D0.OR.SQ.EQ.0.AND.W2.GT.25.0D0) THEN
         WRITE(OUTLYNE,*)'"FLDS" REQUIRES NUMERIC WORD #1 TO BE BETWEEN 1 AND 25'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
         ...
         RETURN
      END IF
      IF(WQ.EQ.'MAX'.AND.W1.LT.1.0D0 .OR.WQ.EQ.'MAX'.AND.W2.GT.25.0D0) THEN
         WRITE(OUTLYNE,*)'"FLDS MAX" REQUIRES NUMERIC WORD #1 TO BE BETWEEN 1 AND 25'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
   END IF
   IF(WC.EQ.'FNBY'.OR.WC.EQ.'FNBX'.OR.WC.EQ.'ERY'.OR.WC.EQ.'ERX') THEN
      IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         IF(WC.EQ.'FNBY'.OR.WC.EQ.'FNBX') THEN
            WRITE(OUTLYNE,*)'"',WC(1:4),'" ONLY TAKES QUALIFIER AND NUMERIC WORD #1 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
         IF(WC.EQ.'ERY'.OR.WC.EQ.'ERX') THEN
            WRITE(OUTLYNE,*)'"',WC(1:3),'" ONLY TAKES QUALIFIER AND NUMERIC WORD #1 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
         END IF
...
!       QUALIFIER MUST BE 'DELK'
            IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
               IF(WC.EQ.'FNBY'.OR.WC.EQ.'FNBX') THEN
                  WRITE(OUTLYNE,*)'"',WC(1:4),' DEL" ONLY TAKES NUMERIC WORD #1 INPUT'
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
                  CALL SHOWIT(1)
               END IF
               IF(WC.EQ.'ERY'.OR.WC.EQ.'ERX') THEN
                  WRITE(OUTLYNE,*)'"',WC(1:3),' DEL" ONLY TAKES NUMERIC WORD #1 INPUT'
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
                  CALL SHOWIT(1)
               END IF
            ...
            IF(DF1.EQ.1) THEN
               IF(WC.EQ.'FNBY'.OR.WC.EQ.'FNBX') THEN
                  WRITE(OUTLYNE,*)'"',WC(1:4),' DEL" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
                  CALL SHOWIT(1)
               END IF
               IF(WC.EQ.'ERY'.OR.WC.EQ.'ERX') THEN
                  WRITE(OUTLYNE,*)'"',WC(1:3),' DEL" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
                  CALL SHOWIT(1)
               END IF
   ...
   IF(WC.EQ.'DEC') THEN
      IF(SST.EQ.1.OR.SQ.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"DEC" ONLY TAKES NUMERIC WORD #1, #2 AND #3 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'PIVOT') THEN
      IF(SST.EQ.1.OR.SQ.EQ.1.OR.SN.EQ.1) THEN
         WRITE(OUTLYNE,*)'"PIVOTD" ONLY TAKES ADDITIONAL INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'PIVOT') THEN
      IF(SST.EQ.1.OR.SQ.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"PIVOT" ONLY TAKES NUMERIC WORD #1, #2 AND #3 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'TILT'.AND.WQ.NE.'AUTOD') THEN
      IF(SST.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"TILT" ONLY TAKES QUALIFIER AND NUMERIC WORDS #1, #2 AND #3'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(SQ.EQ.1) THEN
         IF(WQ.NE.'AUTO'.AND.WQ.NE.'AUTOM'.AND.WQ.NE.'BEN'.AND.WQ.NE.'DAR'.AND.WQ.NE.'RET'.AND.WQ.NE.'REV') THEN
            WRITE(OUTLYNE,*)'INVALID QUALIFIER FOUND'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
   ...
   IF(WC.EQ.'RTILT') THEN
      IF(SST.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"RTILT" ONLY TAKES QUALIFIER AND NUMERIC WORDS #1, #2 AND #3'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'TILT'.AND.WQ.EQ.'RETD') THEN
      IF(SST.EQ.1.OR.SN.EQ.1) THEN
         WRITE(OUTLYNE,*)'"TILT RETD" TAKES NO STRING OR NUMERIC WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'TILT'.AND.WQ.EQ.'BEND') THEN
      IF(SST.EQ.1.OR.SN.EQ.1) THEN
         WRITE(OUTLYNE,*)'"TILT BEND" TAKES NO STRING OR NUMERIC WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'TILT'.AND.WQ.EQ.'DARD') THEN
      IF(SST.EQ.1.OR.SN.EQ.1) THEN
         WRITE(OUTLYNE,*)'"TILT DARD" TAKES NO STRING OR NUMERIC WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'TILT'.AND.WQ.EQ.'AUTOD') THEN
      IF(SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"TILT AUTOD" TAKES NO STRING OR NUMERIC WORDS #3 THROUGH #5'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(DF1.EQ.1.AND.DF2.EQ.0.OR.DF1.EQ.0.AND.DF2.EQ.1) THEN
         WRITE(OUTLYNE,*)'"TILT AUTOD" USES EITHER TWO OR ZERO NUMERIC WORDS'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
   ...
   IF(WC.EQ.'RTILT') THEN
      ...
      RETURN
   END IF
   IF(WC.EQ.'SCHOTT'.OR.WC.EQ.'OHARA'.OR.WC.EQ.'HOYA'.OR.WC.EQ.'CHANCE'.OR.WC.EQ.'CORNIN'.OR.WC.EQ.'HIKARI'.OR.WC.EQ.'RADHARD'.OR.WC.EQ.'MATL'.OR.WC.EQ.'SCH2000'.OR.WC.EQ.'GLCAT'.OR.WC.EQ.'GLAK'.OR.WC.EQ.'RUSSIAN') THEN
      IF(SN.EQ.1.OR.SQ.EQ.1) THEN
!
...
!
   ...
   IF(WC.EQ.'MODEL') THEN
      ...
      IF(S1.EQ.0.OR.S2.EQ.1) THEN
         WRITE(OUTLYNE,*)'"MODEL" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
      ...
      END IF
      IF(SQ.EQ.0) THEN
         WRITE(OUTLYNE,*)'"MODEL" REQUIRES EXPLICIT QUALIFIER WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'ASTOP') THEN
      ...
      END IF
      IF(SQ.EQ.1) THEN
         IF(WQ.EQ.'EN'.OR.WQ.EQ.'EX'.OR.WQ.EQ.'ENEX'.OR.WQ.EQ.'DELK') THEN
            RETURN
         ELSE
            WRITE(OUTLYNE,*)'INVALID QUALIFIER FOUND'
            CALL SHOWIT(1)
   ...
   IF(WC.EQ.'NODUM') THEN
      ...
      END IF
      IF(SQ.EQ.1) THEN
         IF(WQ.EQ.'ON'.OR.WQ.EQ.'OFF'.OR.WQ.EQ.'YES'.OR.WQ.EQ.'NO') THEN
            RETURN
         ELSE
            WRITE(OUTLYNE,*)'INVALID QUALIFIER FOUND'
            CALL SHOWIT(1)
   ...
   IF(WC.EQ.'CAY'.OR.WC.EQ.'CAX') THEN
      IF(SST.EQ.1.OR.SQ.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:3),'" ONLY TAKES NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   IF(WC.EQ.'SPSRF')THEN
      IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"SPSRF" ONLY TAKES QUALIFIER AND NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
   ...
   END IF
   IF(WC.EQ.'PIKUP') THEN
      IF(WQ.NE.'RD'.AND.WQ.NE.'CV'.AND.WQ.NE.'CC'.AND.WC.NE.'AH'.AND.WQ.NE.'TH'.AND.WQ.NE.'AD'.AND.WC.NE.'AE'.AND.WC.NE.'AJ'.AND.WQ.NE.'AF'.AND.WQ.NE.'AG'.AND.WQ.NE.'CVTOR'.AND.WC.NE.'AK'.AND.WQ.NE.'RDTOR'.AND.WQ.NE.'YD'.AND.WQ.NE.'XD'.AND.WC.NE.'AL'.AND.WQ.NE.'ALPHA'.AND.WQ.NE.'BETA'.AND.WQ.NE.'AI'.AND.WC.NE.'GAMMA'.AND.WQ.NE.'CLAP'.AND.WQ.NE.'COBS'.AND.WQ.NE.'ZD'.AND.WQ.NE.'CCTOR'.AND.WQ.NE.'ADTOR'.AND.WQ.NE.'AETOR'.AND.WQ.NE.'AFTOR'.AND.WQ.NE.'AGTOR'.AND.WQ.NE.'PIVX'.AND.WQ.NE.'GLASS'.AND.WQ.NE.'AC'.AND.WQ.NE.'PRO'.AND.WQ.NE.'PIVY'.AND.WQ.NE.'NPRO'.AND.WQ.NE.'THOAL'.AND.WQ.NE.'PIVZ'.AND.WQ.NE.'GDX'.AND.WQ.NE.'GDY'.AND.WQ.NE.'GDZ'.AND.WQ.NE.'GALPHA'.AND.WQ.NE.'GBETA'.AND.WQ.NE.'GGAMMA'.AND.WQ.NE.'GRT'.AND.WQ.NE.'COATING')THEN
         WRITE(OUTLYNE,*)'INVALID QUALIFIER FOUND'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
      ...
      END IF
!
      IF(WQ.EQ.'RD'.OR.WQ.EQ.'CV'.OR.WQ.EQ.'CC'.OR.WQ.EQ.'AH'.OR.WQ.EQ.'TH'.OR.WQ.EQ.'AD'.OR.WQ.EQ.'AE'.OR.WQ.EQ.'AI'.OR.WQ.EQ.'AF'.OR.WQ.EQ.'AG'.OR.WQ.EQ.'CVTOR'.OR.WQ.EQ.'RDTOR'.OR.WQ.EQ.'YD'.OR.WQ.EQ.'XD'.OR.WQ.EQ.'ZD'.OR.WQ.EQ.'ALPHA'.OR.WQ.EQ.'BETA'.OR.WQ.EQ.'AJ'.OR.WQ.EQ.'AK'.OR.WQ.EQ.'GAMMA'.OR.WQ.EQ.'CLAP'.OR.WQ.EQ.'COBS'.OR.WQ.EQ.'AL'.OR.WQ.EQ.'CCTOR'.OR.WQ.EQ.'ADTOR'.OR.WQ.EQ.'AETOR'.OR.WQ.EQ.'AFTOR'.OR.WQ.EQ.'AGTOR'.OR.WQ.EQ.'PIVX'.OR.WQ.EQ.'PIVY'.OR.WQ.EQ.'GLASS'.OR.WQ.NE.'AC'.OR.WQ.EQ.'PRO'.OR.WQ.EQ.'NPRO'.OR.WC.EQ.'PIVZ'.OR.WQ.EQ.'GDX'.OR.WQ.EQ.'GDY'.OR.WQ.EQ.'GDZ'.OR.WQ.EQ.'GALPHA'.OR.WQ.EQ.'GBETA'.OR.WQ.EQ.'GGAMMA'.OR.WQ.EQ.'GRT'.OR.WQ.EQ.'COATING') THEN
         IF(DF1.EQ.1) THEN
      ...
      IF(WQ.EQ.'THOAL') THEN
         IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
            WRITE(OUTLYNE,*)'EXPLICIT NUMERIC WORDS #1 AND #2 INPUT ARE REQUIRED'
            CALL SHOWIT(1)
         ...
         END IF
      END IF
      IF(WQ.EQ.'RD'.OR.WQ.EQ.'CV'.OR.WQ.EQ.'CC'.OR.WQ.EQ.'AH'.OR.WQ.EQ.'TH'.OR.WQ.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.'AI'.OR.WQ.EQ.'AF'.OR.WQ.EQ.'AG'.OR.WQ.EQ.'CVTOR'.OR.WQ.EQ.'RDTOR'.OR.WQ.EQ.'YD'.OR.WQ.EQ.'XD'.OR.WQ.EQ.'ZD'.OR.WQ.EQ.'ALPHA'.OR.WQ.EQ.'BETA'.OR.WQ.EQ.'COATING'.OR.WQ.EQ.'GAMMA'.OR.WQ.EQ.'CLAP'.OR.WQ.EQ.'COBS'.OR.WQ.EQ.'CCTOR'.OR.WQ.EQ.'ADTOR'.OR.WQ.EQ.'AETOR'.OR.WQ.EQ.'AFTOR'.OR.WQ.EQ.'AGTOR'.OR.WC.EQ.'AJ'.OR.WC.EQ.'AK'.OR.WQ.EQ.'GLASS'.OR.WQ.NE.'AC'.OR.WQ.EQ.'PRO'.OR.WQ.EQ.'NPRO'.OR.WC.EQ.'AL'.OR.WQ.EQ.'PIVX'.OR.WQ.EQ.'PIVY'.OR.WQ.EQ.'PIVZ'.OR.WQ.EQ.'GDX'.OR.WQ.EQ.'GDY'.OR.WQ.EQ.'GDZ'.OR.WQ.EQ.'GALPHA'.OR.WQ.EQ.'GBETA'.OR.WQ.EQ.'GGAMMA') THEN
         IF(W1.LT.0.0D0) W1=sys_last_surf()+W1
         IF(INT(W1).LT.0.OR.INT(W1).GT.INT(sys_last_surf())) THEN
            WRITE(OUTLYNE,*)'SURFACE NUMBER BEYOND LEGAL RANGE'
            CALL SHOWIT(1)
      ...
      END IF
      IF(WQ.EQ.'THOAL') THEN
         IF(INT(W1).LT.0.OR.INT(W1).GT.INT(sys_last_surf()).OR.INT(W2).LT.0.OR.INT(W2).GT.INT(sys_last_surf()).OR.INT(W2).LT.INT(W1)) THEN
      ...
      IF(WQ.EQ.'GLASS') THEN
         IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1) THEN
            WRITE(OUTLYNE,*)'"PIKUP GLASS" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(WQ.EQ.'GLASS') THEN
         IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1) THEN
            WRITE(OUTLYNE,*)'"PIKUP COATING" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(WQ.EQ.'GRT') THEN
         IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1) THEN
            WRITE(OUTLYNE,*)'"PIKUP GRT" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(WQ.EQ.'PRO') THEN
         IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1) THEN
            WRITE(OUTLYNE,*)'"PIKUP PRO" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      IF(WQ.EQ.'NPRO') THEN
         IF(SST.EQ.1.OR.S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1) THEN
            WRITE(OUTLYNE,*)'"PIKUP NPRO" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
   ...
   IF(WC.EQ.'PIKD') THEN
      SST=0
      IF(WQ.NE.'RD'.AND.WQ.NE.'CV'.AND.WQ.NE.'CC'.AND.WQ.NE.'AH'.AND.WQ.NE.'TH'.AND.WQ.NE.'AD'.AND.WC.NE.'AE'.AND.WC.NE.'AC'.AND.WQ.NE.'AF'.AND.WQ.NE.'AG'.AND.WQ.NE.'CVTOR'.AND.WQ.NE.'RDTOR'.AND.WQ.NE.'YD'.AND.WQ.NE.'XD'.AND.WQ.NE.'ZD'.AND.WQ.NE.'ALPHA'.AND.WQ.NE.'BETA'.AND.WQ.NE.'AI'.AND.WQ.NE.'GAMMA'.AND.WQ.NE.'CLAP'.AND.WQ.NE.'COBS'.AND.WQ.NE.'CCTOR'.AND.WQ.NE.'ADTOR'.AND.WQ.NE.'AETOR'.AND.WQ.NE.'AFTOR'.AND.WQ.NE.'AGTOR'.AND.WQ.NE.'AJ'.AND.WQ.NE.'GLASS'.AND.WQ.NE.'PRO'.AND.WQ.NE.'NPRO'.AND.WQ.NE.'AK'.AND.WQ.NE.'AL'.AND.WQ.NE.'THOAL'.AND.WQ.NE.'PIVX'.AND.WQ.NE.'PIVY'.AND.WQ.NE.'PIVZ'.AND.WQ.NE.'GDX'.AND.WQ.NE.'GDY'.AND.WQ.NE.'GDZ'.AND.WQ.NE.'GALPHA'.AND.WQ.NE.'GBETA'.AND.WQ.NE.'GGAMMA'.AND.WQ.NE.'COATING') THEN
         WRITE(OUTLYNE,*)'INVALID QUALIFIER FOUND'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         ...
         RETURN
      END IF
      IF(WQ.EQ.'RD'.OR.WQ.EQ.'CV'.OR.WQ.EQ.'CC'.OR.WQ.EQ.'AH'.OR.WQ.EQ.'TH'.OR.WQ.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.'AC'.OR.WQ.EQ.'AF'.OR.WQ.EQ.'AG'.OR.WQ.EQ.'CVTOR'.OR.WQ.EQ.'AI'.OR.WQ.EQ.'RDTOR'.OR.WQ.EQ.'YD'.OR.WQ.EQ.'XD'.OR.WQ.EQ.'AJ'.OR.WQ.EQ.'ALPHA'.OR.WQ.EQ.'BETA'.OR.WQ.EQ.'AK'.OR.WQ .EQ.'GAMMA'.OR.WQ.EQ.'CLAP'.OR.WQ.EQ.'COBS'.OR.WQ.EQ.'AL'.OR.WQ.EQ.'CCTOR'.OR.WQ.EQ.'ADTOR'.OR.WQ.EQ.'AETOR'.OR.WQ.EQ.'AFTOR'.OR.WQ.EQ.'AGTOR'.OR.WQ.EQ.'GLASS'.OR.WQ.EQ.'PRO'.OR.WQ.EQ.'NPRO'.OR.WQ.EQ.'ZD'.OR.WQ.EQ.'PIVX'.OR.WQ.EQ.'PIVY'.OR.WQ.EQ.'PIVZ'.OR.WQ.EQ.'GDX'.OR.WQ.EQ.'GDY'.OR.WQ.EQ.'GDZ'.OR.WQ.EQ.'GALPHA'.OR.WQ.EQ.'GBETA'.OR.WQ.EQ.'GGAMMA'.OR.WQ.EQ.'COATING') THEN
         IF(SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
            WRITE(OUTLYNE,*)'"PIKD" TAKES NO STRING OR NUMERIC WORDS #3 THROUGH #5'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
         ...
         END IF
         IF(DF1.EQ.1.AND.DF2.EQ.0.OR.DF1.EQ.0.AND.DF2.EQ.1) THEN
            WRITE(OUTLYNE,*)'"PIKD" USES EITHER TWO OR ZERO NUMERIC WORDS'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            CALL MACFAL
...
!
   IF(WC.EQ.'CLAP'.OR.WC.EQ.'COBS') THEN
      IF(SST.EQ.1) THEN
         WRITE(OUTLYNE,*)'"',WC(1:4),'" ONLY TAKES QUALIFIER AND NUMERIC WORD INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
         ...
         RETURN
      END IF
      IF(WQ.EQ.'        '.OR.WQ.EQ.'ERASE'.OR.WQ.EQ.'ELIP'.OR.WQ.EQ.'ELIPE'.OR.WQ.EQ.'RECT'.OR.WQ.EQ.'RECTE'.OR.WQ.EQ.'RCTK'.OR.WQ.EQ.'RCTKE'.OR.WQ.EQ.'POLY'.OR.WQ.EQ.'POLYE'.OR.WQ.EQ.'IPOLY'.OR.WQ.EQ.'IPOLYE') THEN
         IF(WQ.EQ.'        '.OR.WQ.EQ.'ERASE') THEN
            ...
            IF(WQ.EQ.'ERASE') THEN
               IF(DF4.EQ.0.OR.DF5.EQ.0) THEN
                  WRITE(OUTLYNE,*)'NUMERIC WORDS #4 AND #5 NOT USED IN THIS INSTANCE'
                  CALL SHOWIT(1)
                  WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
                  CALL SHOWIT(1)
                  RETRET=1
...
!       INVALID QUALIFIER
   ...
   IF(CEE) THEN
!
      IF(WC.EQ.'C1'.OR.WC.EQ.'C2'.OR.WC.EQ.'C3'.OR.WC.EQ.'C4'.OR.WC.EQ.'C5'.OR.WC.EQ.'C6'.OR.WC.EQ.'C7'.OR.WC.EQ.'C8'.OR.WC.EQ.'C9')THEN

         IF(SST.EQ.1.OR.SQ.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
            WRITE(OUTLYNE,*)'"',WC(1:2),'" ONLY TAKES NUMERIC WORD #1 AND #2 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      ELSE
         IF(SST.EQ.1.OR.SQ.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
            WRITE(OUTLYNE,*)'"',WC(1:3),'" ONLY TAKES NUMERIC WORD #1 AND #2 INPUT'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            RETRET=1
      ...
      END IF
!
      IF(DF1.EQ.1.OR.DF2.EQ.1.OR.DF1.EQ.1.AND.DF2.EQ.1) THEN
...
!       CHECK SURFACE NUMBER RANGE
   ...
   IF(WC.EQ.'SPECIAL'.OR.WC.EQ.'GENL') THEN
      IF(SST.EQ.1.OR.SQ.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)'"SPECIAL OR GENL" ONLY TAKES NUMERIC WORD #1 AND #2 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETRET=1
...
!
   CHARACTER BLANK*140,ATEST*8,PART*23,A*140,BTEST*29
!
   COMMON/BLAAA/BLANK
!
   INTEGER SCRCNT,AATI,AATJ,AATJK,ALLOERR,ILINE,NUM,CHGLOC,CHGLO1,ELINE,ULINE,SCR(1:2000),LOCCNT(1:2000),EXTRA,CNT,CFGLAS,IL,CFGNOW,I,JJ,K,II,KK,KKK,JK,J
!
...
997 CNT=0
   DO 991 J=1, CFGCNT(I)
      ...
      IF((HOLDER(1:3)).EQ.'CHG') THEN
         EE12=CONFG(I,(J+1))
         HOLDER=EE12
         IF((HOLDER(1:3)).EQ.'CHG'.OR.(HOLDER(1:3)).EQ.'SAY'.OR.(HOLDER(1:3)).EQ.'SAX'.OR.(HOLDER(1:3)).EQ.'WRX'.OR.(HOLDER(1:3)).EQ.'WRY'.OR.(HOLDER(1:3)).EQ.'BDX'.OR.(HOLDER(1:3)).EQ.'BDY'.OR.(HOLDER(1:4)).EQ.'NAOY'.OR.(HOLDER(1:4)).EQ.'NAOX'.OR.(HOLDER(1:4)).EQ.'FNOY'.OR.(HOLDER(1:4)).EQ.'FNOX'.OR.(HOLDER(1:3)).EQ.'SCY'.OR.(HOLDER(1:3)).EQ.'SCX'.OR.(HOLDER(1:2)).EQ.'LI'.OR.(HOLDER(1:3)).EQ.'LIC'.OR.(HOLDER(1:3)).EQ.'INI'.OR.(HOLDER(1:5)).EQ.'LTYPE'.OR.(HOLDER(1:4)).EQ.'MODE'.OR.(HOLDER(1:5)).EQ.'SPTWT'.OR.(HOLDER(1:6)).EQ.'SPTWT2'.OR.(HOLDER(1:2)).EQ.'WV'.OR.(HOLDER(1:3)).EQ.'WV2'.OR.(HOLDER(1:5)).EQ.'UNITS'.OR.(HOLDER(1:3)).EQ.'PCW'.OR.(HOLDER(1:3)).EQ.'SCW'.OR.(HOLDER(1:8)).EQ.'AUTOFUNC'.OR.HOLDER(1:4).EQ.'ZERO'.OR.(HOLDER(1:4)).EQ.'PXIM'.OR.(HOLDER(1:4)).EQ.'PYIM'.OR.(HOLDER(1:4)).EQ.'RXIM'.OR.(HOLDER(1:4)).EQ.'RYIM'.OR.(HOLDER(1:2)).EQ.'CW'.OR.(HOLDER(1:3)).EQ.'EOS') THEN
            CNT=CNT+1
...
!       DETERMINE THE LINE NUMBERS FOR U L AND EOS
      IF((HOLDER(1:10)).EQ.'U        L'.OR.(HOLDER(1:13)).EQ.'UPDATE   LENS'.OR.(HOLDER(1:10)).EQ.'UPDATE   L'.OR.(HOLDER(1:13)).EQ.'U        LENS') ULINE=K
...
!       CHECK FOR BLANK OR NON-SURFACE AND SKIP
      EE12=CONFG(I,J)
      HOLDER=EE12
      IF(HOLDER.EQ.BLANK.OR.HOLDER(1:3).EQ.'SAY'.OR.HOLDER(1:3).EQ.'SAX'.OR.HOLDER(1:3).EQ.'WRX'.OR.HOLDER(1:3).EQ.'WRY'.OR.HOLDER(1:3).EQ.'BDX'.OR.HOLDER(1:3).EQ.'BDY'.OR.HOLDER(1:4).EQ.'NAOY'.OR.HOLDER(1:4).EQ.'NAOX'.OR.HOLDER(1:4).EQ.'FNOY'.OR.HOLDER(1:4).EQ.'FNOX'.OR.HOLDER(1:3).EQ.'SCY'.OR.HOLDER(1:3).EQ.'SCX'.OR.HOLDER(1:2).EQ.'LI'.OR.HOLDER(1:3).EQ.'LIC'.OR.HOLDER(1:3).EQ.'INI'.OR.HOLDER(1:5).EQ.'LTYPE'.OR.HOLDER(1:4).EQ.'MODE'.OR.HOLDER(1:5).EQ.'SPTWT'.OR.HOLDER(1:6).EQ.'SPTWT2'.OR.HOLDER(1:2).EQ.'WV'.OR.HOLDER(1:3).EQ.'WV2'.OR.HOLDER(1:5).EQ.'UNITS'.OR.HOLDER(1:3).EQ.'PCW'.OR.(HOLDER(1:8)).EQ.'AUTOFUNC'.OR.HOLDER(1:4).EQ.'ZERO'.OR.(HOLDER(1:4)).EQ.'PXIM'.OR.(HOLDER(1:4)).EQ.'PYIM'.OR.(HOLDER(1:4)).EQ.'RXIM'.OR.(HOLDER(1:4)).EQ.'RYIM'.OR.HOLDER(1:3).EQ.'SCW'.OR.HOLDER(1:2).EQ.'CW') THEN
         CONFG(I,J)=BLANK(1:140)
         GO TO 31
      ELSE
...
!
   ...
   INTEGER SCRCNT,IEND,ULINE,ELINE,CHGCNT,CHG(1:2000),STP,I,J,K,ALLOERR
!
...
!
   ...
   IF(ATEST(1:4).EQ.'FLDS'.AND.ATEST(1:12).NE.'FLDS     MAX')AJJK=111
