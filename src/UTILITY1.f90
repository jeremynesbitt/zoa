...
!
      ...
      &.AND.WQ.NE.'ONTOL'.AND.WQ.NE.'SINGTOL'&
      &.AND.WQ.NE.'DIFTOL'.AND.WQ.NE.'DELSUR'.AND.WQ.NE.'SERLIM'&
...
!
      IF(WQ.NE.'SURTOL'.AND.WQ.NE.'AIMTOL'.AND.WQ.NE.'SERINC'&
      &.AND.WQ.NE.'PFAC'.AND.WQ.NE.'MRAYS'.AND.WQ.NE.'CAIMTOL'&
      &.AND.WQ.NE.'DINMUL'.AND.WQ.NE.'NRAITR'&
      &.AND.WQ.NE.'DIFTOL'.AND.WQ.NE.'DELSUR'.AND.WQ.NE.'ONTOL'&
      &.AND.WQ.NE.'SINGTOL'.AND.WQ.NE.'LINTOL'&
      &.AND.WQ.NE.'SERLIM'.AND.WQ.NE.'SAGDEL'.AND.WQ.NE.'MAXREG'.AND.&
      &WQ.NE.'MAXOPT') THEN
         CALL REPORT_ERROR_AND_FAIL(&
