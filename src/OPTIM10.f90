...
!
   LOGICAL CNOT
!
   REAL*8 WEIT,DINCR,VLOW,VHIGH,WORD2,SYS12,SYS13,REFHTT ,COMPNUM,WAVERCW,HM1,HC1
!
!
   WEIT=1.0D0
!
...
!U    USES JACME
   ...
   REAL*8 JKAX,JKXX,JKBX,JKXMIN,V ,XICOM,JACME
...
FUNCTION JACME(NUB,PCOM,XICOM)
   ...
   IMPLICIT NONE
   INTEGER NUB
   REAL*8 JACME,AX,BX,CX,F1DIM,JKX,FAX,FBX,FCX ,FX,X,XMIN,FDEL1,FDEL2,FDEL3,DX1,DX2,DX3,DX12,DX22,DX32 ,AXX,BXX,CXX,AAEE,BBEE,CCEE,PCOM,XICOM
...
!
   REAL*8 IPFUN,V1,OLDV1,JK_DEL ,N1,FUNCIP,XDUM(1:100000)
...
!
   REAL*8 X(1:100000),V1,MAX,VTEMP,OLDCUR,NEWCUR ,N1
!
   LOGICAL LVAL
!
