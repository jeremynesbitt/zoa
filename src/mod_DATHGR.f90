...
!     INCLUDE FILE FOR ROUTINES THAT CALL HGRAPH
    ...
    real(real64) POLDX,POLDY,POLDZ,PCURX,PCURY,PCURZ,PNEWX,PNEWY,PNEWZ
    COMMON/PENMOVER/POLDX,POLDY,POLDZ,PCURX,PCURY,PCURZ,PNEWX,      &
  & PNEWY,PNEWZ
!
!     USER DEFINED FAN AXIS PLOTS
