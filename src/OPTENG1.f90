...
!
   IF(SST.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"XXF (P)" ONLY TAKES NUMERIC WORD #1, #2 AND #3 INPUT'
      CALL SHOWIT(1)
...
!
   IF(SQ.EQ.1.AND.WQ.NE.'P') THEN
      WRITE(OUTLYNE,*)&
      &'"P" IS THE ONLY OPTIONAL QUALIFIER WORD FOR "XXF"'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   &.OR.DF3.EQ.0.AND.W3.EQ.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"XXF (P)" DOES NOT ACCEPT 0.0 FOR ANY OF ITS INPUT VALUES'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   &THEN
      WRITE(OUTLYNE,*)&
      &'"(X) AND (X`) MAY NOT BE BOTH POSITIVE OF BOTH NEGATIVE'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   &DF1.EQ.0.AND.DF2.EQ.1.AND.DF3.EQ.0.OR.&
   &DF1.EQ.0.AND.DF2.EQ.0.AND.DF3.EQ.1) THEN
!     PROCEED
...
!
   IF(SST.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"XXFF (P)" ONLY TAKES NUMERIC WORD #1, #2, #3 AND #4 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(SQ.EQ.1.AND.WQ.NE.'P') THEN
      WRITE(OUTLYNE,*)&
      &'"P" IS THE ONLY OPTIONAL QUALIFIER WORD FOR "XXFF"'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   END IF
   IF(DF1.EQ.0.AND.W1.EQ.0.0D0.OR.DF2.EQ.0.AND.W2.EQ.0.0D0 &
   &.OR.DF3.EQ.0.AND.W3.EQ.0.0D0.OR.DF4.EQ.0.AND.W4.EQ.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"XXFF (P)" DOES NOT ACCEPT 0.0 FOR ANY OF ITS INPUT VALUES'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   &DF1.EQ.0.AND.DF2.EQ.1.AND.DF3.EQ.0.AND.DF4.EQ.0.OR.&
   &DF1.EQ.0.AND.DF2.EQ.0.AND.DF3.EQ.1.AND.DF4.EQ.0.OR.&
   &DF1.EQ.0.AND.DF2.EQ.0.AND.DF3.EQ.0.AND.DF4.EQ.1) THEN
!     PROCEED
...
400      FORMAT('         THE NEW (F`) IS = ',G13.6)
   ...
   ELSE
      WRITE(OUTLYNE,*)&
      &'"XXFF (P)" REQUIRES TWO EXPLICIT NUMERIC VALUES'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"OUTFLT" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!     WC IS PLANK
   IF(WC.EQ.'PLANK') THEN
      ...
      IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"PLANK" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*) 'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!     WC IS STEFBOLT
   IF(WC.EQ.'STEFBOLT') THEN
      ...
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"STEFBOLT" REQUIRES EXPLICIT NUMERIC WORD #1'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*) 'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(W2.LE.0.0D0) THEN
         WRITE(OUTLYNE,*)&
         &'"STEFBOLT" REQUIRES (LAMBDA UPPER) GREATER THAN 0'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*) 'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(W3.LT.0.0D0) THEN
         WRITE(OUTLYNE,*)&
         &'"STEFBOLT" REQUIRES (LAMBDA LOWER) GREATER THAN OR EQUAL TO 0'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*) 'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!     WATT UNITS
      ...
      DO K=1,1000000
         ...
         SUM=SUM+&
         &(((1.0D0/LAMBDA**3)+&
         &((3.0D0*T)/(DBLE(K)*C2*(LAMBDA**2)))+&
         &((6.0D0*(T**2))/(DBLE((K**2))*(C2**2)*LAMBDA))+&
         &((6.0D0*(T**3))/(DBLE((K**3))*(C2**3))))*A)
...
!     PHOTON UNITS
      ...
      DO K=1,1000000
         ...
         SUM=SUM+&
         &(((1.0D0/(LAMBDA**2))+&
         &((2.0D0*T)/(DBLE(K)*C2*LAMBDA))+&
         &((2.0D0*(T**2))/(DBLE((K**2))*(C2**2))))*A)
...
!
   IF(SST.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"OIF (P)" ONLY TAKES NUMERIC WORD #1, #2 AND #3 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(SQ.EQ.1.AND.WQ.NE.'P') THEN
      WRITE(OUTLYNE,*)&
      &'"P" IS THE ONLY OPTIONAL QUALIFIER WORD FOR "OIF"'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   &.OR.DF3.EQ.0.AND.W3.EQ.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"OIF (P)" DOES NOT ACCEPT 0.0 FOR ANY OF ITS INPUT VALUES'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"RAYLEIGH" TAKES NO NUMERIC WORD #3, #4 OR #5 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   IF(W0.LE.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'WAIST DIAMETER MUST BE GREATER THAN 0.0 WITH "RAYLEIGH"'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(LAMBDA.LE.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'WAVELENGTH MUST BE GREATER THAN 0.0 WITH "RAYLEIGH"'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"COST" TAKES NO NUMERIC WORD #3, #4 OR #5 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"COST" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(S2.EQ.1) THEN
      ...
      IF(W2.LE.W1) THEN
         WRITE(OUTLYNE,*)&
         &'SECOND SURFACE MUST FOLLOW FIRST SURFACE'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!
   ...
   IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"WEIGHT" TAKES NO NUMERIC WORD #3, #4 OR #5 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"WEIGHT" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"DR/FR" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(ARG1.LT.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'DR/FR CAN NOT BE CALCULATED FOR CURRENT INPUT VALUES'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   IF(SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1.OR.SQ.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"DTOR" ONLY TAKES NUMERIC WORD #1 AND #2 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"DTOR" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(W1.EQ.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"DTOR" REQUIRES A NON-ZERO D VALUE'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(W2.EQ.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"DTOR" REQUIRES A NON-ZERO (e) VALUE'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   IF(SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1.OR.SQ.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"RTOD" ONLY TAKES NUMERIC WORD #1 AND #2 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"RTOD" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(W1.EQ.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"RTOD" REQUIRES A NON-ZERO R VALUE'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(W2.EQ.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"RTOD" REQUIRES A NON-ZERO (e) VALUE'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   IF(SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1.OR.SQ.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"ETOCC" ONLY TAKES NUMERIC WORD #1 AND #2 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"ETOCC" REQUIRES EXPLICIT NUMERIC WORD #1'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(W1.LT.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"ETOCC" REQUIRES A POSITIVE NUMERIC WORD #1'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(S2.EQ.1.AND.W2.NE.-1.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'EXPLICIT NUMERIC WORD #2 INPUT MUST BE "-1.0"'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   &.OR.S2.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"CCTOE" ONLY TAKES NUMERIC WORD #1 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"CCTOE" REQUIRES EXPLICIT NUMERIC WORD #1'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(STI.EQ.1) THEN
      ...
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'GIVEN RADII OR CURVATURE CONIC CONSTANT AND RHO AS INPUTS'
      CALL SHOWIT(1)
      RETURN
   END IF
   IF(SST.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"Z0" ONLY TAKES QUALIFIER AND NUMERIC WORD #1, #2 AND #3 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1.OR.DF2.EQ.1.OR.DF3.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"Z0" REQUIRES EXPLICIT NUMERIC WORD #1, #2 AND #3 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(WQ(1:1).NE.'R'.AND.WQ(1:1).NE.'C') THEN
      WRITE(OUTLYNE,*)&
      &'"Z0" ONLY TAKES "R" (FOR RADIUS)'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'               OR "C" (FOR CURVATURE) AS QUALIFIER WORDS'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!     FLAT SURFACES
   IF(W1.EQ.0.0D0.OR.WQ.EQ.'R'.AND.DABS(W1).GT.1.0D20) THEN
      WRITE(OUTLYNE,*)&
      &'"Z0" REQUIRES A NON-PLANO SURFACE'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   IF(AC.LT.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"Z0" CAN NOT BE CALCULATED WITH CURRENT INPUT VALUES'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*) 'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(STI.EQ.1) THEN
      ...
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'GIVEN RADII OR CURVATURE CONIC CONSTANT AND Z AS INPUTS'
      CALL SHOWIT(1)
      RETURN
   END IF
   IF(SST.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"RHO" ONLY TAKES QUALIFIER AND NUMERIC WORD #1, #2 AND #3 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1.OR.DF2.EQ.1.OR.DF3.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"RHO" REQUIRES EXPLICIT NUMERIC WORD #1, #2 AND #3 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!     FLAT SURFACES
   IF(W1.EQ.0.0D0.OR.WQ.EQ.'R'.AND.DABS(W1).GT.1.0D20) THEN
      WRITE(OUTLYNE,*)&
      &'"RHO" REQUIRES A NON-PLANO SURFACE'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   IF(RHO2.LT.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"RHO" WILL BE IMAGINARY WITH CURRENT INPUT VALUES'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(STI.EQ.1) THEN
      ...
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'GIVEN RADII OR CURVATURE AND CONIC CONSTANT AS INPUTS'
      CALL SHOWIT(1)
      RETURN
   END IF
   IF(SST.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"FOCI" ONLY TAKES QUALIFIER AND NUMERIC WORD #1 AND #2 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"FOCI" REQUIRES EXPLICIT NUMERIC WORD #1 AND #2 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!     FLAT SURFACES
   IF(W1.EQ.0.0D0.OR.WQ.EQ.'R'.AND.DABS(W1).GT.1.0D20) THEN
      WRITE(OUTLYNE,*)&
      &'"FOCI" REQUIRES A NON-PLANO SURFACE'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!     SPHERICAL SURFACES
   IF(W2.EQ.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"FOCI" REQUIRES A NON-SPHERICAL SURFACE (CC NOT = 0)'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!     CC > 0 OBLATE SHPEROID SURFACES
   IF(W2.GT.0.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"FOCI" DOES NOT WORK WITH OBLATE SPHERIODS'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'"FOCI" REQUIRES CC < 0)'
      CALL SHOWIT(1)
...
!
   ...
   IF(SQ.EQ.1.OR.SST.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"K0" AND "CVG" TAKE NO QUALIFIER OR STRING INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(WC.EQ.'K0') THEN
      ...
      IF(DF1.EQ.1.OR.DF2.EQ.1.OR.DF3.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"K0" REQUIRES EXPLICIT NUMERIC WORD #1, #2 AND #3 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETURN
      ...
      IF(W1.EQ.0.0D0) THEN
         WRITE(OUTLYNE,*)&
         &'"K0" REQUIRES A NON-ZERO NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETURN
...
10    FORMAT('THE "Z0" VALUE IS : ',D23.15,' LENS UNITS')
   ...
   IF(WC.EQ.'CVG') THEN
      ...
      IF(DF1.EQ.1.OR.DF2.EQ.1.OR.DF3.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"CVG" REQUIRES EXPLICIT NUMERIC WORD #1, #2 AND #3 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETURN
      ...
      IF(CURVE.EQ.0.0D0) THEN
         WRITE(OUTLYNE,*)&
         &'THE "CVR" VALUE WAS INFINITE. CHECK YOUR INPUT VALUES'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         REG(40)=REG(9)
