   ...
   IF(TYPE.EQ.1) THEN
      ...
      DO K=1,3
         ...
         DO 10 I=1,10
            VV1=DBLE(I)
!     CHECK WAVELENGTH
            IF(VV1.EQ.1.0D0.AND.SYSTEM(1).EQ.0.0D0.OR.VV1.EQ.2.0D0.AND.SYSTEM(2).EQ.0.0D0.OR.VV1.EQ.3.0D0.AND.SYSTEM(3).EQ.0.0D0.OR.VV1.EQ.4.0D0.AND.SYSTEM(4).EQ.0.0D0.OR.VV1.EQ.5.0D0.AND.SYSTEM(5).EQ.0.0D0.OR.VV1.EQ.6.0D0.AND.SYSTEM(71).EQ.0.0D0.OR.VV1.EQ.7.0D0.AND.SYSTEM(72).EQ.0.0D0.OR.VV1.EQ.8.0D0.AND.SYSTEM(73).EQ.0.0D0.OR.VV1.EQ.9.0D0.AND.SYSTEM(74).EQ.0.0D0.OR.VV1.EQ.10.0D0.AND.SYSTEM(75).EQ.0.0D0) GO TO 10
