...
!
   IF(S2.EQ.1.OR.S3.EQ.1.OR.S4.EQ.1 .OR.S5.EQ.1) THEN
      IF(WC.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF'.OR.WC.EQ.'AG'.OR.WC.EQ.'ACK')OUTLYNE='ACK,AD,AE,AF AND AG TAKE NO NUMERIC WORD #2 THROUGH #5 INPUT'
   ...
   END IF
   IF(SST.EQ.1) THEN
      IF(WC.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF'.OR.WC.EQ.'AG'.OR.WC.EQ.'ACK')OUTLYNE='ACK,AD,AE,AF AND AG TAKE NO STRING INPUT'
   ...
   END IF
   IF(SQ.EQ.1.AND.F5.EQ.1) THEN
      IF(WC.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF'.OR.WC.EQ.'AG'.OR.WC.EQ.'ACK')OUTLYNE='ACK,AD,AE,AF AND AG TAKE NO QUALIFIER WORD IN LENS INPUT MODE'
   ...
   IF(F6.EQ.1) THEN
      IF(WQ.NE.'        '.AND.WQ.NE.'CENT'.AND.WQ.NE.'DELT') THEN
         IF(WC.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF'.OR.WC.EQ.'AG'.OR.WC.EQ.'ACK')OUTLYNE='INVALID QUALIFIER WORD USED WITH ACK,AD,AE,AF OR AG'
   ...
   END IF
   IF(DF1.EQ.1)THEN
      IF(WC.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF'.OR.WC.EQ.'AG'.OR.WC.EQ.'ACK')OUTLYNE='ACK,AD,AE,AF OR AG REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
...
!
   IF(WC.EQ.'AD'.OR.WC.EQ.'AF'.OR.WC.EQ.'AE'.OR.WC.EQ.'AG'.OR.WC.EQ.'ACK'.OR.WC.EQ.'AH'.OR.WC.EQ.'AI'.OR.WC.EQ.'AJ'.OR.WC.EQ.'AK'.OR.WC.EQ.'AL') THEN
...
!       SURFACE NOT ASPHERIC, SET IT AS SUCH.
         IF(WC.EQ.'ACK') THEN
            IF(surf_curvature(SURF).NE.0.0D0) THEN
               ...
               CALL SHOWIT(1)
               OUTLYNE='THE "ACK" TERM WILL BE IGNORED FOR THIS NON-PLANO SURFACE'
               CALL SHOWIT(1)
            END IF
            W5=W1
            DF1=1
         ...
         ELSE
         END IF
         IF(WC.EQ.'ACK'.OR.WC.EQ.'AD'.OR.WC.EQ.'AF'.OR.WC.EQ.'AG'.OR.WC.EQ.'AE')CALL SASPH
...
!       DELETE PIKUP
      ...
      IF(WC.EQ.'AD'.OR.WC.EQ.'AE'.OR.WC.EQ.'AF'.OR.WC.EQ.'AG'.OR.WC.EQ.'ACK'.OR.WC.EQ.'AH'.OR.WC.EQ.'AI'.OR.WC.EQ.'AJ'.OR.WC.EQ.'AK'.OR.WC.EQ.'AL')WRITE(OUTLYNE,*)'SURFACE',SURF,' : PIKUP (',trim(WC),') DELETED'
