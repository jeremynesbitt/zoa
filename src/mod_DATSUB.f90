...
!
!     DINCRS
  real(real64) DINC1,DINC2,DINC3,DINC4,DINC5A,DINC5B &
...
!
  real(real64) OPERND(1:100000,1:20),OLDOP(1:100000,1:20),CURFIG
!
...
!
  ...
  real(real64) FMTFMT,OLDFMT,OOLDFMT
...
!
  real(real64) FIELDX(1:200),FIELDY(1:200),FIELDZ(1:200) &
...
!     AND BTILT(A, B OR G COMMANDS
  real(real64) ASTILTXP,ASTILTYP,ASTILTZP
  real(real64) BSTILTXP,BSTILTYP,BSTILTZP
  real(real64) GSTILTXP,GSTILTYP,GSTILTZP
  real(real64) ABTILTXP,ABTILTYP,ABTILTZP
  real(real64) BBTILTXP,BBTILTYP,BBTILTZP
  real(real64) GBTILTXP,GBTILTYP,GBTILTZP
...
!     DEFAULT AUTO STUFF FOR AUTO GENERATION OF OPERANDS 12/7/99
  ...
  real(real64) DFWT1,DFWT2,DFWT3,DEFAULT_FOB(1:4,1:25),DFDEL
...
!       GLOBAL LIMITS ON TH AND RD VARIABLES IN OPTIMIZATION
    real(real64) THMINLIM,THMAXLIM,RDNEGLIM,RDPOSLIM
