...
!
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"UPDATE COMPVAR" TAKES NO EXPLICIT INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"UPDATE VARIABLE" TAKES NO EXPLICIT INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"UPDATE TVAR" TAKES NO EXPLICIT INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"UPDATE TOPER" TAKES NO EXPLICIT INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"UPDATE FOCRIT" TAKES NO EXPLICIT INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(SST.EQ.1.OR.SN.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"UPDATE MERIT" TAKES NO EXPLICIT INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!       "ROBB" EITHER TAKES OPTINAL NW1 AND NW2
   IF(STI.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"ROBB" PERFORMS CONVERGENCE ACCELERATION'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      DEALLOCATE(OLDX,DELOLDX,VSAVE,STAT=ALLOERR)
   ...
   IF(SQ.EQ.1.OR.SST.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"ROBB" TAKES NO QUALIFIER OR STRING INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(S4.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"ROBB" TAKES NO NUMERIC WORD #4 OR #5 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(DF3.EQ.0.AND.W3.LT.5.0D0) THEN
      WRITE(OUTLYNE,*)&
      &'"ROBB" REQUIRES "rmax" TO BE GREATER THAN OR EQUAL TO 5'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(STI.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"RESTORE MIN LOOKS ALONG THE CURRENT SOLUTION VECTOR'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
   ...
   IF(SN.EQ.1.OR.SST.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"RESTORE MIN TAKES NO NUMERIC OR STRING INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   ...
   &WT(VN1),BTB(VN1,VN1),BTG(VN1),STAT=ALLOERR)
   W(1:VN)=0.0D0
   WT(1:VN)=0.0D0
   BTG(1:VN)=0.0D0
   V(1:VN,1:VN)=0.0D0
...
!
   INTEGER SSN,SM,NP2,MP,N,J,I,L,M,VTYPE,ALTYPE,VADD,VCFG &
   &,VN1,MAXCNT,IV1,VN,ALLOERR,IID,JJD
!
