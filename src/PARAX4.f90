...
!       THE DESIRED F-NUMBER IS STORED IN sys_fno_val_y()
!       IF ALL SOLVED ARE SHUT OFF, THE NEW F-NUMBER
!       IS REALIZED BY SCALING THE SAY VALUE BY:
!
!       CURRENT F-NUMBER/NEW F-NUMBER
!
      call set_sys_say(sys_say()*(-(1.0D0/(2.0D0*PXTRAY(2,(INT(sys_last_surf())))))/sys_fno_val_y()))
!
...
!       THE DESIRED F-NUMBER IS STORED IN sys_fno_val_x()
!       IF ALL SOLVED ARE SHUT OFF, THE NEW F-NUMBER
!       IS REALIZED BY SCALING THE SAX VALUE BY:
!
!       CURRENT F-NUMBER/NEW F-NUMBER
!
      call set_sys_sax(sys_sax()*(-(1.0D0/(2.0D0*PXTRAX(2,(INT(sys_last_surf())))))/sys_fno_val_x()))
!
!       NOW WE PERFORM A PARAXIAL RAY TRACE WITHOUT AND SOLVES
!
!       TELECENTRIC STUFF, 11/12/2000
...
!       CALCULATE INTV
      IF(WQ.EQ.'PACX'.OR.WQ.EQ.'PLCX'.OR.WQ.EQ.'SACX'.OR.WQ.EQ.'SLCX') THEN
         INTV=((PXTRAX(5,SF)*ALENS(CW,(SF-1))*PXTRAX(2,(SF-1)))-(PXTRAX(1,SF)*ALENS(CW,(SF-1))*PXTRAX(6,(SF-1))))
      END IF
      IF(WQ.EQ.'PACY'.OR.WQ.EQ.'PLCY'.OR.WQ.EQ.'SACY'.OR.WQ.EQ.'SLCY') THEN
...
!       MODE IS FOCAL
      IF(WQ(1:1).NE.'X')INV=-2.0*ALENS(CW,(SF-1))*PXTRAY(2,(SF-1))
      IF(WQ(1:1).EQ.'X')INV=-2.0*ALENS(CW,(SF-1))*PXTRAX(2,(SF-1))
   END IF
   IF(sys_mode().EQ.3.0D0) THEN
!       MODE IS AFOCAL
      IF(WQ(1:1).NE.'X')INV= 2.0*ALENS(CW,(SF-1))*PXTRAY(1,SF)
      IF(WQ(1:1).EQ.'X')INV= 2.0*ALENS(CW,(SF-1))*PXTRAX(1,SF)
   END IF
...
!       3RD, 5TH AND 7TH ORDER ABERRATIONS
      ...
      IF(WQ.EQ.'TOBSA')     VALUE=MAB57(4,INT(W1))+MAB57(5,INT(W1))+MAB57(6,INT(W1))
      IF(WQ.EQ.'XTOBSA')    VALUE=XMAB57(4,INT(W1))+XMAB57(5,INT(W1))+XMAB57(6,INT(W1))
      IF(WQ.EQ.'SOBSA')     VALUE=MAB57(5,INT(W1))
      IF(WQ.EQ.'XSOBSA')    VALUE=XMAB57(5,INT(W1))
      IF(WQ.EQ.'ELCMA')     VALUE=MAB57(7,INT(W1))+MAB57(8,INT(W1))
      IF(WQ.EQ.'XELCMA')    VALUE=XMAB57(7,INT(W1))+XMAB57(8,INT(W1))
      IF(WQ.EQ.'TAS')       VALUE=MAB57(10,INT(W1))+(5.0*MAB57(11,INT(W1)))
      IF(WQ.EQ.'XTAS')      VALUE=XMAB57(10,INT(W1))+(5.0*XMAB57(11,INT(W1)))
      IF(WQ.EQ.'SAS')       VALUE=MAB57(10,INT(W1))+MAB57(11,INT(W1))
      IF(WQ.EQ.'XSAS')      VALUE=XMAB57(10,INT(W1))+XMAB57(11,INT(W1))
...
!       PRIMARY CHROMATIC ABERRATION DIFFERENCES
      ...
      IF(WQ.EQ.'TOBSAP')     VALUE=PDF57(4,INT(W1))+PDF57(5,INT(W1))+PDF57(6,INT(W1))
      IF(WQ.EQ.'XTOBSAP')    VALUE=XPDF57(4,INT(W1))+XPDF57(5,INT(W1))+XPDF57(6,INT(W1))
      IF(WQ.EQ.'SOBSAP')     VALUE=PDF57(5,INT(W1))
      IF(WQ.EQ.'XSOBSAP')    VALUE=XPDF57(5,INT(W1))
      IF(WQ.EQ.'ELCMAP')     VALUE=PDF57(7,INT(W1))+PDF57(8,INT(W1))
      IF(WQ.EQ.'XELCMAP')    VALUE=XPDF57(7,INT(W1))+XPDF57(8,INT(W1))
      IF(WQ.EQ.'TASP')       VALUE=PDF57(10,INT(W1))+(5.0*PDF57(11,INT(W1)))
      IF(WQ.EQ.'XTASP')      VALUE=XPDF57(10,INT(W1))+(5.0*XPDF57(11,INT(W1)))
      IF(WQ.EQ.'SASP')       VALUE=PDF57(10,INT(W1))+PDF57(11,INT(W1))
      IF(WQ.EQ.'XSASP')      VALUE=XPDF57(10,INT(W1))+XPDF57(11,INT(W1))
...
!       SECONDARY CHROMATIC ABERRATION DIFFERENCES
      ...
      IF(WQ.EQ.'TOBSAS')     VALUE=SDF57(4,INT(W1))+SDF57(5,INT(W1))+SDF57(6,INT(W1))
      IF(WQ.EQ.'XTOBSAS')    VALUE=XSDF57(4,INT(W1))+XSDF57(5,INT(W1))+XSDF57(6,INT(W1))
      IF(WQ.EQ.'SOBSAS')     VALUE=SDF57(5,INT(W1))
      IF(WQ.EQ.'XSOBSAS')    VALUE=XSDF57(5,INT(W1))
      IF(WQ.EQ.'ELCMAS')     VALUE=SDF57(7,INT(W1))+SDF57(8,INT(W1))
      IF(WQ.EQ.'XELCMAS')    VALUE=XSDF57(7,INT(W1))+XSDF57(8,INT(W1))
      IF(WQ.EQ.'TASS')       VALUE=SDF57(10,INT(W1))+(5.0*SDF57(11,INT(W1)))
      IF(WQ.EQ.'XTASS')      VALUE=XSDF57(10,INT(W1))+(5.0*XSDF57(11,INT(W1)))
      IF(WQ.EQ.'SASS')       VALUE=SDF57(10,INT(W1))+SDF57(11,INT(W1))
      IF(WQ.EQ.'XSASS')      VALUE=XSDF57(10,INT(W1))+XSDF57(11,INT(W1))
...
!       5TH AND 7TH ORDER INTRINSIC SURFACE ABERRATIONS
      ...
      IF(WQ.EQ.'TOBSAI')     VALUE=SAB57(4,INT(W1))+SAB57(5,INT(W1))+SAB57(6,INT(W1))
      IF(WQ.EQ.'XTOBSAI')    VALUE=XSAB57(4,INT(W1))+XSAB57(5,INT(W1))+XSAB57(6,INT(W1))
      IF(WQ.EQ.'SOBSAI')     VALUE=SAB57(5,INT(W1))
      IF(WQ.EQ.'XSOBSAI')    VALUE=XSAB57(5,INT(W1))
      IF(WQ.EQ.'ELCMAI')     VALUE=SAB57(7,INT(W1))+SAB57(8,INT(W1))
      IF(WQ.EQ.'XELCMAI')    VALUE=XSAB57(7,INT(W1))+XSAB57(8,INT(W1))
      IF(WQ.EQ.'TASI')       VALUE=SAB57(10,INT(W1))+(5.0*SAB57(11,INT(W1)))
      IF(WQ.EQ.'XTASI')      VALUE=XSAB57(10,INT(W1))+(5.0*XSAB57(11,INT(W1)))
      IF(WQ.EQ.'SASI')       VALUE=SAB57(10,INT(W1))+SAB57(11,INT(W1))
      IF(WQ.EQ.'XSASI')      VALUE=XSAB57(10,INT(W1))+XSAB57(11,INT(W1))
...
!       3RD, 5TH AND 7TH ORDER ABERRATIONS
      ...
      IF(WQ.EQ.'TOBSA') THEN
         DO I=0,INT(sys_last_surf())
            V=V+MAB57(4,I)+MAB57(5,I)+MAB57(6,I)
         END DO
      END IF
      IF(WQ.EQ.'XTOBSA') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XMAB57(4,I)+XMAB57(5,I)+XMAB57(6,I)
         END DO
      END IF
      IF(WQ.EQ.'SOBSA') THEN
         DO I=0,INT(sys_last_surf())
      ...
      IF(WQ.EQ.'ELCMA') THEN
         DO I=0,INT(sys_last_surf())
            V=V+MAB57(7,I)+MAB57(8,I)
         END DO
      END IF
      IF(WQ.EQ.'XELCMA') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XMAB57(7,I)+XMAB57(8,I)
         END DO
      END IF
      IF(WQ.EQ.'TAS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+MAB57(10,I)+(5.0*MAB57(11,I))
         END DO
      END IF
      IF(WQ.EQ.'XTAS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XMAB57(10,I)+(5.0*XMAB57(11,I))
         END DO
      END IF
      IF(WQ.EQ.'SAS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+MAB57(10,I)+MAB57(11,I)
         END DO
      END IF
      IF(WQ.EQ.'XSAS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XMAB57(10,I)+XMAB57(11,I)
         END DO
      END IF
      IF(WQ.EQ.'SA7') THEN
         DO I=0,INT(sys_last_surf())
...
!       PRIMARY CHROMATIC ABERRATION DIFFERENCES
      ...
      IF(WQ.EQ.'TOBSAP') THEN
         DO I=0,INT(sys_last_surf())
            V=V+PDF57(4,I)+PDF57(5,I)+PDF57(6,I)
         END DO
      END IF
      IF(WQ.EQ.'XTOBSAP') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XPDF57(4,I)+XPDF57(5,I)+XPDF57(6,I)
         END DO
      END IF
      ...
      IF(WQ.EQ.'ELCMAP') THEN
         DO I=0,INT(sys_last_surf())
            V=V+PDF57(7,I)+PDF57(8,I)
         END DO
      END IF
      IF(WQ.EQ.'XELCMAP') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XPDF57(7,I)+XPDF57(8,I)
         END DO
      END IF
      IF(WQ.EQ.'TASP') THEN
         DO I=0,INT(sys_last_surf())
            V=V+PDF57(10,I)+(5.0*PDF57(11,I))
         END DO
      END IF
      IF(WQ.EQ.'XTASP') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XPDF57(10,I)+(5.0*XPDF57(11,I))
         END DO
      END IF
      IF(WQ.EQ.'SASP') THEN
         DO I=0,INT(sys_last_surf())
            V=V+PDF57(10,I)+PDF57(11,I)
         END DO
      END IF
      IF(WQ.EQ.'XSASP') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XPDF57(10,I)+XPDF57(11,I)
         END DO
      END IF
      IF(WQ.EQ.'SA7P') THEN
         DO I=0,INT(sys_last_surf())
...
!       SECONDARY CHROMATIC ABERRATION DIFFERENCES
      ...
      IF(WQ.EQ.'TOBSAS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+SDF57(4,I)+SDF57(5,I)+SDF57(6,I)
         END DO
      END IF
      IF(WQ.EQ.'XTOBSAS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XSDF57(4,I)+XSDF57(5,I)+XSDF57(6,I)
         END DO
      END IF
      ...
      IF(WQ.EQ.'ELCMAS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+SDF57(7,I)+SDF57(8,I)
         END DO
      END IF
      IF(WQ.EQ.'XELCMAS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XSDF57(7,I)+XSDF57(8,I)
         END DO
      END IF
      IF(WQ.EQ.'TASS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+SDF57(10,I)+(5.0*SDF57(11,I))
         END DO
      END IF
      IF(WQ.EQ.'XTASS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XSDF57(10,I)+(5.0*XSDF57(11,I))
         END DO
      END IF
      IF(WQ.EQ.'SASS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+SDF57(10,I)+SDF57(11,I)
         END DO
      END IF
      IF(WQ.EQ.'XSASS') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XSDF57(10,I)+XSDF57(11,I)
         END DO
      END IF
      IF(WQ.EQ.'SA7S') THEN
         DO I=0,INT(sys_last_surf())
...
!       5TH AND 7TH ORDER INTRINSIC SURFACE ABERRATIONS
      ...
      IF(WQ.EQ.'TOBSAI') THEN
         DO I=0,INT(sys_last_surf())
            V=V+SAB57(4,I)+SAB57(5,I)+SAB57(6,I)
         END DO
      END IF
      IF(WQ.EQ.'XTOBSAI') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XSAB57(4,I)+XSAB57(5,I)+XSAB57(6,I)
         END DO
      END IF
      ...
      IF(WQ.EQ.'ELCMAI') THEN
         DO I=0,INT(sys_last_surf())
            V=V+SAB57(7,I)+SAB57(8,I)
         END DO
      END IF
      IF(WQ.EQ.'XELCMAI') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XSAB57(7,I)+XSAB57(8,I)
         END DO
      END IF
      IF(WQ.EQ.'TASI') THEN
         DO I=0,INT(sys_last_surf())
            V=V+SAB57(10,I)+(5.0*SAB57(11,I))
         END DO
      END IF
      IF(WQ.EQ.'XTASI') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XSAB57(10,I)+(5.0*XSAB57(11,I))
         END DO
      END IF
      IF(WQ.EQ.'SASI') THEN
         DO I=0,INT(sys_last_surf())
            V=V+SAB57(10,I)+SAB57(11,I)
         END DO
      END IF
      IF(WQ.EQ.'XSASI') THEN
         DO I=0,INT(sys_last_surf())
            V=V+XSAB57(10,I)+XSAB57(11,I)
         END DO
      END IF
      IF(WQ.EQ.'SA7I') THEN
         DO I=0,INT(sys_last_surf())
