...
SUBROUTINE SHOWREG
   ...
   END IF
   IF(S1.EQ.0) THEN
      OUTLYNE='"SHOW" WITHOUT A QUALIFIER REQUIRES EXPLICIT NUMERIC WORD #1'
      CALL SHOWIT(1)
   ...
   IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      OUTLYNE='"SHOW" WITHOUT A QUALIFIER ONLY TAKES NUMERIC WORD #1 AND #2'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   END IF
   IF(SST.EQ.1) THEN
      OUTLYNE='"SHOW" TAKES NO ALPHANUMERIC INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(S2.EQ.1.AND.W2.LT.W1) THEN
      OUTLYNE='FOR "SHOW" WITH NO QUALIFIER WORD INPUT'
      CALL SHOWIT(1)
      OUTLYNE='NUMERIC WORD #2 MUST BE GREATER THAN OR EQUAL TO NUMERIC WORD #1'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!               WE ARE AT LENS INPUT OR LENS UPDATE LEVEL
   ...
   IF(SST.EQ.1.OR.SN.EQ.1)THEN
      OUTLYNE='"'//WC(1:6)//'" TAKES ONLY QUALIFIER INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   END IF
   IF(SQ.EQ.0) THEN
      OUTLYNE='"'//WC(1:6)//'" REQUIRES EXPLICIT QUALIFIER INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(WQ(1:1).EQ.' '.OR.WQ(2:2).EQ.' '.OR.WQ(3:3).EQ.' '.OR.WQ(4:4).EQ.' '.OR.WQ(5:5).EQ.' '.OR.WQ(6:6).EQ.' ') THEN
      OUTLYNE='NEW DIRECTORY NAME MUST BE EXACTLY 6 NON-BLANK CHARACTERS'
      CALL SHOWIT(1)
      OUTLYNE='IN LENGTH'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
   ...
   IF(WQ(7:7).NE.' '.OR.WQ(8:8).NE.' ') THEN
      OUTLYNE='NEW DIRECTORY NAME MAY BE ONLY 6 NON-BLANK CHARACTERS'
      CALL SHOWIT(1)
      OUTLYNE='IN LENGTH'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
...
!               WE ARE AT LENS INPUT OR LENS UPDATE LEVEL
   ...
   IF(SQ.EQ.1.OR.SN.EQ.1)THEN
      OUTLYNE='"LENSLOC" TAKES ONLY STRING INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   END IF
   IF(SST.EQ.0) THEN
      OUTLYNE='"LENSLOC" REQUIRES EXPLICIT STRING INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!               WE ARE AT LENS INPUT OR LENS UPDATE LEVEL
   ...
   IF(SQ.EQ.1.OR.SST.EQ.1.OR.SN.EQ.1)THEN
      OUTLYNE='"LENSDIR" TAKES NO ADDITIONAL INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
