...
SUBROUTINE SHOWREG
   ...
   IF(SST.EQ.1) THEN
      OUTLYNE=&
      &'"SHOW" TAKES NO ALPHANUMERIC INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(W1.LE.0.0D0.OR.INT(W1).GT.MAXREG) THEN
      ...
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'NUMERIC WORD #1 MUST LIE BETWEEN 1 AND ',MAXREG
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
   ...
   IF(S2.EQ.1.AND.W2.LE.0.0D0.OR.S2.EQ.1.AND.INT(W2).GT.MAXREG) THEN
      ...
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'NUMERIC WORD #2 MUST LIE BETWEEN 1 AND ',MAXREG
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!               WE ARE AT LENS INPUT OR LENS UPDATE LEVEL
   ...
   &.OR.WQ(4:4).EQ.' '.OR.WQ(5:5).EQ.' '.OR.WQ(6:6).EQ.' ') THEN
      OUTLYNE=&
...
!               WE ARE AT LENS INPUT OR LENS UPDATE LEVEL
   ...
   IF(SQ.EQ.1.OR.SN.EQ.1)THEN
      OUTLYNE=&
      &'"LENSLOC" TAKES ONLY STRING INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!               WE ARE AT LENS INPUT OR LENS UPDATE LEVEL
   ...
   IF(SQ.EQ.1.OR.SST.EQ.1.OR.SN.EQ.1)THEN
      OUTLYNE=&
      &'"LENSDIR" TAKES NO ADDITIONAL INPUT'
      CALL SHOWIT(1)
      OUTLYNE='RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(S3.EQ.1.OR.S4.EQ.1.OR.S5.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"DO" TAKES NO NUMERIC WORD #1, #2 AND #3 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
      CALL SHOWIT(1)
      CALL MACFAL
...
!
   IF(STI.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"PROMPT" IS USED TO SET THE PROMPT STRING FOR PROMPTED INPUT'
      CALL SHOWIT(1)
      IF(PMTVAL(1:10).EQ.'          ')&
      &WRITE(OUTLYNE,*) 'THE CURRENT PROMPT IS : (BLANK)'
      IF(PMTVAL(1:10).NE.'          ')&
      &WRITE(OUTLYNE,*) 'THE CURRENT PROMPT IS : ',PMTVAL
      CALL SHOWIT(1)
      RETURN
   END IF
   IF(SN.EQ.1.OR.SQ.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"PROMPT" TAKES NO QUALIFIER OR NUMERIC INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'RE-ENTER COMMAND'
      CALL SHOWIT(1)
   ...
   IF(SST.EQ.0) THEN
      WRITE(OUTLYNE,*)&
      &'"PROMPT" REQUIRES EXPLICIT STRING INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'RE-ENTER COMMAND'
      CALL SHOWIT(1)
...
!
   IF(STI.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"ASTO", "ARCL", "CLASTO" AND "AWRITE" MANIPULATE'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'ALPHA STORAGE REGISTERS'
      CALL SHOWIT(1)
      RETURN
   END IF
   IF(SN.EQ.1) THEN
      IF(WC.NE.'ARCL'.AND.WC.NE.'AWRITE') THEN
         WRITE(OUTLYNE,*)&
         &'"ASTO" AND "CLASTO" COMMANDS TAKE NO NUMERIC INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)&
         &'RE-ENTER COMMAND'
         CALL SHOWIT(1)
   ...
   &SST.EQ.0) THEN
      WRITE(OUTLYNE,*)&
      &'"ASTO" REQUIRES EXPLICIT QUALIFIER AND STRING INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'RE-ENTER COMMAND'
      CALL SHOWIT(1)
   ...
   IF(WC.EQ.'ARCL'.AND.S1.EQ.0) THEN
      WRITE(OUTLYNE,*)&
      &'"ARCL" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'RE-ENTER COMMAND'
      CALL SHOWIT(1)
   ...
   IF(WC.EQ.'AWRITE'.AND.S1.EQ.0) THEN
      WRITE(OUTLYNE,*)&
      &'"AWRITE" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'RE-ENTER COMMAND'
      CALL SHOWIT(1)
   ...
   IF(WC.EQ.'ARCL') THEN
      ...
      &.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"ARCL" ONLY TAKES NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)&
         &'RE-ENTER COMMAND'
         CALL SHOWIT(1)
      ...
      IF(INT(W1).LT.1.OR.INT(W1).GT.MAXREG) THEN
         WRITE(OUTLYNE,*)&
         &'"ARCL" STORAGE REGISTER NUMBER BEYOND LEGAL BOUNDS'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)&
         &'VALID INPUT IS 1 TO ',MAXREG
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)&
         &'RE-ENTER COMMAND'
         CALL SHOWIT(1)
   ...
   IF(WC.EQ.'AWRITE') THEN
      ...
      &.OR.S5.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"AWRITE" ONLY TAKES NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)&
         &'RE-ENTER COMMAND'
         CALL SHOWIT(1)
      ...
      IF(W1.LT.1.0D0.OR.INT(W1).GT.MAXREG) THEN
         WRITE(OUTLYNE,*)&
         &'"AWRITE" STORAGE REGISTER NUMBER BEYOND LEGAL BOUNDS'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)&
         &'VALID INPUT IS 1 TO ',MAXREG
         CALL SHOWIT(1)
   ...
   &SST.EQ.1) THEN
      WRITE(OUTLYNE,*)&
      &'"CLASTO" TAKES NO QUALIFIER OR STRING INPUT'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'RE-ENTER COMMAND'
      CALL SHOWIT(1)
   ...
   IF(WC.EQ.'AWRITE') THEN
      ...
      &WRITE(OUTLYNE,987) AGPREG(INT(W1))(1:80)
      IF(OUT.EQ.6.OR.OUT.EQ.7)&
      &WRITE(OUTLYNE,9871) AGPREG(INT(W1))(1:79)
      CALL SHOWIT(0)
987   FORMAT(A80)
9871  FORMAT(A79)
      RETURN
...
!       REGISTERS AGPREG(1) TO AGPREG(MACREG)
      ...
      END DO
      WRITE(OUTLYNE,*)&
      &'GENERAL PURPOSE CHARACTER REGISTERS HAVE BEEN CLEARED'
      CALL SHOWIT(1)
      WRITE(OUTLYNE,*)&
      &'RE-ENTER COMMAND'
      CALL SHOWIT(1)
...
!
   ...
   &.AND.WQ.NE.'LIC3'.AND.WQ.NE.'LIC4'.AND.WQ.NE.'CATNAME'&
   &.AND.WQ.NE.'GLANAME'.AND.WQ.NE.'SURFLBL') THEN
!
!       NO MATCH WAS FOUND.
...
!
   ...
   &,GETTER,GERROR1,GERROR2,OPDERROR
!
   REAL*8 DERVAL,VALL
!
...
!
   ...
   &INDEX,DISP,VNUM,V1,EDGTHK,PARTL,TEMPSUM,VALVAL,DWORD1,DWORD2 &
   &,VHI,VLO,NWN1,NWN2,NWN3,NWN4,JPX,JPY,JPCY,JPCX,JPUY,JPUX,JPUCY,&
   &JPUCX,V2,V9,JA,JB
!
   COMMON/GV/VALUE,NUM5
!
...
!       CHECK FOR GETABLE THINGS
!
   IF(WQ.NE.'CFG'.AND.WQ.NE.'UNITS'.AND.WQ.NE.'INSK'&
   &.AND.WQ.NE.'REFS'.AND.WQ.NE.'ASTOP'.AND.WQ.NE.'PIYP'&
   &.AND.WQ.NE.'PY'.AND.WQ.NE.'PCY'.AND.WQ.NE.'PUY'.AND.WQ.NE.&
   &'PIXP'.AND.WQ.NE.'PIY'.AND.WQ.NE.'PUCY'.AND.WQ.NE.'PICY'&
   &.AND.WQ.NE.'PX'.AND.WQ.NE.'PCX'.AND.WQ.NE.'PUX'.AND. &
   &WQ.NE.'PIX'.AND.WQ.NE.'PUCX'.AND.WQ.NE.'PICX'.AND. &
   &WQ.NE.'CV'.AND.WQ.NE.'CVTOR'.AND.WQ.NE.'TH'.AND.WQ.NE.&
   &'AD'.AND.WQ.NE.'AE'.AND.WQ.NE.'AF'.AND.WQ.NE.'AG'.AND.&
   &WQ.NE.'CC'.AND.WQ.NE.'ALPHA'.AND.WQ.NE.'BETA'.AND.WQ.NE.&
   &'GAMMA'.AND.WQ.NE.'TCODE'.AND.WQ.NE.'XD'.AND.WQ.NE.'YD'&
   &.AND.WQ.NE.'AC'.AND.WQ.NE.'PICYP'.AND.WQ.NE.'PICXP'.AND.WQ &
   &.NE.'INR'.AND.WQ.NE.'GPY'.AND.WQ.NE.'GPX'.AND.WQ.NE.'GPCX'&
   &.AND.WQ.NE.'GPCY'.AND.WQ.NE.'GPUX'.AND.WQ.NE.'GPUY'.AND.&
   &WQ.NE.'SHRTWAVE'.AND.WQ.NE.'GPUCX'.AND.WQ.NE.'GPUCY'.AND.WQ &
   &.NE.'ZD'.AND.WQ.NE.'PSFK'.AND.WQ.NE.'ISN'.AND.WQ.NE.'RLEN'.AND.&
   &WQ.NE.'OSN'.AND.WQ.NE.'SPTWT'.AND.WQ.NE.'GDX'.AND.WQ.NE.'ORLEN'&
   &.AND.WQ.NE.'GDY'.AND.WQ.NE.'GDZ'.AND.WQ.NE.'GALPHA'.AND.&
   &WQ.NE.'GBETA'.AND.WQ.NE.'GGAMMA'.AND.WQ.NE.'THM'.AND.&
   &WQ.NE.'PRICE'.AND.WQ.NE.'RAYCOD1'.AND.WQ.NE.'RAYCOD2') THEN
!
!       CONTINUE CHECKING
   ELSE
...
!
   ...
   &.AND.WQ.NE.'LXVERT'.AND.WQ.NE.'MXVERT'.AND.WQ.NE.'NXVERT'&
   &.AND.WQ.NE.'LYVERT'.AND.WQ.NE.'MYVERT'.AND.WQ.NE.'NYVERT'&
   &.AND.WQ.NE.'LZVERT'.AND.WQ.NE.'MZVERT'.AND.WQ.NE.'NZVERT'&
   &.AND.WQ.NE.'GLX'.AND.WQ.NE.'GLY'.AND.WQ.NE.'GLZ'&
   &.AND.WQ.NE.'GLL'.AND.WQ.NE.'GLM'.AND.WQ.NE.'GLN'&
   &.AND.WQ.NE.'GLLOLD'.AND.WQ.NE.'GLMOLD'.AND.WQ.NE.'FLDSX'.AND.&
   &WQ.NE.'GLNOLD'.AND.WQ.NE.'DYA'.AND.WQ.NE.'DXA'.AND.WQ.NE.&
   &'FLDSY'.AND.WQ.NE.'AH'.AND.WQ.NE.'AJ'.AND.WQ.NE.'AI'.AND.&
   &WQ.NE.'AK'.AND.WQ.NE.'AL'.AND.WQ.NE.'GLLN'.AND.WQ.NE.'GLMN'&
   &.AND.WQ.NE.'GLNN') THEN
!
!       CONTINUE CHECKING
   ELSE
...
!
   ...
   &WQ.NE.'NSSMEANR'.AND.WQ.NE.'NSSRMSX'.AND.&
   &WQ.NE.'NSSRMSY'.AND.WQ.NE.'NSSRMSR') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
...
!
   ...
   &'DY'.AND.WQ.NE.'X'.AND.WQ.NE.'DX'.AND.WQ.NE.'XANG'.AND. &
   &WQ.NE.'YANG'.AND.WQ.NE.'AII'.AND.WQ.NE.'Z'.AND.WQ.NE.&
   &'DCL'.AND.WQ.NE.'DCM'.AND.WQ.NE.'DCN'.AND.WQ.NE.'OPL'.AND.&
   &WQ.NE.'WV'.AND.WQ.NE.'PFAC'.AND.WQ.NE.'K'.AND.WQ.NE.'L'.AND.WQ &
   &.NE.'DINMUL'.AND.WQ.NE.'PXPX'.AND.WQ.NE.'PXPY'.AND.WQ.NE.'PYPX'&
   &.AND.WQ.NE.'PYPY'.AND.WQ.NE.'DXDX'.AND.WQ.NE.'DXDY'&
   &.AND.WQ.NE.'DYDX'.AND.WQ.NE.'DYDY'.AND.WQ.NE.'DYADY'.AND.WQ.NE.&
   &'DYADX'.AND.WQ.NE.'DXADX'.AND.WQ.NE.'DXADY'&
   &.AND.WQ.NE.'CTSX'.AND.WQ.NE.'CTSY'.AND.WQ.NE.'SCEX'.AND.&
   &WQ.NE.'SCEY'.AND.WQ.NE.'GRS'.AND.WQ.NE.'GRO'.AND.WQ.NE.'GRX'&
   &.AND.WQ.NE.'GRY'.AND.WQ.NE.'GRZ'.AND.WQ.NE.'RENERGY'&
   &.AND.WQ.NE.'MAXREG'.AND.WQ.NE.'MINREG'.AND.WQ.NE.'NUMHITS'&
   &.AND.WQ.NE.'RTOT'.AND.WQ.NE.'ITOT'.AND.WQ.NE.'M'.AND.WQ.NE.'ONTOL'&
   &.AND.WQ.NE.'SINGTOL'.AND.WQ.NE.'LINTOL') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
...
!
   ...
   &.NE.'LREF'.AND.WQ.NE.'MREF'.AND.WQ.NE.'NREF'.AND.WQ.NE.&
   &'LENREF'.AND.WQ.NE.'OPLREF'.AND.WQ.NE.'IREF'.AND.WQ.NE.&
   &'IPREF'.AND.WQ.NE.'LNREF'.AND.WQ.NE.'MNREF'.AND.WQ.NE.&
   &'NNREF'.AND.WQ.NE.'XAREF'.AND.WQ.NE.'YAREF'.AND.WQ.NE.&
   &'DIFTOL'.AND.WQ.NE.'LEN'.AND.WQ.NE.'AIP'.AND.WQ.NE.'LN'&
   &.AND.WQ.NE.'MN'.AND.WQ.NE.'NN'.AND.WQ.NE.'LOLD'.AND.&
   &WQ.NE.'MOLD'.AND.WQ.NE.'NOLD'.AND.WQ.NE.'LREFOL'.AND.WQ.NE.&
   &'MREFOL'.AND.WQ.NE.'NREFOL'.AND.WQ.NE.'COATING') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
   ...
   &'PYAPX'.AND.WQ.NE.'VNUM'.AND.WQ.NE.'MCODE'.AND.WQ.NE.'CLAP'.AND.&
   &WQ.NE.'CLAPY'.AND.WQ.NE.'CLAPX'.AND.WQ.NE.'COBS'.AND.WQ.NE.&
   &'COBSY'.AND.WQ.NE.'COBSX'.AND.WQ.NE.'PARTL'&
   &.AND.WQ.NE.'CENTX'.AND.WQ.NE.'CENTY'.AND.WQ.&
   &NE.'MODE'.AND.WQ.NE.'MATRIX'.AND.WQ.NE.'NVAR'.AND.WQ.NE.'KDWA'&
   &.AND.WQ.NE.'FOCRIT'.AND.WQ.NE.'VB'.AND.WQ.NE.'DERIV'.AND.WQ.NE.&
   &'VWFC'.AND.WQ.NE.'LCV'.AND.WQ.NE.'SPS'.AND.WQ.NE.'TV'&
   &.AND.WQ.NE.'SAG'.AND.WQ.NE.'RMSOPD'&
   &.AND.WQ.NE.'RMSX'.AND.WQ.NE.'RMSY'.AND.WQ.NE.'RMS'.AND.WQ.NE.&
   &'SPDTRANS'.AND.WQ.NE.'RSSX'.AND.WQ.NE.'RSSY'.AND.WQ.NE.'RSS'.AND.&
   &WQ.NE.'PTOVOPD'.AND.WQ.NE.'ABBE'.AND.WQ.NE.'INDEX'.AND.&
   &WQ.NE.'FCSFT'.AND.WQ.NE.'FCSFTX'.AND.WQ.NE.'FCSFTY'.AND.WQ.NE.&
   &'TRANS'.AND.WQ.NE.'N1'.AND.WQ.NE.'N2'.AND.WQ.NE.'N3'.AND.WQ.NE.&
   &'N4'.AND.WQ.NE.'N5'.AND.WQ.NE.'N6'.AND.WQ.NE.'N7'.AND.WQ.NE.'N8'&
   &.AND.WQ.NE.'N9'.AND.WQ.NE.'N10'.AND.WQ.NE.'DPART'.AND.WQ.NE.&
   &'RMSASPCT'.AND.WQ.NE.'PSFSUM'.AND.WQ.NE.'PSFFWHMX'.AND.WQ.NE.&
   &'PSFFWHMY') THEN
!
!       CONTINUE CHECKING
   ELSE
...
!       3,5 AND 7 ABERRATIONS
   ...
   &'XCMA3'.AND.WQ.NE.'DIS3'.AND.WQ.NE.'XDIS3'.AND.WQ.NE.'AST3'.AND.&
   &WQ.NE.'XAST3'.AND.WQ.NE.'PTZ3'.AND.WQ.NE.'XPTZ3'.AND.WQ.NE.&
   &'SA5'.AND.WQ.NE.'XSA5'.AND.WQ.NE.'CMA5'.AND.WQ.NE.'XCMA5'.AND.&
   &WQ.NE.'AST5'.AND.WQ.NE.'XAST5'.AND.WQ.NE.'DIS5'&
   &.AND.WQ.NE.'PTZCV'.AND.WQ.NE.'XPTZCV'&
   &.AND.WQ.NE.'XDIS5'.AND.WQ.NE.'PTZ5'.AND.WQ.NE.'XPTZ5'.AND.&
   &WQ.NE.'TOBSA'.AND.WQ.NE.'XTOBSA'.AND.WQ.NE.'SOBSA'.AND.&
   &WQ.NE.'XSOBSA'.AND.WQ.NE.'ELCMA'.AND.WQ.NE.'XELCMA'.AND.WQ &
   &.NE.'TAS'.AND.WQ.NE.'XTAS'.AND.WQ.NE.'SAS'.AND.WQ.NE.'XTAS'&
   &.AND.WQ.NE.'SA7'.AND.WQ.NE.'XSA7') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
...
!       3RD PUPIL ABERRATIONS
   ...
   &'XPCMA3'.AND.WQ.NE.'PDIS3'.AND.WQ.NE.'XPDIS3'.AND.&
   &WQ.NE.'PAST3'.AND.WQ.NE.'OPD'.AND.WQ.NE.'OPDW'&
   &.AND.WQ.NE.'XPAST3'.AND.WQ.NE.'PPTZ3'.AND.WQ.NE.'XPPTZ3'&
   &.AND.WQ.NE.'VIGY'.AND.WQ.NE.'VIGX'.AND.WQ.NE.'SAY'.AND.WQ &
   &.NE.'SAX'.AND.WQ.NE.'SCX'.AND.WQ.NE.'SCY'.AND.WQ.NE.'WRX'&
   &.AND.WQ.NE.'WRY'.AND.WQ.NE.'BDX'.AND.WQ.NE.'BDY'&
   &.AND.WQ.NE.'VIGSX'.AND.WQ.NE.'VIGSY'.AND.WQ.NE.'AUTOFUNC'.AND.&
   &WQ.NE.'PXIM'.AND.WQ.NE.'PYIM'.AND.WQ.NE.'RXIM'.AND.WQ.NE.&
   &'RYIM') THEN
!
!       CONTINUE CHECKING
   ELSE
...
!       3RD PUPIL ABERRATIONS (PRIMARY CHROMATIC DIFFERENCES)
   ...
   &.AND.WQ.NE.'XPCMA3P'.AND.WQ.NE.'PDIS3P'.AND.WQ.NE.'XPDIS3P'.AND.&
   &WQ.NE.'PAST3P'.AND.WQ.NE.'RSPHX'.AND.WQ.NE.'RSPHY'.AND.&
   &WQ.NE.'XPAST3P'.AND.WQ.NE.'PPTZ3P'.AND.WQ.NE.'XPPTZ3P'&
   &.AND.WQ.NE.'RSPHZ'.AND.WQ.NE.'SHORT'.AND.WQ.NE.&
   &'MEDIUM'.AND.WQ.NE.'LONG'.AND.WQ.NE.&
   &'BUYDELAY'.AND.WQ.NE.'SELDELAY') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
...
!       3RD PUPIL ABERRATIONS (SECONDARY CHROMATIC DIFFERENCES)
   ...
   &.AND.WQ.NE.'XPCMA3S'.AND.WQ.NE.'PDIS3S'.AND.WQ.NE.'XPDIS3S'.AND.&
   &WQ.NE.'PAST3S'.AND.&
   &WQ.NE.'GLASSWV1'.AND.&
   &WQ.NE.'GLASSWV2'.AND.WQ.NE.'GLASSWV3'.AND.WQ.NE.'GLASSWV4'&
   &.AND.WQ.NE.'GLASSWV5'.AND.&
   &WQ.NE.'XPAST3S'.AND.WQ.NE.'PPTZ3S'.AND.WQ.NE.'XPPTZ3S'&
   &.AND.WQ.NE.'PACM'.AND.WQ.NE.'PACZ'.AND.WQ.NE.'SACM'.AND.WQ.NE.&
   &'SACZ'.AND.WQ.NE.'PLCM'.AND.WQ.NE.'PLCZ'.AND.WQ.NE.'SLCM'.AND.&
   &WQ.NE.'SLCZ') THEN
!
!       CONTINUE CHECKING
   ELSE
...
!       INTRINSIC ABERRATIONS
   ...
   &WQ.NE.'AST5I'.AND.WQ.NE.'XAST5I'.AND.WQ.NE.'DIS5I'&
   &.AND.WQ.NE.'XDIS5I'.AND.WQ.NE.'PTZ5I'.AND.WQ.NE.'XPTZ5I'.AND.&
   &WQ.NE.'TOBSAI'.AND.WQ.NE.'XTOBSAI'.AND.WQ.NE.'SOBSAI'.AND.&
   &WQ.NE.'XSOBSAI'.AND.WQ.NE.'ELCMAI'.AND.WQ.NE.'XELCMAI'.AND.WQ.&
   &NE.'TASI'.AND.WQ.NE.'XTASI'.AND.WQ.NE.'SASI'.AND.WQ.NE.'XTASI'&
   &.AND.WQ.NE.'SA7I'.AND.WQ.NE.'XSA7I'.AND.WQ.NE.'XCMA5I') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
...
!       3,5 AND 7 PRIMARTY CHROMATIC DIFFERENCES (YZ)
   ...
   &'DIS3P'.AND.WQ.NE.'AST3P'.AND.&
   &WQ.NE.'PTZ3P'.AND.WQ.NE.&
   &'SA5P'.AND.WQ.NE.'CMA5P'.AND.&
   &WQ.NE.'AST5P'.AND.WQ.NE.'DIS5P'&
   &.AND.WQ.NE.'PTZ5P'.AND.&
   &WQ.NE.'TOBSAP'.AND.WQ.NE.'SOBSAP'.AND.&
   &WQ.NE.'ELCMAP'.AND.WQ.&
   &NE.'TASP'.AND.WQ.NE.'SASP'.AND.&
   &WQ.NE.'SA7P') THEN
!
!       CONTINUE CHECKING
   ELSE
...
!       REMAINER OF THINGS
   ...
   &WQ.NE.'LENGTH'.AND.WQ.NE.'MLENGTH'.AND.WQ.NE.'MAGYOR'.AND.&
   &WQ.NE.'FFLY'.AND.WQ.NE.'FFLX'.AND.WQ.NE.'PUPDISX'.AND.WQ.NE.&
   &'IMDISX'.AND.WQ.NE.'BFLX'.AND.WQ.NE.'BFLY'&
   &.AND.WQ.NE.'FLCLTH'.AND.WQ.NE.'PUPDIAX'.AND.WQ.NE.'MAGX'&
   &.AND.WQ.NE.'CHFIMX'.AND.WQ.NE.'DR'.AND.WQ.NE.'DRA'.AND.&
   &WQ.NE.'MAGY'.AND.WQ.NE.'EFLX'.AND.WQ.NE.'EFLY'.AND.WQ.NE.&
   &'FFNX'.AND.WQ.NE.'FFNY'.AND.WQ.NE.'BFNX'.AND.WQ.NE.'BFNY'&
   &.AND.WQ.NE.'ENPOSX'.AND.WQ.NE.'ENPOSY'.AND.WQ.NE.'ENPOSZ'.AND.&
   &WQ.NE.'EXPOSX'.AND.WQ.NE.'EXPOSY'.AND.WQ.NE.'EXPOSZ'.AND.WQ.NE.&
   &'PUPDISY'.AND.WQ.NE.'PUPDIAY'.AND.WQ.NE.'IMDISY'.AND.WQ.NE.&
   &'CHFIMY'.AND.WQ.NE.'OAL'.AND.WQ.NE.'OPTLEN'.AND.WQ.NE.'WEIGHT'&
   &) THEN
!
!       CONTINUE CHECKING
   ELSE
...
!       3,5 AND 7 SECONDARY CHROMATIC DIFFERENCES  (YZ)
   ...
   &'DIS3S'.AND.WQ.NE.'AST3S'.AND.WQ.NE.'FLCLTHY'.AND.&
   &WQ.NE.'PTZ3S'.AND.WQ.NE.'FLCLTHX'.AND.WQ.NE.&
   &'SA5S'.AND.WQ.NE.'CMA5S'.AND.&
   &WQ.NE.'AST5S'.AND.WQ.NE.'DIS5S'&
   &.AND.WQ.NE.'PTZ5S'.AND.&
   &WQ.NE.'TOBSAS'.AND.WQ.NE.'SOBSAS'.AND.&
   &WQ.NE.'ELCMAP'.AND.WQ.&
   &NE.'TASS'.AND.WQ.NE.'SASS'.AND.&
   &WQ.NE.'SA7S') THEN
!
!       CONTINUE CHECKING
   ELSE
...
!       3,5 AND 7 PRIMARTY CHROMATIC DIFFERENCES (XZ)
   ...
   &'XDIS3P'.AND.WQ.NE.'XAST3P'.AND.&
   &WQ.NE.'XPTZ3P'.AND.WQ.NE.&
   &'XSA5P'.AND.WQ.NE.'XCMA5P'.AND.&
   &WQ.NE.'XAST5P'.AND.WQ.NE.'XDIS5P'&
   &.AND.WQ.NE.'XPTZ5P'.AND.&
   &WQ.NE.'XTOBSAP'.AND.WQ.NE.'XSOBSAP'.AND.&
   &WQ.NE.'XELCMAP'.AND.WQ.&
   &NE.'XTASP'.AND.WQ.NE.'XSASP'.AND.&
   &WQ.NE.'XSA7P') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
   ...
   &.AND.WQ.NE.'YFOC'.AND.WQ.NE.'AST') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
...
!       CHROMATIC ABERRATIONS
   ...
   &'SACY'.AND.WQ.NE.'SACX'.AND.WQ.NE.'CAIMTOL'&
   &.AND.WQ.NE.'SURTOL'.AND.WQ.NE.'PLCY'.AND.WQ.NE.'MRAYS'.AND.WQ.NE.&
   &'PLCX'.AND.WQ.NE.'SLCY'.AND.WQ.NE.'AIMTOL'.AND.WQ.NE.'NRAITR'&
   &.AND.WQ.NE.'DELSUR'.AND.WQ.NE.'SLCX'.AND.WQ.NE.'FNUMX'.AND.&
   &WQ.NE.'FNUMY'.AND.WQ.NE.'OBFNUMX'.AND.WQ.NE.'OBFNUMY'.AND.&
   &WQ.NE.'EXPDIAX'.AND.WQ.NE.'EXPDIAY'.AND.WQ.NE.'ENPDIAX'&
   &.AND.WQ.NE.'ENPDIAY'.AND.WQ.NE.'SERINC'.AND.WQ.NE.'SERLIM') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
...
!       3,5 AND 7 SECONDARY CHROMATIC DIFFERENCES  (XZ)
   ...
   &'XDIS3S'.AND.WQ.NE.'XAST3S'.AND.&
   &WQ.NE.'XPTZ3S'.AND.WQ.NE.'ZERN37'.AND.WQ.NE.&
   &'XSA5S'.AND.WQ.NE.'XCMA5S'.AND.&
   &WQ.NE.'XAST5S'.AND.WQ.NE.'XDIS5S'&
   &.AND.WQ.NE.'XPTZ5S'.AND.&
   &WQ.NE.'XTOBSAS'.AND.WQ.NE.'XSOBSAS'.AND.&
   &WQ.NE.'XELCMAP'.AND.WQ.NE.'OPWT'.AND.WQ.NE.'VARWT'.AND.WQ.&
   &NE.'XTASS'.AND.WQ.NE.'XSASS'.AND.WQ.NE.'VARDNC'.AND.WQ.NE.&
   &'OPTYPE'.AND.&
   &WQ.NE.'XSA7S') THEN
!
!       CONTINUE CHECKING
...
!       COBS AND CLAP DATA CONT'D AND GAUSSIAN BEAM PROP STUFF
   ...
   &WQ.NE.'COBSX'.AND.WQ.NE.'COBSXE'.AND.WQ.NE.'CLAPE'.AND.&
   &WQ.NE.'CLAPY'.AND.WQ.NE.'CLAPYE'.AND.WQ.NE.'CLAPX'.AND.&
   &WQ.NE.'CLAPXE'.AND.WQ.NE.'GBRADX'.AND.WQ.NE.'GBRADY'.AND.&
   &WQ.NE.'GBDISX'.AND.WQ.NE.'GBDISY'.AND.WQ.NE.'GBRCVX'.AND.&
   &WQ.NE.'GBRCVY'.AND.WQ.NE.'GBWAISTX'.AND.WQ.NE.'GBWAISTY') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
...
!       SPECIAL SURFACE COEFFICIENTS C1 TO C96
   ...
   &'SCALEY'.AND.WQ.NE.&
   &'CCTOR'.AND.WQ.NE.'ADTOR'.AND.WQ.NE.'AETOR'.AND.&
   &WQ.NE.'AFTOR'.AND.WQ.NE.'SHAPEFAC'.AND.WQ.NE.&
   &'AGTOR'.AND.WQ.NE.'CW'.AND.WQ.NE.'CLDECY'.AND.WQ.NE.'CLDECX'&
   &.AND.WQ.NE.'CODECX'.AND.WQ.NE.'CODECY'.AND.WQ.NE.'CLTILT'.AND.&
   &WQ.NE.'COTILT'.AND.WQ.NE.'CLRAD'.AND.WQ.NE.'XPEN'&
   &.AND.WQ.NE.'YPEN'.AND.WQ.NE.'SCALX'.AND.WQ.NE.'SCALY'.AND.WQ.NE.&
   &'CORAD'.AND.WQ.NE.'ET'.AND.WQ.NE.'ETY'.AND.WQ.NE.'ETX'.AND.&
   &WQ.NE.'XPENOL'.AND.WQ.NE.&
   &'YPENOL'.AND.WQ.NE.'PENSTA') THEN
!
!       NO MATCH WAS FOUND.
...
!
      IF(WQ.EQ.'RSPHX'.OR.WQ.EQ.'RSPHY'.OR.WQ.EQ.'RSPHZ') THEN
         IF(.NOT.CPFNEXT) THEN
            OUTLYNE=&
            &'NO CAPFN EXISTS, "'//WQ(1:5)//'" IS NOT CURRENTLY GETABLE'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            CALL MACFAL
...
!
      ...
      &.OR.WQ.EQ.'PLCM'.OR.WQ.EQ.'PLCZ'.OR.WQ.EQ.'SLCM'.OR.WQ.EQ.'SLCZ')&
      &THEN
         VALUE=0.0D0
         ERRR=.FALSE.
         ...
         IF(ERRR) THEN
            WRITE(OUTLYNE,*)&
            &'SOME RAYS COULD NOT BE TRACED'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)&
            &'"',WQ(1:4),'" IS NOT GETABLE'
            CALL SHOWIT(1)
            ERRR=.FALSE.
            CALL MACFAL
            RETURN
      ...
      IF(WQ.EQ.'CENTX') THEN
         IF(.NOT.SPDEXT) THEN
            WRITE(OUTLYNE,*)&
            &'NO SPOT DIAGRAM EXISTS, "CENTX" IS NOT CURRENTLY GETABLE'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            CALL MACFAL
      ...
      IF(WQ.EQ.'CENTY') THEN
         IF(.NOT.SPDEXT) THEN
            WRITE(OUTLYNE,*)&
            &'NO SPOT DIAGRAM EXISTS, "CENTY" IS NOT CURRENTLY GETABLE'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
            CALL SHOWIT(1)
            CALL MACFAL
      ...
      &'RSS'.OR.WQ.EQ.'RSSX'.OR.WQ.EQ.'RSSY'.OR.WQ.EQ.'FCSFT'.OR.&
      &WQ.EQ.'FCSFTX'.OR.WQ.EQ.'FCSFTY'.OR.WQ.EQ.'RMSASPCT') THEN
         IF(WQ.EQ.'FCSFT'.OR.WQ.EQ.'FCSFTX'.OR.WQ.EQ.'FCSFTY') THEN
            IF(.NOT.SPDEXT) THEN
               WRITE(OUTLYNE,*)&
               &'NO SPOT DIAGRAM EXISTS, ITEM IS NOT CURRENTLY GETABLE'
               CALL SHOWIT(1)
               WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
               CALL SHOWIT(1)
               CALL MACFAL
...
!
            IF(.NOT.STATSP) THEN
               WRITE(OUTLYNE,*)&
               &'NO FULL STATS EXIST, "',WQ(1:6),'" IS NOT CURRENTLY GETABLE'
               CALL SHOWIT(1)
               WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
               CALL SHOWIT(1)
               CALL MACFAL
            ...
            IF(SYSTEM(30).GE.3.0D0) THEN
               WRITE(OUTLYNE,*)&
               &WQ(1:6),'" IS NOT DEFINED IN MODES AFOCAL AND UAFOCAL'
               CALL SHOWIT(1)
               WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
               CALL SHOWIT(1)
               CALL MACFAL
...
!
   ...
   &WQ.EQ.'AD'.OR.WQ.EQ.'AE'.OR.WQ.EQ.'AF'.OR.WQ.EQ.'SHAPEFAC'.OR.&
   &WQ.EQ.'AG'.OR.WQ.EQ.'CC'.OR.WQ.EQ.'ALPHA'.OR.WQ.EQ.'AH'.OR.WQ &
   &.EQ.'BETA'.OR.WQ.EQ.'GAMMA'.OR.WQ.EQ.'TCODE'.OR.WQ.EQ.'AI'.OR.&
   &WQ.EQ.'CCTOR'.OR.WQ.EQ.'ADTOR'.OR.WQ.EQ.'AETOR'.OR.WQ.EQ.'AJ'.OR.&
   &WQ.EQ.'GBDISX'.OR.WQ.EQ.'GBDISY'.OR.WQ.EQ.'GBWAISTX'.OR.WQ.EQ.&
   &'GBWAISTY'.OR.WQ.EQ.'ZD'.OR.WQ.EQ.'PTOVOPD'.OR.WQ &
   &.EQ.'AFTOR'.OR.WQ.EQ.'AGTOR'.OR.WQ.EQ.'XD'.OR.WQ.EQ.'AK'.OR.WQ.EQ.&
   &'YD'.OR.WQ.EQ.'RD'.OR.WQ.EQ.'RDTOR'.OR.WQ.EQ.'X'.OR.WQ.EQ.'AL'&
   &.OR.WQ.EQ.'Y'.OR.WQ.EQ.'Z'.OR.WQ.EQ.'DX'.OR.WQ.EQ.'RENERGY'.OR.WQ &
   &.EQ.'DY'.OR.WQ.EQ.'XANG'.OR.WQ.EQ.'YANG'.OR.WQ.EQ.'AII'.OR.WQ.EQ.&
   &'NUMHITS'.OR.WQ.EQ.'K'.OR.WQ.EQ.'M'.OR.WQ.EQ.'L'&
   &.OR.WQ.EQ.'DCL'.OR.WQ.EQ.'DCM'.OR.WQ.EQ.'DCN'.OR.WQ.EQ.'AC'.OR.&
   &WQ.EQ.'RMSOPD'.OR.WQ.EQ.'SPTWT'.OR.WQ.EQ.'GDX'.OR.WQ.EQ.'GDY'&
   &.OR.WQ.EQ.'GDZ'.OR.WQ.EQ.'GALPHA'.OR.WQ.EQ.'GBETA'.OR.WQ.EQ.&
   &'GGAMMA'.OR.WQ.EQ.'GRS'.OR.WQ.EQ.'GRO'.OR.WQ.EQ.'GRX'.OR.WQ &
   &.EQ.'GRY'.OR.WQ.EQ.'GRZ'.AND.WQ.EQ.'THM'.AND.WQ.EQ.'PRICE') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
   ...
   &WQ.EQ.'XCMA3'.OR.WQ.EQ.'AST3'.OR.WQ.EQ.'XAST3'.OR.WQ &
   &.EQ.'DIS3'.OR.WQ.EQ.'XDIS3'.OR.WQ.EQ.'PTZ3'.OR.WQ &
   &.EQ.'XPTZ3'.OR.WQ.EQ.'SA5'.OR.WQ.EQ.'XSA5'.OR.&
   &WQ.EQ.'CMA5'.OR.WQ.EQ.'XCMA5'.OR.WQ.EQ.'AST5'.OR.WQ &
   &.EQ.'XAST5'.OR.WQ.EQ.'DIS5'.OR.WQ.EQ.'XDIS5'.OR.WQ.EQ.&
   &'PTZ5'.OR.WQ.EQ.'XPTZ5'.OR.WQ.EQ.'TOBSA'.OR.WQ.EQ.'XTOBSA'&
   &.OR.WQ.EQ.'SOBSA'.OR.WQ.EQ.'XSOBSA'.OR.WQ.EQ.'ELCMA'.OR.WQ.EQ.&
   &'XELCMA'.OR.WQ.EQ.'TAS'.OR.WQ.EQ.'XTAS'.OR.WQ.EQ.'SAS'&
   &.OR.WQ.EQ.'XSAS'.OR.WQ.EQ.'SA7'.OR.WQ.EQ.'XSA7'&
   &.OR.WQ.EQ.'PTZCV'.OR.WQ.EQ.'MINREG'.OR.WQ.EQ.'MAXREG'.OR.WQ.EQ.&
   &'XPTZCV'.OR.WQ.EQ.'COATING') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
         CALL SHOWIT(1)
...
!
   ...
   &WQ.EQ.'XCMA3P'.OR.WQ.EQ.'AST3P'.OR.WQ.EQ.'XAST3P'.OR.WQ &
   &.EQ.'DIS3P'.OR.WQ.EQ.'XDIS3P'.OR.WQ.EQ.'PTZ3P'.OR.WQ &
   &.EQ.'XPTZ3P'.OR.WQ.EQ.'SA5P'.OR.WQ.EQ.'XSA5P'.OR.&
   &WQ.EQ.'CMA3P'.OR.WQ.EQ.'XCMA3P'.OR.WQ.EQ.'AST5P'.OR.WQ &
   &.EQ.'XAST5P'.OR.WQ.EQ.'DIS5P'.OR.WQ.EQ.'XDIS5P'.OR.WQ.EQ.&
   &'PTZ5P'.OR.WQ.EQ.'XPTZ5P'.OR.WQ.EQ.'TOBSAP'.OR.WQ.EQ.'XTOBSAP'&
   &.OR.WQ.EQ.'SOBSAP'.OR.WQ.EQ.'XSOBSAP'.OR.WQ.EQ.'ELCMAP'.OR.WQ &
   &.EQ.'XELCMAP'.OR.WQ.EQ.'TASP'.OR.WQ.EQ.'XTASP'.OR.WQ.EQ.'SASP'&
   &.OR.WQ.EQ.'XSASP'.OR.WQ.EQ.'SA7P'.OR.WQ.EQ.'XSA7P') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
         CALL SHOWIT(1)
   ...
   &WQ.EQ.'XCMA3S'.OR.WQ.EQ.'AST3S'.OR.WQ.EQ.'XAST3S'.OR.WQ &
   &.EQ.'DIS3S'.OR.WQ.EQ.'XDIS3S'.OR.WQ.EQ.'PTZ3S'.OR.WQ &
   &.EQ.'XPTZ3S'.OR.WQ.EQ.'SA5S'.OR.WQ.EQ.'XSA5S'.OR.&
   &WQ.EQ.'CMA3S'.OR.WQ.EQ.'XCMA3S'.OR.WQ.EQ.'AST5S'.OR.WQ &
   &.EQ.'XAST5S'.OR.WQ.EQ.'DIS5S'.OR.WQ.EQ.'XDIS5S'.OR.WQ.EQ.&
   &'PTZ5S'.OR.WQ.EQ.'XPTZ5S'.OR.WQ.EQ.'TOBSAS'.OR.WQ.EQ.'XTOBSAS'&
   &.OR.WQ.EQ.'SOBSAS'.OR.WQ.EQ.'XSOBSAS'.OR.WQ.EQ.'ELCMAS'.OR.WQ &
   &.EQ.'XELCMAS'.OR.WQ.EQ.'TASS'.OR.WQ.EQ.'XTASS'.OR.WQ.EQ.'SASS'&
   &.OR.WQ.EQ.'XSASS'.OR.WQ.EQ.'SA7S'.OR.WQ.EQ.'XSA7S')THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
         CALL SHOWIT(1)
   ...
   &WQ.EQ.'CMA5I'.OR.WQ.EQ.'XCMA5I'.OR.WQ.EQ.'AST5I'.OR.WQ &
   &.EQ.'XAST5I'.OR.WQ.EQ.'DIS5I'.OR.WQ.EQ.'XDIS5I'.OR.WQ.EQ.&
   &'PTZ5I'.OR.WQ.EQ.'XPTZ5I'.OR.WQ.EQ.'TOBSAI'.OR.WQ.EQ.'XTOBSAI'&
   &.OR.WQ.EQ.'SOBSAI'.OR.WQ.EQ.'XSOBSAI'.OR.WQ.EQ.'ELCMAI'.OR.WQ &
   &.EQ.'XELCMAI'.OR.WQ.EQ.'TASI'.OR.WQ.EQ.'XTASI'.OR.WQ.EQ.'SASI'&
   &.OR.WQ.EQ.'XSASI'.OR.WQ.EQ.'SA7I'.OR.WQ.EQ.'XSA7I'&
   &.OR.WQ.EQ.'CHFIMX'.OR.WQ.EQ.'PUPDIAX'.OR.WQ.EQ.'PUPDISX'&
   &.OR.WQ.EQ.'IMDISX'.OR.WQ.EQ.'PUPDIAY'.OR.WQ.EQ.'PUPDISY'.OR.WQ &
   &.EQ.'IMDISY'.OR.WQ.EQ.'CHFIMY') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
         CALL SHOWIT(1)
   ...
   &WQ.EQ.'XPCMA3'.OR.WQ.EQ.'PAST3'.OR.WQ.EQ.'XPAST3'.OR.WQ &
   &.EQ.'PDIS3'.OR.WQ.EQ.'XPDIS3'.OR.WQ.EQ.'PPTZ3'.OR.WQ &
   &.EQ.'XPPTZ3'.OR.WQ.EQ.'DR'.OR.WQ.EQ.'DRA'&
   &.OR.WQ.EQ.'ZERN37'.OR.WQ.EQ.'OPWT'&
   &.OR.WQ.EQ.'OPTYPE'.OR.WQ.EQ.'VARDNC'.OR.WQ.EQ.'VARWT') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
         CALL SHOWIT(1)
   ...
   &WQ.EQ.'XPCMA3P'.OR.WQ.EQ.'PAST3P'.OR.WQ.EQ.'XPAST3P'.OR.WQ &
   &.EQ.'PDIS3P'.OR.WQ.EQ.'XPDIS3P'.OR.WQ.EQ.'PPTZ3P'.OR.WQ &
   &.EQ.'XPPTZ3P') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
   ...
   &WQ.EQ.'PLCX'.OR.WQ.EQ.'SACY'.OR.WQ.EQ.'SACX'.OR.WQ &
   &.EQ.'SLCY'.OR.WQ.EQ.'SLCX'.OR.WQ.EQ.'ET'.OR.WQ.EQ.'ETY'.OR.&
   &WQ.EQ.'ETX') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
   ...
   &WQ.EQ.'XPCMA3S'.OR.WQ.EQ.'PAST3S'.OR.WQ.EQ.'XPAST3S'.OR.WQ &
   &.EQ.'PDIS3S'.OR.WQ.EQ.'XPDIS3S'.OR.WQ.EQ.'PPTZ3S'.OR.WQ &
   &.EQ.'XPPTZ3S') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
...
!
   ...
   &.OR.WQ.EQ.'GLL'.OR.WQ.EQ.'GLM'.OR.WQ.EQ.'GLN'&
   &.OR.WQ.EQ.'GLLOLD'.OR.WQ.EQ.'GLMOLD'.OR.WQ.EQ.'GLNOLD'&
   &.OR.WQ.EQ.'GLLN'.OR.WQ.EQ.'GLMN'.OR.WQ.EQ.'GLNN')THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
         CALL SHOWIT(1)
   ...
   &'OPL'.OR.WQ.EQ.'WV'.OR.WQ.EQ.'PXPX'.OR.WQ.EQ.'PXPY'&
   &.OR.WQ.EQ.'PXPY'.OR.WQ.EQ.'PYPY'.OR.WQ.EQ.'PYPX'&
   &.OR.WQ.EQ.'DXDX'.OR.WQ.EQ.'DXDY'.OR.WQ.EQ.'DYDY'.OR.&
   &WQ.EQ.'DYDX'.OR.WQ.EQ.'PXAPX'.OR.WQ.EQ.'PXAPY'.OR.&
   &WQ.EQ.'PYAPY'.OR.WQ.EQ.'PYAPX'.OR.WQ.EQ.'DXADX'.OR.&
   &WQ.EQ.'DXADY'.OR.WQ.EQ.'DYADY'.OR.WQ.EQ.'DYADX'.OR.&
   &WQ.EQ.'VNUM'.OR.WQ.EQ.'MCODE'.OR.WQ.EQ.'CLAP'.OR.WQ.EQ.&
   &'CLAPY'.OR.WQ.EQ.'CLAPX'.OR.WQ.EQ.'COBS'.OR.WQ.EQ.'COBSY'&
   &.OR.WQ.EQ.'COBSX'.OR.WQ.EQ.'PARTL'.OR.WQ.EQ.'ABBE'.OR.&
   &WQ.EQ.'N1'.OR.WQ.EQ.'N2'.OR.WQ.EQ.'N3'.OR.WQ.EQ.'N4'.OR.&
   &WQ.EQ.'N5'.OR.WQ.EQ.'N6'.OR.WQ.EQ.'N7'.OR.WQ.EQ.'N8'.OR.&
   &WQ.EQ.'N9'.OR.WQ.EQ.'N10'.OR.WQ.EQ.'DPART') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
         CALL SHOWIT(1)
   ...
   &'TV'.OR.WQ.EQ.'OPRD'.OR.WQ.EQ.'WT'.OR.WQ.EQ.'GBDISY'.OR.&
   &WQ.EQ.'CLDECX'.OR.WQ.EQ.'CLDECY'.OR.WQ.EQ.'GBWAISTX'.OR.&
   &WQ.EQ.'CODECX'.OR.WQ.EQ.'CODECY'.OR.WQ.EQ.'CLTILT'.OR.WQ &
   &.EQ.'COTILT'.OR.WQ.EQ.'LOLD'.OR.WQ.EQ.'MOLD'.OR.&
   &WQ.EQ.'XREF'.OR.WQ.EQ.'YREF'.OR.WQ.EQ.'ZREF'.OR.WQ &
   &.EQ.'LREF'.OR.WQ.EQ.'MREF'.OR.WQ.EQ.'NREF'.OR.WQ.EQ.&
   &'LENREF'.OR.WQ.EQ.'OPLREF'.OR.WQ.EQ.'IREF'.OR.WQ.EQ.&
   &'GBWAISTY'.OR.WQ.EQ.'FLDSX'.OR.WQ.EQ.'FLDSY'.OR.&
   &WQ.EQ.'IPREF'.OR.WQ.EQ.'LNREF'.OR.WQ.EQ.'MNREF')THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
         CALL SHOWIT(1)
   ...
   &WQ.EQ.'AII'.OR.WQ.EQ.'LEN'.OR.WQ.EQ.'DXA'.OR.WQ.EQ.'DYA'&
   &.OR.WQ.EQ.'AIP'.OR.WQ.EQ.'LN'.OR.WQ.EQ.'MN'.OR.WQ.EQ.&
   &'NN'.OR.WQ.EQ.'CLRAD'.OR.WQ.EQ.&
   &'CORAD'.OR.&
   &WQ.EQ.'NOLD'.OR.WQ.EQ.'SCEX'.OR.WQ.EQ.'SCEY') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1 AND #5 INPUT'
         CALL SHOWIT(1)
...
!
   IF(WQ.EQ.'SCEX'.OR.WQ.EQ.'SCEY') THEN
      IF(DF2.EQ.0.OR.DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY USES NUMERIC WORDS #1 AND #5'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!       ON 1/10/94 THE CODE TO GET C1 TO C96 WAS ADDED
   ...
   IF(WQ.EQ.'FLDSX') THEN
      ...
      &DF1.EQ.0.AND.INT(W1).GT.CFLDCNT) THEN
         WRITE(OUTLYNE,*)&
         &'INVALID FIELD OF VIEW POSITION NUMBER ENTERED WITH "FLDSX"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
   ...
   IF(WQ.EQ.'FLDSY') THEN
      ...
      &DF1.EQ.0.AND.INT(W1).GT.CFLDCNT) THEN
         WRITE(OUTLYNE,*)&
         &'INVALID FIELD OF VIEW POSITION NUMBER ENTERED WITH "FLDSY"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
   ...
   IF(WQ.EQ.'SPTWT') THEN
      IF(DF1.EQ.0.AND.W1.LT.1.0D0.OR.DF1.EQ.0.AND.W1.GT.10.0D0) THEN
         WRITE(OUTLYNE,*)&
         &'INVALID WAVELENGTH NUMBER ENTERED WITH "SPTWT"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'WAVELENGTH NUMBER (1 TO 10) REQUIRED WITH " GET SPTWT"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
   ...
   IF(WQ.EQ.'RMSOPD') THEN
      IF(.NOT.CPFNEXT) THEN
         WRITE(OUTLYNE,*)&
         &'NO CAPFN EXISTS, "RMSOPD" IS NOT CURRENTLY GETABLE'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(DF1.EQ.0.AND.W1.LT.1.0D0.OR.DF1.EQ.0.AND.W1.GT.10.0D0) THEN
         WRITE(OUTLYNE,*)&
         &'INVALID WAVELENGTH NUMBER ENTERED WITH "RMSOPD"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
   ...
   IF(WQ.EQ.'PTOVOPD') THEN
      IF(.NOT.CPFNEXT) THEN
         WRITE(OUTLYNE,*)&
         &'NO CAPFN EXISTS, "PTOVOPD" IS NOT CURRENTLY GETABLE'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(DF1.EQ.0.AND.W1.LT.1.0D0.OR.DF1.EQ.0.AND.W1.GT.10.0D0) THEN
         WRITE(OUTLYNE,*)&
         &'INVALID WAVELENGTH NUMBER ENTERED WITH "PTOVOPD"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
   ...
   IF(WQ.EQ.'OPWT'.OR.WQ.EQ.'WT') THEN
      ...
      IF(OPCNT.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'THERE ARE CURRENTLY NO OPERANDS'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'NO ACTION TAKEN'
         CALL SHOWIT(1)
         RETURN
      ...
      IF(INT(W1).LT.0.OR.INT(W1).GT.OPCNT) THEN
         WRITE(OUTLYNE,*)&
         &'"OPERAND NUMBER DESIGNATOR BEYOND CURRENT BOUNDARY'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETURN
   ...
   IF(WQ.EQ.'VB') THEN
      ...
      IF(INT(W1).LT.0.OR.INT(W1).GT.VBCNT) THEN
         WRITE(OUTLYNE,*)&
         &'"VARIABLE NUMBER DESIGNATOR BEYOND CURRENT BOUNDARY'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETURN
   ...
   IF(WQ.EQ.'VBT') THEN
      ...
      IF(TVBCNT.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'THERE ARE CURRENTLY NO TOLERANCE VARIABLES'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'NO ACTION TAKEN'
         CALL SHOWIT(1)
         RETURN
      ...
      IF(INT(W1).LT.0.OR.INT(W1).GT.TVBCNT) THEN
         WRITE(OUTLYNE,*)&
         &'"TOL VARIABLE NUMBER DESIGNATOR BEYOND CURRENT BOUNDARY'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         RETURN
   ...
   &WQ.EQ.'LREF'.OR.WQ.EQ.'MREF'.OR.WQ.EQ.'NREF'.OR.WQ.EQ.&
   &'LENREF'.OR.WQ.EQ.'OPLREF'.OR.WQ.EQ.'IREF'.OR.WQ.EQ.'IPREF'&
   &.OR.WQ.EQ.'LNREF'.OR.WQ.EQ.'MNREF'.OR.WQ.EQ.'NNREF'.OR.WQ &
   &.EQ.'XAREF'.OR.WQ.EQ.'YAREF') THEN
!       CHECK IF REFERENCE RAY DATA EXISTS
      IF(.NOT.REFEXT) THEN
         WRITE(OUTLYNE,*)'NO REFERENCE RAY DATA EXISTS.'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)&
         &WQ,' AT SURFACE ',INT(W1),' IS NOT GET-ABLE'
         CALL SHOWIT(1)
         CALL MACFAL
         RETURN
      END IF
   ...
   &WQ.EQ.'DCL'.OR.WQ.EQ.'DCM'.OR.WQ.EQ.'DCN'.OR.WQ.EQ.&
   &'LEN'.OR.WQ.EQ.'OPL'.OR.WQ.EQ.'AII'.OR.WQ.EQ.'AIP'&
   &.OR.WQ.EQ.'LN'.OR.WQ.EQ.'MN'.OR.WQ.EQ.'NN'.OR.WQ &
   &.EQ.'XANG'.OR.WQ.EQ.'YANG'.OR.WQ.EQ.'DX'.OR.WQ.EQ.'NUMHITS'&
   &.OR.WQ.EQ.'DY'.OR.WQ.EQ.'DXA'.OR.WQ.EQ.'DYA'.OR.WQ.EQ.&
   &'DYDY'.OR.WQ.EQ.'DYDX'.OR.WQ.EQ.'DXDY'.OR.WQ.EQ.'DXDX'&
   &.OR.WQ.EQ.'DYADY'.OR.WQ.EQ.'DYADX'.OR.WQ.EQ.'DXADY'.OR.&
   &WQ.EQ.'DXADX'.OR.WQ.EQ.'LOLD'.OR.WQ.EQ.'MOLD'.OR.WQ.EQ.&
   &'NOLD'.OR.WQ.EQ.'DR'.OR.WQ.EQ.'DRA'.OR.WQ.EQ.'LREFOL'&
   &.OR.WQ.EQ.'NREFOL'.OR.WQ.EQ.'MREFOL'.OR.WQ.EQ.'K'.OR.WQ.EQ.'L'&
   &.OR.WQ.EQ.'M') THEN
      IF(DF1.EQ.1) W1=DBLE(NEWIMG)
      GO TO 231
   END IF
   IF(WQ.EQ.'GLX'.OR.WQ.EQ.'GLY'.OR.WQ.EQ.'GLZ'.OR.&
   &WQ.EQ.'GLL'.OR.WQ.EQ.'GLM'.OR.WQ.EQ.'GLN'.OR.&
   &WQ.EQ.'GLLOLD'.OR.WQ.EQ.'GLMOLD'.OR.WQ.EQ.'GLNOLD'.OR.&
   &WQ.EQ.'PYPY'.OR.WQ.EQ.'PYPX'.OR.WQ.EQ.'PXPX'.OR.&
   &WQ.EQ.'PXPY'.OR.WQ.EQ.'PXAPX'.OR.WQ.EQ.'PXAPY'.OR.&
   &WQ.EQ.'PYAPX'.OR.WQ.EQ.'PYAPY'.OR.&
   &WQ.EQ.'GLLN'.OR.WQ.EQ.'GLMN'.OR.WQ.EQ.'GLNN') THEN
      IF(DF1.EQ.1) W1=DBLE(NEWIMG)
      GO TO 231
   ELSE
      GO TO 232
...
!       CALCULATE DX AND DY AND THEIR SLOPES
   IF(WQ.EQ.'DR') THEN
      ...
      VALUE=VALUE+&
      &(((RAYRAY(2,INT(W1))-REFRY(2,INT(W1)))/JA)**2)
      VALUE=DSQRT(VALUE)
   END IF
   IF(WQ.EQ.'DRA') THEN
      COSARG=((RAYRAY(4,INT(W1))*REFRY(4,INT(W1)))+&
      &(RAYRAY(5,INT(W1))*REFRY(5,INT(W1)))+&
      &(RAYRAY(6,INT(W1))*REFRY(6,INT(W1))))
   ...
   IF(.NOT.LDIF) THEN
      ...
      &'DYDY'.OR.WQ.EQ.'DYADY'.OR.WQ.EQ.'DYADX'.OR.WQ.EQ.'DXADY'&
      &.OR.WQ.EQ.'DXADX'.OR.WQ.EQ.'PYPX'.OR.WQ.EQ.'PYPY'.OR.WQ.EQ.&
      &'PXPY'.OR.WQ.EQ.'PXPX'.OR.WQ.EQ.'PYAPY'.OR.WQ.EQ.'PYAPX'&
      &.OR.WQ.EQ.'PXAPY'.OR.WQ.EQ.'PXAPX') THEN
         WRITE(OUTLYNE,*)&
         &'DIFFERENTIAL RAYTRACE IS "OFF"'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)&
         &'ALL RAY DERIVATIVES ARE ALL ZERO'
         CALL SHOWIT(1)
         VALUE=0.0D0
         GO TO 200
      END IF
...
!       CALCULATE DXA AND DYA AND THEIR SLOPES
   ...
   IF(WQ.EQ.'DXADX') THEN
      ...
      &(1.0D35*DABS(DIFF(6,INT(W1))))) THEN
      ...
      ELSE
         ...
         &DABS(DIFF(6,INT(W1))).LE.1.0D-15) THEN
            V1=0.0D0
         ELSE
   ...
   IF(WQ.EQ.'DXADY') THEN
      ...
      &(1.0D35*DABS(DIFF(12,INT(W1))))) THEN
      ...
      ELSE
         ...
         &DABS(DIFF(12,INT(W1))).LE.1.0D-15) THEN
            V1=0.0D0
         ELSE
   ...
   IF(WQ.EQ.'PYAPX') THEN
      ...
      &(1.0D35*DABS(RFDIFF(6,INT(W1))))) THEN
      ...
      ELSE
         ...
         &DABS(RFDIFF(6,INT(W1))).LE.1.0D-15) THEN
            V1=0.0D0
         ELSE
   ...
   IF(WQ.EQ.'PYAPY') THEN
      ...
      &(1.0D35*DABS(RFDIFF(12,INT(W1))))) THEN
      ...
      ELSE
         ...
         &DABS(RFDIFF(12,INT(W1))).LE.1.0D-15) THEN
            V1=0.0D0
         ELSE
...
232 CONTINUE
   IF(WQ.EQ.'ZERN37') THEN
      IF(.NOT.OPMAP) THEN
         WRITE(OUTLYNE,*)&
         &'NO FITTED WAVEFRONT MAP EXISTS'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'NO-ACTION TAKEN'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ZERN37" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!
   ...
   IF(WQ.EQ.'ET'.OR.WQ.EQ.'ETY') THEN
      ...
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ET" AND "GET ETY" REQUIRE EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!     CALCULATE EDGTHK (ET) VIA THE EDGTHK FUNCTION
   ...
   IF(WQ.EQ.'ETX') THEN
      ...
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ETX" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!       NOT OBJECT SURFACE
         ...
         &GLANAM((INT(W1)-1),2).EQ.'AIR') VALUE=0.0D0
         IF(GLANAM(INT(W1),1).EQ.'GLASS') VALUE=3.0D0
         IF(GLANAM(INT(W1),1).EQ.'MODEL') VALUE=4.0D0
         IF(GLANAM(INT(W1),2).EQ.'REFL') VALUE=1.0D0
         IF(GLANAM(INT(W1),2).EQ.'REFLTIRO') VALUE=7.0D0
...
!
   ...
   IF(WQ.EQ.'SHAPEFAC') THEN
      ...
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"SHAPEFAC" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!       ABBE AND WV AND PARTL
   ...
   &WQ.EQ.'VNUM'.OR.WQ.EQ.'DPART') THEN
      IF(W1.LT.0.0D0) W1=SYSTEM(20)+W1
      IF(W1.LT.0.0.OR.W1.GT.SYSTEM(20)) THEN
         WRITE(OUTLYNE,*)'SURFACE NUMBER BEYOND LEGAL RANGE'
         CALL SHOWIT(1)
...
!       CALCULATE VALUE
   ...
   &.OR.WQ.EQ.'CODECX'.OR.WQ.EQ.'CODECY'.OR.WQ.EQ.'COTILT') THEN
      IF(W1.LT.0.0D0) W1=SYSTEM(20)+W1
      IF(W1.LT.0.0.OR.W1.GT.SYSTEM(20)) THEN
         WRITE(OUTLYNE,*)'SURFACE NUMBER BEYOND LEGAL RANGE'
         CALL SHOWIT(1)
...
!     BOTH ARE ZERO
   ...
   &.OR.WQ.EQ.'CODECXE'.OR.WQ.EQ.'CODECYE'.OR.WQ.EQ.'COTILTE') THEN
      IF(W1.LT.0.0D0) W1=SYSTEM(20)+W1
      IF(W1.LT.0.0.OR.W1.GT.SYSTEM(20)) THEN
         WRITE(OUTLYNE,*)'SURFACE NUMBER BEYOND LEGAL RANGE'
         CALL SHOWIT(1)
...
!       CALCULATE VALUE
      ...
      ELSE
         WRITE(OUTLYNE,*)&
         &'NO "CLAP/COBS ERASE" DEFINED ON CURRENT SURFACE"'
         CALL SHOWIT(1)
         CALL MACFAL
         VALUE=-1.0D0
         GO TO 200
...
!       CALCULATE VALUE
      ...
      &ALENS(9,INT(W1)).EQ.3.0D0.OR.ALENS(9,INT(W1))&
      &.EQ.4.0D0) THEN
         VALUE=ALENS(10,INT(W1))
      ELSE
...
!       CALCULATE VALUE
      ...
      &ALENS(16,INT(W1)).EQ.3.0D0.OR.ALENS(16,INT(W1))&
      &.EQ.4.0D0) THEN
         VALUE=ALENS(17,INT(W1))
      ELSE
...
!       CALCULATE VALUE
      IF(DF1.EQ.1) W1=SYSTEM(20)
      IF(ALENS(61,INT(W1)).EQ.2.0D0.OR.&
      &ALENS(61,INT(W1)).EQ.3.0D0.OR.ALENS(61,INT(W1))&
      &.EQ.4.0D0) THEN
...
!     'ACT ' GOES HERE
   IF(WQ.EQ.'ACT     ') THEN
      IF(DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY USES NUMERIC WORDS #1, #2 AND #5'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!     'RLEN' AND 'ORLEN ' GOES HERE
   IF(WQ.EQ.'RLEN    '.OR.WQ.EQ.'ORLEN   ') THEN
      ...
      IF(INT(W2).LT.INT(W1)) THEN
         WRITE(OUTLYNE,*)&
         &'ENDING SURFACE NUMBER MUST BE GREATER THAN'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)&
         &'STARTING SURFACE NUMBER'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!     VALUES GETABLE
   ...
   IF(WQ.EQ.'PSFK') THEN
      IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"GET PSF" REQUIRES EXPLICIT NUMERIC WORDS #1 AND #2'
         CALL SHOWIT(1)
         CALL MACFAL
         RETURN
      END IF
      IF(S3.EQ.1.OR.S4.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"GET PSF" TAKES NO NUMERIC WORD #3 OR #4'
         CALL SHOWIT(1)
         CALL MACFAL
         RETURN
      END IF
      ...
      IF(ERRER2) THEN
         WRITE(OUTLYNE,*)&
         &'NUMERIC WORD #1 OR #2 OR #1 AND #2 ARE OUTSIDE THE CURRENT PSF'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)&
         &'NO ACTION TAKEN'
         CALL SHOWIT(1)
   ...
   IF(WQ.EQ.'PSFSUM'.OR.WQ.EQ.'PSFFWHMX'.OR.WQ.EQ.'PSFFWHMY') THEN
      IF(SN.EQ.1.OR.SST.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" TAKES NO ADDITIONAL INPUT'
         CALL SHOWIT(1)
         CALL MACFAL
         RETURN
      END IF
      IF(WQ.EQ.'PSFSUM') THEN
         ...
         IF(ERRER) THEN
            WRITE(OUTLYNE,*)&
            &'ERROR, NO PSF.DAT EXISTS, NO INTEGRATION CAN BE PERFORMED'
            CALL SHOWIT(1)
            WRITE(OUTLYNE,*)&
            &'NO ACTION TAKEN'
            CALL SHOWIT(1)
...
!     CALCULATE THE GPX,GPUX,GPCX AND GPUCX
         ...
         &+((JPUCX**2)*(W2**2))+&
         &(2.0D0*JPX*JPUX*W2)+(2.0D0*JPCX*JPUCX*W2)
         VALUE=DSQRT(VALUE)
         NEWOBJ=OLDOBJ
         NEWREF=OLDREF
         NEWIMG=OLDIMG
...
!     CALCULATE THE GPY,GPUY,GPCY AND GPUCY
         ...
         &+((JPUCY**2)*(W2**2))+&
         &(2.0D0*JPY*JPUY*W2)+(2.0D0*JPCY*JPUCY*W2)
         VALUE=DSQRT(VALUE)
         NEWOBJ=OLDOBJ
         NEWREF=OLDREF
         NEWIMG=OLDIMG
...
!
   ...
   &.OR.WQ.EQ.'LXVERT'.OR.WQ.EQ.'MXVERT'.OR.WQ.EQ.'NXVERT'&
   &.OR.WQ.EQ.'LYVERT'.OR.WQ.EQ.'MYVERT'.OR.WQ.EQ.'NYVERT'&
   &.OR.WQ.EQ.'LZVERT'.OR.WQ.EQ.'MZVERT'.OR.WQ.EQ.'NZVERT'&
   &)THEN
      IF(DF3.EQ.0.OR.DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORDS #1, #2 AND #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(DF1.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" REQUIRES EXPLICIT NUMERIC WORD #1 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(DF2.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" REQUIRES EXPLICIT NUMERIC WORD #2 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(W1.LT.NEWOBJ.OR.W1.GT.NEWIMG) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" NW1, SURFACE NUMBER BEYOND LEGAL RANGE'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(W2.LT.NEWOBJ.OR.W2.GT.NEWIMG) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" NW2, SURFACE NUMBER BEYOND LEGAL RANGE'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!
   ...
   &'LENGTH'.OR.WQ.EQ.'MLENGTH'.OR.WQ.EQ.'OAL'.OR.&
   &WQ.EQ.'OPTLEN'.OR.WQ.EQ.'FLCLTHY'.OR.WQ.EQ.'FLCLTHX'.OR.&
   &WQ.EQ.'FLCLTH'.OR.WQ.EQ.'WEIGHT')THEN
      IF(DF1.EQ.1) W1=0.0D0
...
!
   IF(WQ.EQ.'DERIV'.OR.WQ.EQ.'MATRIX') THEN
      IF(.NOT.DEREXT) THEN
         WRITE(OUTLYNE,*)&
         &'NO MATRIX EXISTS, DERIVATIVES ARE NOT AVAILABLE'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
      ...
      IF(DF1.EQ.1.OR.DF2.EQ.1) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" REQUIRES EXPLICIT NUMERIC WORDS #1 AND #2'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
...
!
   ...
   &.OR.WQ.EQ.'PUCY'.OR.WQ.EQ.'PICY'.OR.WQ.EQ.'PX'.OR.WQ.EQ.'PUX'&
   &.OR.WQ.EQ.'PIX'.OR.WQ.EQ.'PCX'.OR.WQ.EQ.'PUCX'.OR.WQ.EQ.'PICX'&
   &.OR.WQ.EQ.'PICYP'.OR.WQ.EQ.'PICXP'.OR.WQ.EQ.'PIYP'.OR.WQ.EQ.&
   &'PIXP') THEN
      IF(DF1.EQ.1) W1=SYSTEM(20)
...
!       SEARCH FOR GETS USING THREE NUMERIC INPUT WORDS
   ...
   &.OR.WQ.EQ.'GPCX'.OR.WQ.EQ.'GPCY'.OR.WQ.EQ.'GPUY'.OR.WQ.EQ.&
   &'GPUX'.OR.WQ.EQ.'GPUCX'.OR.WQ.EQ.'GPUCY') THEN
      IF(DF4.EQ.0) THEN
         WRITE(OUTLYNE,*)&
         &'"GET ',WQ,'" ONLY TAKES NUMERIC WORD #1, #2, #3 AND #5 INPUT'
         CALL SHOWIT(1)
         WRITE(OUTLYNE,*)'RE-ENTER COMMAND'
         CALL SHOWIT(1)
         CALL MACFAL
