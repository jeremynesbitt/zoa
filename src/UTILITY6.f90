...
!       3RD PUPIL ABERRATIONS (PRIMARY CHROMATIC DIFFERENCES)
   IF(WQ.NE.'PSA3P'.AND.WQ.NE.'XPSA3P'.AND.WQ.NE.'PCMA3P'.AND.WQ.NE.'XPCMA3P'.AND.WQ.NE.'PDIS3P'.AND.WQ.NE.'XPDIS3P'.AND.WQ.NE.'PAST3P'.AND.WQ.NE.'RSPHX'.AND.WQ.NE.'RSPHY'.AND.WQ.NE.'XPAST3P'.AND.WQ.NE.'PPTZ3P'.AND.WQ.NE.'XPPTZ3P'.AND.WQ.NE.'RSPHZ') THEN
!
!       CONTINUE CHECKING
   ELSE
!       FOUND A MATCH, GO TO 1
